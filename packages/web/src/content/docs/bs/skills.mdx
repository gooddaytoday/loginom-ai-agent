...
- Konfiguracija projekta: `.loginom-ai-agent/skills/<name>/SKILL.md`
...
Usput ucitava sve odgovarajuce `skills/*/SKILL.md` u `.loginom-ai-agent/` i odgovarajuce `.claude/skills/*/SKILL.md` ili `.agents/skills/*/SKILL.md`.
...
Kreirajte `.loginom-ai-agent/skills/git-release/SKILL.md` ovako:
...
Kontrolisite kojim skills agenti mogu pristupiti pomocu dozvola baziranih na obrascima u `loginom-ai-agent.json`:
...
**Za ugradene agente** (u `loginom-ai-agent.json`):
