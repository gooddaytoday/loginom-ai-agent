...
- `.loginom-ai-agent/plugins/` - Dodaci na nivou projekta
...
1. Globalna konfiguracija (`~/.config/opencode/loginom-ai-agent.json`)
2. Konfiguracija projekta (`loginom-ai-agent.json`)
3. Globalni direktorij dodataka (`~/.config/opencode/plugins/`)
4. Direktorij dodataka projekta (`.loginom-ai-agent/plugins/`)
