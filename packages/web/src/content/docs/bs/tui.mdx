...
Ovo je odvojeno od `loginom-ai-agent.json`, koji konfiguriše ponašanje servera/izvršavanja.
...
Koristite `LOGINOM_AI_AGENT_TUI_CONFIG` da učitate prilagođenu putanju TUI konfiguracije.
