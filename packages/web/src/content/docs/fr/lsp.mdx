...
:::note
Vous pouvez désactiver les téléchargements automatiques du serveur LSP en définissant la variable d'environnement `LOGINOM_AI_AGENT_DISABLE_LSP_DOWNLOAD` sur `true`.
:::
...
```json title="loginom-ai-agent.json" {5-7}
{
  "$schema": "https://opencode.ai/config.json",
  "lsp": {
    "rust": {
...
```json title="loginom-ai-agent.json" {5-9}
{
  "$schema": "https://opencode.ai/config.json",
  "lsp": {
    "typescript": {
...
```json title="loginom-ai-agent.json" {3}
{
  "$schema": "https://opencode.ai/config.json",
  "lsp": false
}
...
```json title="loginom-ai-agent.json" {5}
{
  "$schema": "https://opencode.ai/config.json",
  "lsp": {
    "typescript": {
