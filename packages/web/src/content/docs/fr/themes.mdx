...
3. **Répertoire racine du projet** - Défini dans `<project-root>/.loginom-ai-agent/themes/*.json`
4. **Répertoire de travail actuel** - Défini dans `./.loginom-ai-agent/themes/*.json`
