...
- Configuration du projet : `.loginom-ai-agent/skills/<name>/SKILL.md`
...
Il charge tout `skills/*/SKILL.md` correspondant dans `.loginom-ai-agent/` et tout `.claude/skills/*/SKILL.md` ou `.agents/skills/*/SKILL.md` correspondant en cours de route.
...
Créez `.loginom-ai-agent/skills/git-release/SKILL.md` comme ceci :
...
Contrôlez les compétences auxquelles les agents peuvent accéder à l'aide d'autorisations basées sur des modèles dans `loginom-ai-agent.json` :
...
**Pour les agents intégrés** (dans `loginom-ai-agent.json`) :
