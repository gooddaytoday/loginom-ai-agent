...
Configurez les agents dans votre fichier de configuration `loginom-ai-agent.json` :
...
- Par projet : `.loginom-ai-agent/agents/`
...
```json title="loginom-ai-agent.json" {3-6,9-12}
{
  "$schema": "https://opencode.ai/config.json",
  "tools": {
    "write": true,
...
```json title="loginom-ai-agent.json" {3-5,8-10}
{
  "$schema": "https://opencode.ai/config.json",
  "permission": {
    "edit": "deny"
...
```json title="loginom-ai-agent.json" {8}
{
  "$schema": "https://opencode.ai/config.json",
  "agent": {
    "build": {
...
```json title="loginom-ai-agent.json" {6,7}
{
  "agent": {
    "deep-thinker": {
