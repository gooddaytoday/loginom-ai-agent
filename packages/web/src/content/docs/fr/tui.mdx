...
Ceci est séparé de `loginom-ai-agent.json`, qui configure le comportement du serveur/d'exécution.
...
Utilisez `LOGINOM_AI_AGENT_TUI_CONFIG` pour charger un chemin de configuration TUI personnalisé.
