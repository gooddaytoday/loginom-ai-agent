...
- `.loginom-ai-agent/plugins/` - Plugins au niveau du projet
...
1. Configuration globale (`~/.config/opencode/loginom-ai-agent.json`)
2. Configuration du projet (`loginom-ai-agent.json`)
3. Répertoire global des plugins (`~/.config/opencode/plugins/`)
4. Répertoire des plugins du projet (`.loginom-ai-agent/plugins/`)
