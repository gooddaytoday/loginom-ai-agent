...
:::caution
Lorsque vous utilisez `--hostname 0.0.0.0`, définissez `LOGINOM_AI_AGENT_SERVER_PASSWORD` pour sécuriser le serveur.

```bash
LOGINOM_AI_AGENT_SERVER_PASSWORD=your-password opencode serve --hostname 0.0.0.0
```
