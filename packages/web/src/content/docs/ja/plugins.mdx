...
- `.loginom-ai-agent/plugins/` - プロジェクトレベルのプラグイン
...
1. グローバル設定 (`~/.config/opencode/loginom-ai-agent.json`)
2. プロジェクト設定 (`loginom-ai-agent.json`)
3. グローバルプラグインディレクトリ (`~/.config/opencode/plugins/`)
4. プロジェクトプラグインディレクトリ (`.loginom-ai-agent/plugins/`)
