...
Dies ist getrennt von `loginom-ai-agent.json`, welche das Server-/Runtime-Verhalten konfiguriert.
...
Verwende `LOGINOM_AI_AGENT_TUI_CONFIG`, um einen benutzerdefinierten TUI-Konfigurationspfad zu laden.
