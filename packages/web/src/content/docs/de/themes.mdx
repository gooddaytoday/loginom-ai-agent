...
3. **Projekt-Root-Verzeichnis** - Definiert in `<project-root>/.loginom-ai-agent/themes/*.json`
4. **Aktuelles Arbeitsverzeichnis** - Definiert in `./.loginom-ai-agent/themes/*.json`
...
```bash no-frame
mkdir -p .loginom-ai-agent/themes
vim .loginom-ai-agent/themes/my-theme.json
```
