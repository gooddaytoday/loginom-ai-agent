...
Dabei werden passende `skills/*/SKILL.md` in `.loginom-ai-agent/` sowie passende Dateien unter `.claude/skills/*/SKILL.md` und `.agents/skills/*/SKILL.md` geladen.
...
Erstelle `.loginom-ai-agent/skills/git-release/SKILL.md` zum Beispiel so:
...
Steuere in `loginom-ai-agent.json` per Muster, auf welche Skills Agenten zugreifen duerfen:
...
**Fuer eingebaute Agenten** (in `loginom-ai-agent.json`):
