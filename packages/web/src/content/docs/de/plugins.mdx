...
- `.loginom-ai-agent/plugins/` – Plugins auf Projektebene
...
1. Globale Konfiguration (`~/.config/opencode/loginom-ai-agent.json`)
2. Projektkonfiguration (`loginom-ai-agent.json`)
3. Globales Plugin-Verzeichnis (`~/.config/opencode/plugins/`)
4. Projekt-Plugin-Verzeichnis (`.loginom-ai-agent/plugins/`)
