...
Isso é separado do `loginom-ai-agent.json`, que configura o comportamento do servidor/runtime.
...
Use `LOGINOM_AI_AGENT_TUI_CONFIG` para carregar um caminho de configuração TUI personalizado.
