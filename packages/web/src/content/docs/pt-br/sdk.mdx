...
Você pode passar um objeto de configuração para personalizar o comportamento. A instância ainda pega seu `loginom-ai-agent.json`, mas você pode substituir ou adicionar configuração inline:
