...
3. **Diretório raiz do projeto** - Definido em `<project-root>/.loginom-ai-agent/themes/*.json`
4. **Diretório de trabalho atual** - Definido em `./.loginom-ai-agent/themes/*.json`
