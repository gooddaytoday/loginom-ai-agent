...
- `.loginom-ai-agent/plugins/` - Plugins em nível de projeto
...
1. Configuração global (`~/.config/opencode/loginom-ai-agent.json`)
2. Configuração do projeto (`loginom-ai-agent.json`)
3. Diretório de plugins global (`~/.config/opencode/plugins/`)
4. Diretório de plugins do projeto (`.loginom-ai-agent/plugins/`)
