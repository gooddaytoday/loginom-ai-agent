...
- Configuração do projeto: `.loginom-ai-agent/skills/<name>/SKILL.md`
...
Ele carrega qualquer `skills/*/SKILL.md` correspondente em `.loginom-ai-agent/` e qualquer `.claude/skills/*/SKILL.md` ou `.agents/skills/*/SKILL.md` ao longo do caminho.
...
Crie `.loginom-ai-agent/skills/git-release/SKILL.md` assim:
...
Controle quais habilidades os agentes podem acessar usando permissões baseadas em padrões em `loginom-ai-agent.json`:
...
**Para agentes embutidos** (em `loginom-ai-agent.json`):
