...
- `.loginom-ai-agent/plugins/` - Programtillegg på prosjektnivå
...
1. Global konfigurasjon (`~/.config/opencode/loginom-ai-agent.json`)
2. Prosjektkonfigurasjon (`loginom-ai-agent.json`)
3. Global plugin-katalog (`~/.config/opencode/plugins/`)
4. Prosjektpluginkatalog (`.loginom-ai-agent/plugins/`)
