...
Dette er atskilt fra `loginom-ai-agent.json`, som konfigurerer server-/kjøretidsoppførsel.
...
Bruk `LOGINOM_AI_AGENT_TUI_CONFIG` for å laste en egendefinert TUI-konfigurasjonsbane.
