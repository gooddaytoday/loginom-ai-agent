...
2. **Konfigurer autentisering** ved å bruke en av følgende metoder:
   ...
   For prosjektspesifikk eller vedvarende konfigurasjon, bruk `loginom-ai-agent.json`:
...
`loginom-ai-agent.json` fil. Det anbefales også å deaktivere øktdeling.
...
Tilpass gjennom `loginom-ai-agent.json`:
...
4. Opprett eller oppdater `loginom-ai-agent.json`-filen i prosjektkatalogen:
