...
- Config di progetto: `.loginom-ai-agent/skills/<name>/SKILL.md`
...
Carica qualsiasi `skills/*/SKILL.md` corrispondente in `.loginom-ai-agent/` e qualsiasi `.claude/skills/*/SKILL.md` o `.agents/skills/*/SKILL.md` corrispondente lungo il percorso.
...
Crea `.loginom-ai-agent/skills/git-release/SKILL.md` cosi':
...
Controlla a quali skill gli agenti possono accedere usando permessi basati su pattern in `loginom-ai-agent.json`:
...
**Per agenti integrati** (in `loginom-ai-agent.json`):
