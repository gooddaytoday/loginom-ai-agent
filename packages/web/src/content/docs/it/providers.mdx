...
2. **Configura l'autenticazione** usando uno dei seguenti metodi:
   ...
   ***
   ...
   Per configurazione specifica del progetto o persistente, usa `loginom-ai-agent.json`:
...
file `loginom-ai-agent.json`. Si raccomanda anche di disabilitare la condivisione sessioni.
...
Personalizza tramite `loginom-ai-agent.json`:
...
4. Crea o aggiorna il tuo file `loginom-ai-agent.json` nella directory del progetto:
