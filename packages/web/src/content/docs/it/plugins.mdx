...
- `.loginom-ai-agent/plugins/` - plugin a livello progetto
...
1. Config globale (`~/.config/opencode/loginom-ai-agent.json`)
2. Config di progetto (`loginom-ai-agent.json`)
3. Directory plugin globale (`~/.config/opencode/plugins/`)
4. Directory plugin di progetto (`.loginom-ai-agent/plugins/`)
