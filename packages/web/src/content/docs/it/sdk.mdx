...
Puoi passare un oggetto di configurazione per personalizzare il comportamento. L'istanza legge comunque `loginom-ai-agent.json`, ma puoi sovrascrivere o aggiungere configurazione inline:
