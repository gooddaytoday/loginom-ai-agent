...
Questo è separato da `loginom-ai-agent.json`, che configura il comportamento di server/runtime.
...
Usa `LOGINOM_AI_AGENT_TUI_CONFIG` per caricare un path di configurazione TUI personalizzato.
