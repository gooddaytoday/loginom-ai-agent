...
- Configuración del proyecto: `.loginom-ai-agent/skills/<name>/SKILL.md`
...
Carga cualquier `skills/*/SKILL.md` coincidente en `.loginom-ai-agent/` y cualquier `.claude/skills/*/SKILL.md` o `.agents/skills/*/SKILL.md` coincidente a lo largo del camino.
...
Crea `.loginom-ai-agent/skills/git-release/SKILL.md` así:
...
Controle a qué agentes de habilidades pueden acceder utilizando permisos basados ​​en patrones en `loginom-ai-agent.json`:
...
**Para agentes integrados** (en `loginom-ai-agent.json`):
