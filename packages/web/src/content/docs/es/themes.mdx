...
3. **Directorio raíz del proyecto**: definido en `<project-root>/.loginom-ai-agent/themes/*.json`
4. **Directorio de trabajo actual** - Definido en `./.loginom-ai-agent/themes/*.json`
