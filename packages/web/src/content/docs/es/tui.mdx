...
Esto es independiente de `loginom-ai-agent.json`, que configura el comportamiento del servidor/tiempo de ejecución.
...
Utilice `LOGINOM_AI_AGENT_TUI_CONFIG` para cargar una ruta de configuración de TUI personalizada.
