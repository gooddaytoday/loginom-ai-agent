...
2. **Configure la autenticación** utilizando uno de los siguientes métodos:
   ...
   Para una configuración persistente o específica del proyecto, utilice `loginom-ai-agent.json`:
...
Archivo `loginom-ai-agent.json`. También se recomienda desactivar el uso compartido de sesiones.
...
Personalizar a través de `loginom-ai-agent.json`:
...
4. Cree o actualice su archivo `loginom-ai-agent.json` en el directorio de su proyecto:
