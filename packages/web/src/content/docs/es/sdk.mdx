...
Puede pasar un objeto de configuración para personalizar el comportamiento. La instancia aún recoge su `loginom-ai-agent.json`, pero puede anular o agregar configuración en línea:
