...
- `.loginom-ai-agent/plugins/` - Complementos a nivel de proyecto
...
1. Configuración global (`~/.config/opencode/loginom-ai-agent.json`)
2. Configuración del proyecto (`loginom-ai-agent.json`)
3. Directorio global de complementos (`~/.config/opencode/plugins/`)
4. Directorio de complementos del proyecto (`.loginom-ai-agent/plugins/`)
...
```json title=".loginom-ai-agent/package.json"
{
  "dependencies": {
    "shescape": "^2.1.0"
  }
...
```ts title=".loginom-ai-agent/plugins/my-plugin.ts"
...
```js title=".loginom-ai-agent/plugins/example.js"
...
```js title=".loginom-ai-agent/plugins/notification.js"
...
```javascript title=".loginom-ai-agent/plugins/env-protection.js"
...
```javascript title=".loginom-ai-agent/plugins/inject-env.js"
...
```ts title=".loginom-ai-agent/plugins/custom-tools.ts"
import { type Plugin, tool } from "@loginom-ai-agent/plugin"
...
```ts title=".loginom-ai-agent/plugins/compaction.ts"
import type { Plugin } from "@loginom-ai-agent/plugin"
...
```ts title=".loginom-ai-agent/plugins/custom-compaction.ts"
import type { Plugin } from "@loginom-ai-agent/plugin"
