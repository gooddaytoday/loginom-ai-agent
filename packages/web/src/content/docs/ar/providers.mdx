...
2. **اضبط المصادقة** باستخدام إحدى الطرق التالية:
   ...
   للإعداد الخاص بالمشروع أو الإعداد الدائم، استخدم `loginom-ai-agent.json`:
...
`loginom-ai-agent.json` لديك. يوصى أيضا بتعطيل مشاركة الجلسات.
...
خصّص عبر `loginom-ai-agent.json`:
...
4. أنشئ أو حدّث ملف `loginom-ai-agent.json` في دليل مشروعك:
