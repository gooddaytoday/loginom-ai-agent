...
- `.loginom-ai-agent/plugins/` - إضافات على مستوى المشروع
...
1. إعدادات عامة (`~/.config/opencode/loginom-ai-agent.json`)
2. إعدادات المشروع (`loginom-ai-agent.json`)
3. دليل الإضافات العام (`~/.config/opencode/plugins/`)
4. دليل إضافات المشروع (`.loginom-ai-agent/plugins/`)
