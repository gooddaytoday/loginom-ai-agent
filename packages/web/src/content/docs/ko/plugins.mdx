...
- `.loginom-ai-agent/plugins/` - 프로젝트 레벨 플러그인
...
1. 글로벌 구성 (`~/.config/opencode/loginom-ai-agent.json`)
2. 프로젝트 구성 (`loginom-ai-agent.json`)
3. 글로벌 플러그인 디렉토리 (`~/.config/opencode/plugins/`)
4. 프로젝트 플러그인 디렉토리 (`.loginom-ai-agent/plugins/`)
