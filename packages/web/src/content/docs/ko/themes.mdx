...
3. **프로젝트 루트 디렉토리 (Project root directory)** - `<project-root>/.loginom-ai-agent/themes/*.json`에 정의됩니다.
4. **현재 작업 디렉토리 (Current working directory)** - `./.loginom-ai-agent/themes/*.json`에 정의됩니다.
