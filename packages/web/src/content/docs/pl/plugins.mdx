...
- `.loginom-ai-agent/plugins/` - Wtyczki na poziomie projektu
...
1. Konfiguracja globalna (`~/.config/opencode/loginom-ai-agent.json`)
2. Konfiguracja projektu (`loginom-ai-agent.json`)
3. Globalny katalog wtyczek (`~/.config/opencode/plugins/`)
4. Katalog wtyczek projektu (`.loginom-ai-agent/plugins/`)
