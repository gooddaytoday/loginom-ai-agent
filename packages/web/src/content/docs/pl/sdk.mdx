...
Można przekazać obiekt konfiguracyjny, aby dostosować zachowanie. Instancja nadal pobiera `loginom-ai-agent.json`, ale możesz zastąpić lub dodać konfigurację bezpośrednio:
