...
3. **Katalog główny projektu** - Zdefiniowany w `<project-root>/.loginom-ai-agent/themes/*.json`
4. **Bieżący katalog roboczy** - Zdefiniowany w `./.loginom-ai-agent/themes/*.json`
