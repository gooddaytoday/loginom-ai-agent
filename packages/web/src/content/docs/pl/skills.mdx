...
- Project config: `.loginom-ai-agent/skills/<name>/SKILL.md`
...
Ładuje po drodze dowolne pasujące `skills/*/SKILL.md` w `.loginom-ai-agent/` i dowolne pasujące `.claude/skills/*/SKILL.md` lub `.agents/skills/*/SKILL.md`.
...
Utwórz `.loginom-ai-agent/skills/git-release/SKILL.md` w ten sposób:
...
Kontroluj, do których umiejętności agenci mogą uzyskać dostęp, używając uprawnień opartych na wzorcach w `loginom-ai-agent.json`:
...
**Dla agentów wbudowanych** (w `loginom-ai-agent.json`):
