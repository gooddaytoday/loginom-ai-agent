...
Jest to oddzielny plik od `loginom-ai-agent.json`, który konfiguruje zachowanie serwera/runtime.
...
Użyj `LOGINOM_AI_AGENT_TUI_CONFIG`, aby załadować niestandardową ścieżkę konfiguracji TUI.
