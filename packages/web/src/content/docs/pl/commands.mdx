...
Utwórz `.loginom-ai-agent/commands/test.md`:

```md title=".loginom-ai-agent/commands/test.md"
---
...
Możesz zdefiniować polecenia w `loginom-ai-agent.json` lub w plikach w katalogu `commands/`.
...
```json title="loginom-ai-agent.jsonc" {4-12}
{
...
- Na projekt: `.loginom-ai-agent/commands/`
...
```md title=".loginom-ai-agent/commands/component.md"
---
...
```md title=".loginom-ai-agent/commands/create-file.md"
---
...
```md title=".loginom-ai-agent/commands/analyze-coverage.md"
---
...
```md title=".loginom-ai-agent/commands/review-changes.md"
---
...
```md title=".loginom-ai-agent/commands/review-component.md"
---
