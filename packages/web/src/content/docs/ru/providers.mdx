...
2. **Настройте аутентификацию** одним из следующих способов:
   ...
   Для конкретной или постоянной конфигурации проекта используйте `loginom-ai-agent.json`:
...
`loginom-ai-agent.json` файл. Также рекомендуется отключить совместное использование сеансов.
...
Настройте через `loginom-ai-agent.json`:
...
4. Создайте или обновите файл `loginom-ai-agent.json` в каталоге вашего проекта:
