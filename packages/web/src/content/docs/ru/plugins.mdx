...
- `.loginom-ai-agent/plugins/` – плагины уровня проекта.
...
1. Глобальная конфигурация (`~/.config/opencode/loginom-ai-agent.json`)
2. Конфигурация проекта (`loginom-ai-agent.json`)
3. Глобальный каталог плагинов (`~/.config/opencode/plugins/`)
4. Каталог плагинов проекта (`.loginom-ai-agent/plugins/`)
