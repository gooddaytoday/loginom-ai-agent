...
สิ่งนี้แยกจาก `loginom-ai-agent.json` ซึ่งกำหนดค่าพฤติกรรมเซิร์ฟเวอร์/รันไทม์
...
ใช้ `LOGINOM_AI_AGENT_TUI_CONFIG` เพื่อโหลดเส้นทางการกำหนดค่า TUI แบบกำหนดเอง
