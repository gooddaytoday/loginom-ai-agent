...
- การกำหนดค่าโครงการ: `.loginom-ai-agent/skills/<name>/SKILL.md`
...
โดยจะโหลด `skills/*/SKILL.md` ที่ตรงกันใน `.loginom-ai-agent/` และ `.claude/skills/*/SKILL.md` หรือ `.agents/skills/*/SKILL.md` ที่ตรงกันตลอดทาง
...
สร้าง `.loginom-ai-agent/skills/git-release/SKILL.md` แบบนี้:
...
ควบคุมว่าตัวแทนทักษะใดสามารถเข้าถึงโดยใช้สิทธิ์ตามรูปแบบใน `loginom-ai-agent.json`:
...
**สำหรับตัวแทนในตัว** (ใน `loginom-ai-agent.json`):
