...
- `.loginom-ai-agent/plugins/` - ​​ปลั๊กอินระดับโครงการ
...
1. การกำหนดค่าส่วนกลาง (`~/.config/opencode/loginom-ai-agent.json`)
2. การกำหนดค่าโครงการ (`loginom-ai-agent.json`)
3. ไดเร็กทอรีปลั๊กอินสากล (`~/.config/opencode/plugins/`)
4. ไดเรกทอรีปลั๊กอินโครงการ (`.loginom-ai-agent/plugins/`)
