...
2. **กำหนดค่าการตรวจสอบสิทธิ์** โดยใช้วิธีใดวิธีหนึ่งต่อไปนี้:
   ...
   สำหรับการกำหนดค่าเฉพาะโครงการหรือแบบถาวร ให้ใช้ `loginom-ai-agent.json`:
...
`loginom-ai-agent.json` ไฟล์. ขอแนะนำให้ปิดใช้งานการแชร์เซสชันด้วย
...
ปรับแต่งผ่าน `loginom-ai-agent.json`:
...
4. สร้างหรืออัปเดตไฟล์ `loginom-ai-agent.json` ของคุณในไดเร็กทอรีโครงการของคุณ:
...
4. สร้างหรืออัปเดตไฟล์ `loginom-ai-agent.json` ในไดเรกทอรีโครงการของคุณ:
