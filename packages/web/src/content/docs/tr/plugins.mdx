...
- `.loginom-ai-agent/plugins/` - Proje düzeyinde eklentiler
...
1. Global config (`~/.config/opencode/loginom-ai-agent.json`)
2. Project config (`loginom-ai-agent.json`)
3. Global eklenti dizini (`~/.config/opencode/plugins/`)
4. Proje eklenti dizini (`.loginom-ai-agent/plugins/`)
