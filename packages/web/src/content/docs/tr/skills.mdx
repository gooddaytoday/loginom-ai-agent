...
- Proje konfigurasyonu: `.loginom-ai-agent/skills/<name>/SKILL.md`
...
Bu sirada `skills/*/SKILL.md` altindaki eslesen `.loginom-ai-agent/` dosyalarini ve `.claude/skills/*/SKILL.md` ya da `.agents/skills/*/SKILL.md` dosyalarini yukler.
...
`.loginom-ai-agent/skills/git-release/SKILL.md` dosyasini soyle olusturun:
...
`loginom-ai-agent.json` icinde pattern tabanli izinlerle ajanlarin hangi becerilere erisecegini kontrol edin:
...
**Yerlesik ajanlar icin** (`loginom-ai-agent.json` icinde):
