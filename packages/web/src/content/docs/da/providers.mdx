...
2. **Konfigurer godkendelse** ved at bruge en af følgende metoder:
   ...
   For projektspecifik eller vedvarende konfiguration, brug `loginom-ai-agent.json`:
...
`loginom-ai-agent.json` fil. Det anbefales også at deaktivere sessionsdeling.
...
Tilpas gennem `loginom-ai-agent.json`:
...
4. Opret eller opdater `loginom-ai-agent.json`-filen i projektkataloget:
