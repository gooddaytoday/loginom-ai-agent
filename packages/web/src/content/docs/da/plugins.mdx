...
- `.loginom-ai-agent/plugins/` - Plugins på projektniveau
...
1. Global konfiguration (`~/.config/opencode/loginom-ai-agent.json`)
2. Projektkonfiguration (`loginom-ai-agent.json`)
3. Global plugin-mappe (`~/.config/opencode/plugins/`)
4. Projekt plugin bibliotek (`.loginom-ai-agent/plugins/`)
