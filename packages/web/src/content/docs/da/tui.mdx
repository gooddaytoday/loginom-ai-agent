...
Dette er adskilt fra `loginom-ai-agent.json`, som konfigurerer server-/kørselstidsadfærd.
...
Brug `LOGINOM_AI_AGENT_TUI_CONFIG` til at indlæse en brugerdefineret TUI-konfigurationssti.
