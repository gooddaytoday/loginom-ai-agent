...
- Prosjektkonfigurasjon: `.loginom-ai-agent/skills/<name>/SKILL.md`
...
Den laster alle matchende `skills/*/SKILL.md` i `.loginom-ai-agent/` og alle matchende `.claude/skills/*/SKILL.md` eller `.agents/skills/*/SKILL.md` underveis.
...
Lag `.loginom-ai-agent/skills/git-release/SKILL.md` slik:
...
Kontroller hvilke ferdigheter agenter har tilgang til ved at bruge mønsterbaserte tillatelser i `loginom-ai-agent.json`:
...
**For innebygde agenter** (i `loginom-ai-agent.json`):
