        ...
        Effect.tryPromise({
          try: () =>
            createCliRenderer({
              ...
              useMouse: !Flag.LOGINOM_AI_AGENT_DISABLE_MOUSE && input.config.mouse,
              consoleOptions: {
                ...
                <ErrorBoundary fallback={(error, reset) => <ErrorComponent error={error} reset={reset} mode={mode} />}>
                  ...
                  >
                    ...
                    >
                      <TuiStartupProvider
                        value={{
                          initialRoute: process.env.LOGINOM_AI_AGENT_ROUTE ? JSON.parse(process.env.LOGINOM_AI_AGENT_ROUTE) : undefined,
                          skipInitialLoading: Boolean(process.env.LOGINOM_AI_AGENT_FAST_BOOT),
                        }}
                      >
                        <ClipboardProvider>
...
function App(props: { onSnapshot?: () => Promise<string[]>; pluginHost: TuiPluginHost }) {
  ...
  const offSelectionKeys = keymap.intercept(
    "key",
    ({ event }) => {
      if (!Flag.LOGINOM_AI_AGENT_EXPERIMENTAL_DISABLE_COPY_ON_SELECT) return
  ...
  createEffect(() => {
    if (!terminalTitleEnabled() || Flag.LOGINOM_AI_AGENT_DISABLE_TERMINAL_TITLE) return
  ...
  const appCommands = createMemo(() =>
    [
      ...
      },
      {
        ...
        category: "Workspace",
        hidden: !Flag.LOGINOM_AI_AGENT_EXPERIMENTAL_WORKSPACES,
  ...
  useBindings(() => ({
    mode: LOGINOM_AI_AGENT_BASE_MODE,
  ...
  return (
    <box
      ...
      onMouseUp={
        !Flag.LOGINOM_AI_AGENT_EXPERIMENTAL_DISABLE_COPY_ON_SELECT
          ? () => Selection.copy(renderer, toast, clipboard)
          : undefined
      }
    >
      <Show when={Flag.LOGINOM_AI_AGENT_SHOW_TTFD}>
        <TimeToFirstDraw />
      </Show>
      <Show when={ready()}>
