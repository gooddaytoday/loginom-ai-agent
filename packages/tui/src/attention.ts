...
import defaultSoundPath from "@loginom-ai-agent/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@loginom-ai-agent/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@loginom-ai-agent/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@loginom-ai-agent/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@loginom-ai-agent/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@loginom-ai-agent/ui/audio/yup-01.mp3" with { type: "file" }
