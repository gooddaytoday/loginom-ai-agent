...
class Database extends Context.Service<Database, DatabaseShape>()("@loginom-ai-agent/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@loginom-ai-agent/example/UserStore") {
