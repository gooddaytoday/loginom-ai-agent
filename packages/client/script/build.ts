...
import { compile, emitEffectImported, emitPromise, write } from "@loginom-ai-agent/httpapi-codegen"
        ...
        emitPromise(contract, {
          outputTypes: {
            "events.subscribe": {
              ...
              import: 'import type { OpenCodeEventEncoded } from "@loginom-ai-agent/protocol/groups/event"',
            },
          },
        }),
