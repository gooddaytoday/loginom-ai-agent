const codes = new Set([
  "LOGINOM_RECOVERY_STORE_INVALID",
  "LOGINOM_SESSION_STORE_INVALID",
  "LOGINOM_SESSION_BINDING_INVALID",
  "LOGINOM_SESSION_COMPLETION_CONFLICT",
  "LOGINOM_SESSION_UNREGISTERED",
  "LOGINOM_SESSION_UNAVAILABLE",
  "LOGINOM_SESSION_BUSY",
  "LOGINOM_SESSION_COMPLETED",
  "LOGINOM_SESSION_SAVE_REQUIRED",
  "LOGINOM_SESSION_COMPLETION_PENDING",
