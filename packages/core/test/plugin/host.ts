import type { PluginContext } from "@loginom-ai-agent/plugin/v2/effect"
...
import type { IntegrationEnvMethod, IntegrationKeyMethod, IntegrationOAuthMethod } from "@loginom-ai-agent/sdk/v2/types"
