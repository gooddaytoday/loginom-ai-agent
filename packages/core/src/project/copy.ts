...
import { Event } from "@loginom-ai-agent/schema/project-directories"
import { ProjectCopy } from "@loginom-ai-agent/schema/project-copy"
...
export class Service extends Context.Service<Service, Interface>()("@loginom-ai-agent/ProjectCopy") {}
