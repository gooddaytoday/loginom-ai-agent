...
import type { EffectDrizzleSqlite } from "@loginom-ai-agent/effect-drizzle-sqlite"
...
export class Service extends Context.Service<Service, Interface>()("@loginom-ai-agent/ProjectDirectories") {}
