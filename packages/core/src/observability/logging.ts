...
export function fileLogger(file = path.join(Global.Path.log, "loginom-ai-agent.log"), id: string = runID) {
...
export function minimumLogLevel() {
  const value = process.env.LOGINOM_AI_AGENT_LOG_LEVEL?.toUpperCase()
  const levels = {
    DEBUG: "Debug",
    INFO: "Info",
    WARN: "Warn",
