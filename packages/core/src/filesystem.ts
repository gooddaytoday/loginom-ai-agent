...
import { Entry, FileSystem, FindInput, Match } from "@loginom-ai-agent/schema/filesystem"
export { Entry, Match, Submatch } from "@loginom-ai-agent/schema/filesystem"
...
export class Service extends Context.Service<Service, Interface>()("@loginom-ai-agent/v2/FileSystem") {}
