...
import { ToolFailure } from "@loginom-ai-agent/llm"
...
export class ConfigService extends Context.Service<ConfigService, Config>()("@loginom-ai-agent/v2/WebSearchConfig") {}

/** Isolates the retained product environment contract from the generic tool implementation. */
export const defaultConfigLayer = Layer.sync(ConfigService, () =>
  ConfigService.of({
    provider:
      process.env.LOGINOM_AI_AGENT_WEBSEARCH_PROVIDER === "exa" || process.env.LOGINOM_AI_AGENT_WEBSEARCH_PROVIDER === "parallel"
        ? process.env.LOGINOM_AI_AGENT_WEBSEARCH_PROVIDER
        : undefined,
    enableExa: truthy("LOGINOM_AI_AGENT_EXPERIMENTAL") || truthy("LOGINOM_AI_AGENT_ENABLE_EXA") || truthy("LOGINOM_AI_AGENT_EXPERIMENTAL_EXA"),
    enableParallel: truthy("LOGINOM_AI_AGENT_ENABLE_PARALLEL") || truthy("LOGINOM_AI_AGENT_EXPERIMENTAL_PARALLEL"),
