...
import { ToolOutput, type ToolCall, type ToolDefinition, type ToolResultValue } from "@loginom-ai-agent/llm"
...
export class Service extends Context.Service<Service, Interface>()("@loginom-ai-agent/v2/ToolRegistry") {}
