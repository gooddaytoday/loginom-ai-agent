...
export class Service extends Context.Service<Service, Interface>()("@loginom-ai-agent/v2/SkillDiscovery") {}
      ...
      pull: Effect.fn("SkillDiscovery.pull")(function* (url) {
        ...
        return yield* Effect.forEach(
          data.skills.flatMap((skill) => {
            ...
            const versionFile = path.join(root, ".loginom-ai-agent-version")
            ...
            Effect.gen(function* () {
              ...
              if (version === undefined || current === version) {
                ...
                yield* Effect.gen(function* () {
                  ...
                  if (!exists) return
                  yield* fs.writeFileString(path.join(staging, ".loginom-ai-agent-version"), version)
