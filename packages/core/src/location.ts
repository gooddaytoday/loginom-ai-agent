...
import { Info, Ref, response } from "@loginom-ai-agent/schema/location"
...
export class Service extends Context.Service<Service, Interface>()("@loginom-ai-agent/Location") {}
