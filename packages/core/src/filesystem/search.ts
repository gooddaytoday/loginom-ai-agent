...
export class Service extends Context.Service<Service, Interface>()("@loginom-ai-agent/v2/FileSystem/Search") {}
...
const layer = Layer.unwrap(Effect.sync(() => (Flag.LOGINOM_AI_AGENT_DISABLE_FFF || !Fff.available() ? ripgrepLayer : fffLayer)))
