...
export const unavailable = Symbol.for("@loginom-ai-agent/SystemContext.Unavailable")
...
const ContextTypeId: unique symbol = Symbol.for("@loginom-ai-agent/SystemContext")
