...
import type { IntegrationOAuthMethodRegistration } from "@loginom-ai-agent/plugin/v2/effect/integration"
import { define } from "@loginom-ai-agent/plugin/v2/effect/plugin"
