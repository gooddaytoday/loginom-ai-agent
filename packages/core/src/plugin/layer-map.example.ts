...
export class RequestContextRef extends Context.Service<RequestContextRef, RequestContext>()(
  "@loginom-ai-agent/example/RequestContextRef",
) {}
...
export class ConfigService extends Context.Service<ConfigService, ConfigServiceShape>()(
  "@loginom-ai-agent/example/ConfigService",
) {}
...
export class ConfigServiceMap extends LayerMap.Service<ConfigServiceMap>()("@loginom-ai-agent/example/ConfigServiceMap", {
