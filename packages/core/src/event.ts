...
import type { Data, Definition, Payload } from "@loginom-ai-agent/schema/event"
...
import { Durable } from "@loginom-ai-agent/schema/durable-event-manifest"

export const ID = Event.ID
export type ID = import("@loginom-ai-agent/schema/event").ID
export type { Data, Definition, Payload } from "@loginom-ai-agent/schema/event"
...
export class Service extends Context.Service<Service, Interface>()("@loginom-ai-agent/Event") {}
