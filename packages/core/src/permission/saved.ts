...
import { PermissionSaved } from "@loginom-ai-agent/schema/permission-saved"
...
export class Service extends Context.Service<Service, Interface>()("@loginom-ai-agent/v2/PermissionSaved") {}
