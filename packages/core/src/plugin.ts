...
import type { Plugin as PluginRuntime } from "@loginom-ai-agent/plugin/v2/effect"
...
export class Service extends Context.Service<Service, Interface>()("@loginom-ai-agent/v2/Plugin") {}
