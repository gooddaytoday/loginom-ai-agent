...
export { Effect, Rule, Ruleset } from "@loginom-ai-agent/schema/permission"
...
export class Service extends Context.Service<Service, Interface>()("@loginom-ai-agent/v2/Permission") {}
