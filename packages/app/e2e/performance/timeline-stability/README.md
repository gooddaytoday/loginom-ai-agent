...
For optional before/violation/after screenshots, set `LOGINOM_AI_AGENT_STABILITY_CAPTURE=1`. Capture is opt-in because compositor readback can perturb timing.
