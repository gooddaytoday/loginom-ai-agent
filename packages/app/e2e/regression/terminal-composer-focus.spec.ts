...
const directory = "C:/Loginom AI Agent/TerminalComposerFocus"
...
function seedCachedTerminal(page: Page) {
  return page.addInitScript(
    ({ terminalKey, ptyID }) => {
      localStorage.setItem("loginom-ai-agent.global.dat:layout", JSON.stringify({ terminal: { height: 320, opened: true } }))
