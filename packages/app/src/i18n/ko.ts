...
export const dict = {
  ...
  "provider.connect.opencodeZen.line1":
    "Loginom AI Agent Zen은 코딩 에이전트를 위해 최적화된 신뢰할 수 있는 엄선된 모델에 대한 액세스를 제공합니다.",
  ...
  "dialog.plugins.empty": "loginom-ai-agent.json에 구성된 플러그인",
  ...
  "dialog.server.description": "이 앱이 연결할 Loginom AI Agent 서버를 전환합니다.",
  ...
  "error.page.report.prefix": "이 오류를 Loginom AI Agent 팀에 제보해 주세요: ",
  ...
  "error.chain.checkConfig": "구성(loginom-ai-agent.json)의 공급자/모델 이름을 확인하세요",
  ...
  "settings.desktop.wsl.description": "Windows의 WSL 내부에서 Loginom AI Agent 서버를 실행합니다.",
  ...
  "settings.general.row.language.description": "Loginom AI Agent 표시 언어 변경",
  ...
  "settings.general.row.theme.description": "Loginom AI Agent 테마 사용자 지정",
  ...
  "wsl.onboarding.checkingOpencode": "Loginom AI Agent 확인 중...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}에서 Loginom AI Agent 확인 중...",
  "wsl.onboarding.updatingOpencode": "Loginom AI Agent 업데이트 중...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}에서 Loginom AI Agent 업데이트 중...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}에서 OpenCode를 업데이트하세요.",
  "wsl.onboarding.updateOpencode": "Loginom AI Agent 업데이트",
  ...
  "wsl.onboarding.installOpencode": "Loginom AI Agent 설치",
  ...
  "help.tabs.introduction": "이제 Loginom AI Agent Desktop은 탭을 중심으로 구성됩니다.",
  "help.tabs.sessions":
  ...
  "desktop.recovery.terminated": "Loginom AI Agent 윈도우가 예기치 않게 종료되었습니다",
  ...
  "desktop.wsl.error.installOpencode": "Loginom AI Agent 설치 실패",
  ...
  "desktop.wsl.error.updateVersion":
    "Loginom AI Agent 업데이트가 완료되었지만 {{distro}}에서 여전히 {{installed}} 버전으로 표시됩니다. 예상 버전: {{expected}}",
