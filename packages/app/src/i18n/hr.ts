...
const desktop = [
  ...
  "Minimiziraj",
  "Maksimiziraj",
  "Dokumentacija za Loginom AI Agent",
  "Forum za podršku",
  "Pošalji povratne informacije",
  "Prijavi pogrešku",
  "Izbornik Loginom AI Agent",
  ...
  "Nastavi čekati",
  "Izađi",
  "Loginom AI Agent se nije uspio učitati",
  "Prozor aplikacije Loginom AI Agent neočekivano je zatvoren",
  "Loginom AI Agent ne reagira",
  ...
  "Instalacija aplikacije Loginom AI Agent nije uspjela",
  ...
  "Loginom AI Agent nije instaliran u distribuciji {{distro}}",
  "Ažuriranje aplikacije Loginom AI Agent je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  "nema verzije",
...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Enter vaš {{provider}} API ključ za povezivanje vašeg računa i korištenje {{provider}} modela u Loginom AI Agent.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "za prikupljanje vašeg autorizacijskog koda za povezivanje vašeg računa i korištenje {{provider}} modela u Loginom AI Agent.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "i unesite kod ispod kako biste povezali svoj račun i koristili {{provider}} modele u Loginom AI Agent.",
  ...
  "dialog.plugins.empty": "Dodaci konfigurirani u loginom-ai-agent.json",
  ...
  "dialog.server.description": "Promijenite na koji se Loginom AI Agent poslužitelj povezuje ova aplikacija.",
  ...
  "wsl.onboarding.checkingOpencodeIn": "Provjera Loginom AI Agent u {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje Loginom AI Agent...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje Loginom AI Agent u {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažurirajte Loginom AI Agent u {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažurirajte Loginom AI Agent",
  "wsl.onboarding.opencodeReadyIn": "Loginom AI Agent je spreman u {{distro}}.",
  "wsl.onboarding.opencodeReady": "Loginom AI Agent je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instalirajte Loginom AI Agent u {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalirajte Loginom AI Agent",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows podsustav za Linux) je potreban prije nego što Loginom AI Agent može dodati WSL poslužitelj",
  "wsl.onboarding.wslUnavailable.title": "WSL nedostupan",
  "wsl.onboarding.wslUnavailable.description": "Loginom AI Agent nije mogao potvrditi WSL na ovom stroju.",
  "wsl.onboarding.installWsl": "Instalirajte WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokrenite Windows da dovršite instalaciju WSL, zatim ponovno otvorite Loginom AI Agent.",
  ...
  "help.tabs.introduction": "Radna površina Loginom AI Agent sada je izgrađena oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija Loginom AI Agent ({{version}}) sada je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Prijavite ovu grešku Loginom AI Agent timu",
  ...
  "error.chain.checkConfig": "Provjerite nazive dobavljača/modela svoje konfiguracije (loginom-ai-agent.json).",
  "error.chain.mcpFailed":
    'MCP poslužitelj "{{name}}" nije uspio. Napomena, Loginom AI Agent još ne podržava MCP autentifikaciju.',
  ...
  "app.name.desktop": "Loginom AI Agent Radna površina",
  ...
  "settings.desktop.wsl.description": "Pokrenite Loginom AI Agent poslužitelj unutar WSL na Windows.",
  ...
  "settings.general.row.language.description": "Promijenite jezik prikaza za Loginom AI Agent",
  ...
  "settings.general.row.appearance.description": "Prilagodite kako Loginom AI Agent izgleda na vašem uređaju",
  "settings.general.row.colorScheme.title": "Shema boja",
  "settings.general.row.colorScheme.description":
    "Odaberite hoće li Loginom AI Agent slijediti sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite način na koji je Loginom AI Agent tematiziran.",
  ...
  "settings.updates.row.startup.description": "Automatski provjeri ima li ažuriranja kada se Loginom AI Agent pokrene",
  ...
  "settings.updates.toast.latest.description": "Imate najnoviju verziju Loginom AI Agent.",
