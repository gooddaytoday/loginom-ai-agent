...
export const dict = {
  ...
  "desktop.menu.documentation": "Loginom AI Agent दस्तावेज़",
  ...
  "desktop.menu.ariaLabel": "Loginom AI Agent मेन्यू",
  ...
  "desktop.recovery.loadFailed": "Loginom AI Agent लोड नहीं हो सका",
  "desktop.recovery.terminated": "Loginom AI Agent विंडो अनपेक्षित रूप से बंद हो गई",
  "desktop.recovery.unresponsive": "Loginom AI Agent प्रतिसाद नहीं दे रहा है",
  ...
  "desktop.wsl.error.installOpencode": "Loginom AI Agent इंस्टॉल नहीं हो सका",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}} में Loginom AI Agent इंस्टॉल नहीं है",
  "desktop.wsl.error.updateVersion":
    "Loginom AI Agent अपडेट पूरा हो गया, लेकिन {{distro}} अब भी {{installed}} रिपोर्ट कर रहा है; अपेक्षित संस्करण {{expected}} है",
  ...
  "provider.connect.apiKey.description":
    "अपने खाते को कनेक्ट करने के लिए अपनी {{provider}} API कुंजी दर्ज करें और Loginom AI Agent में {{provider}} मॉडल का उपयोग करें।",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " अपने खाते को कनेक्ट करने और Loginom AI Agent में {{provider}} मॉडल का उपयोग करने के लिए अपना प्राधिकरण कोड प्राप्त करें।",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " और अपने खाते को कनेक्ट करने तथा Loginom AI Agent में {{provider}} मॉडल का उपयोग करने के लिए नीचे दिया गया कोड दर्ज करें।",
  ...
  "dialog.plugins.empty": "प्लगइन loginom-ai-agent.json में कॉन्फ़िगर किए गए हैं",
  ...
  "dialog.server.description": "स्विच करें कि यह ऐप किस Loginom AI Agent सर्वर से कनेक्ट होता है।",
  ...
  "wsl.onboarding.checkingOpencode": "Loginom AI Agent की जाँच हो रही है...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} में Loginom AI Agent की जाँच हो रही है...",
  "wsl.onboarding.updatingOpencode": "Loginom AI Agent अपडेट हो रहा है...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} में Loginom AI Agent अपडेट हो रहा है...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} में Loginom AI Agent को अपडेट करें।",
  "wsl.onboarding.updateOpencode": "Loginom AI Agent को अपडेट करें",
  "wsl.onboarding.opencodeReadyIn": "Loginom AI Agent {{distro}} में तैयार है।",
  "wsl.onboarding.opencodeReady": "Loginom AI Agent तैयार है।",
  "wsl.onboarding.installOpencodeIn": "{{distro}} में Loginom AI Agent स्थापित करें।",
  "wsl.onboarding.installOpencode": "Loginom AI Agent स्थापित करें",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Loginom AI Agent स्थापित नहीं है",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Loginom AI Agent द्वारा WSL सर्वर जोड़ने से पहले WSL (Linux के लिए Windows सबसिस्टम) आवश्यक है",
  "wsl.onboarding.wslUnavailable.title": "WSL अनुपलब्ध है",
  "wsl.onboarding.wslUnavailable.description": "Loginom AI Agent इस मशीन पर WSL को सत्यापित नहीं कर सका।",
  "wsl.onboarding.installWsl": "WSL स्थापित करें",
  "wsl.onboarding.windowsRestartRequired":
    "WSL की स्थापना समाप्त करने के लिए Windows को पुनरारंभ करें, फिर Loginom AI Agent को फिर से खोलें।",
  ...
  "help.tabs.introduction": "Loginom AI Agent Desktop अब टैब पर आधारित है।",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Loginom AI Agent ({{version}}) का एक नया संस्करण अब इंस्टॉल करने के लिए उपलब्ध है।",
  ...
  "error.page.report.prefix": "कृपया इस त्रुटि की रिपोर्ट Loginom AI Agent टीम को करें",
  ...
  "error.chain.checkConfig": "अपने कॉन्फ़िगरेशन (loginom-ai-agent.json) प्रोवाइडर/मॉडल नामों की जाँच करें",
  "error.chain.mcpFailed":
    'MCP सर्वर "{{name}}" विफल रहा। ध्यान दें, Loginom AI Agent अभी तक MCP प्रमाणीकरण का समर्थन नहीं करता है।',
  ...
  "settings.desktop.wsl.description": "Windows पर WSL के अंदर Loginom AI Agent सर्वर चलाएँ।",
  ...
  "settings.general.row.language.description": "Loginom AI Agent के लिए प्रदर्शन भाषा बदलें",
  ...
  "settings.general.row.appearance.description": "अनुकूलित करें कि Loginom AI Agent आपके डिवाइस पर कैसा दिखता है",
  "settings.general.row.colorScheme.title": "रंग योजना",
  "settings.general.row.colorScheme.description": "चुनें कि Loginom AI Agent सिस्टम, हल्की या गहरी थीम में से किसका उपयोग करे",
  "settings.general.row.theme.title": "थीम",
  "settings.general.row.theme.description": "अनुकूलित करें कि Loginom AI Agent की थीम कैसी है।",
  ...
  "settings.updates.row.startup.description": "Loginom AI Agent लॉन्च होने पर अपने-आप अपडेट की जाँच करें",
  ...
  "settings.updates.toast.latest.description": "आप Loginom AI Agent का नवीनतम संस्करण चला रहे हैं।",
