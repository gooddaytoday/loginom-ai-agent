...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "Loginom AI Agent 載入失敗",
  "desktop.recovery.terminated": "Loginom AI Agent 視窗意外終止",
  "desktop.recovery.unresponsive": "Loginom AI Agent 沒有回應",
  ...
  "desktop.wsl.error.installOpencode": "Loginom AI Agent 安裝失敗",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}} 中未安裝 Loginom AI Agent",
  "desktop.wsl.error.updateVersion":
    "Loginom AI Agent 更新完成，但 {{distro}} 回報的版本仍為 {{installed}}；預期版本為 {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "輸入你的 {{provider}} API 金鑰以連線帳戶，並在 Loginom AI Agent 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 取得授權碼，以連線你的帳戶並在 Loginom AI Agent 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " 並輸入以下程式碼，以連線你的帳戶並在 Loginom AI Agent 中使用 {{provider}} 模型。",
  ...
  "dialog.plugins.empty": "在 loginom-ai-agent.json 中設定的外掛程式",
  ...
  "dialog.server.description": "切換此應用程式連線的 Loginom AI Agent 伺服器。",
  ...
  "wsl.onboarding.checkingOpencode": "正在檢查 Loginom AI Agent...",
  "wsl.onboarding.checkingOpencodeIn": "正在檢查 {{distro}} 中的 Loginom AI Agent...",
  ...
  "wsl.onboarding.opencodeReadyIn": "{{distro}} 中的 Loginom AI Agent 已就緒。",
  "wsl.onboarding.opencodeReady": "Loginom AI Agent 已就緒。",
  "wsl.onboarding.installOpencodeIn": "在 {{distro}} 中安裝 Loginom AI Agent。",
  "wsl.onboarding.installOpencode": "安裝 Loginom AI Agent",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "未安裝 Loginom AI Agent",
  ...
  "wsl.onboarding.wslUnavailable.description": "Loginom AI Agent 無法確認此電腦上的 WSL。",
  "wsl.onboarding.installWsl": "安裝 WSL",
  "wsl.onboarding.windowsRestartRequired": "重新啟動 Windows 以完成 WSL 安裝，然後重新開啟 Loginom AI Agent。",
  ...
  "help.tabs.introduction": "Loginom AI Agent Desktop 現在以分頁為核心。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Loginom AI Agent 有新版本 ({{version}}) 可安裝。",
  ...
  "error.page.report.prefix": "請將此錯誤回報給 Loginom AI Agent 團隊",
  ...
  "error.chain.checkConfig": "請檢查你的設定 (loginom-ai-agent.json) 中的 provider/model 名稱",
  "error.chain.mcpFailed": "MCP 伺服器「{{name}}」啟動失敗。注意：Loginom AI Agent 尚不支援 MCP 驗證。",
  ...
  "settings.desktop.wsl.description": "在 Windows 上的 WSL 中執行 Loginom AI Agent 伺服器。",
  ...
  "settings.general.row.language.description": "變更 Loginom AI Agent 的顯示語言",
  ...
  "settings.general.row.appearance.description": "自訂 Loginom AI Agent 在你的裝置上的外觀",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "選擇 Loginom AI Agent 要跟隨系統、淺色或深色主題",
  "settings.general.row.theme.title": "主題",
  "settings.general.row.theme.description": "自訂 Loginom AI Agent 的主題。",
  ...
  "settings.updates.row.startup.description": "在 Loginom AI Agent 啟動時自動檢查更新",
