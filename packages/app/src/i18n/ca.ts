...
export const dict = {
  ...
  "desktop.menu.documentation": "Loginom AI Agent Documentació",
  ...
  "desktop.menu.ariaLabel": "menú Loginom AI Agent.",
  ...
  "desktop.recovery.loadFailed": "Loginom AI Agent no s'ha pogut carregar",
  "desktop.recovery.terminated": "La finestra Loginom AI Agent s'ha acabat inesperadament",
  "desktop.recovery.unresponsive": "Loginom AI Agent no respon",
  ...
  "desktop.wsl.error.installOpencode": "La instal·lació de Loginom AI Agent ha fallat",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Loginom AI Agent no està instal·lat a {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Loginom AI Agent actualització acabada però {{distro}} encara informa {{installed}}; esperat {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Introduïu la clau API de {{provider}} per connectar el compte i utilitzar els models de {{provider}} a Loginom AI Agent.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " per recollir el vostre codi d'autorització per connectar el vostre compte i utilitzar {{provider}} models a Loginom AI Agent.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i introduïu el codi següent per connectar el vostre compte i utilitzar {{provider}} models a Loginom AI Agent.",
  ...
  "dialog.plugins.empty": "Connectors configurats a loginom-ai-agent.json",
  ...
  "dialog.server.description": "Canvia a quin Loginom AI Agent servidor es connecta aquesta aplicació.",
  ...
  "wsl.onboarding.checkingOpencode": "S'està comprovant Loginom AI Agent...",
  "wsl.onboarding.checkingOpencodeIn": "S'està registrant Loginom AI Agent a {{distro}}...",
  "wsl.onboarding.updatingOpencode": "S'està actualitzant Loginom AI Agent...",
  "wsl.onboarding.updatingOpencodeIn": "S'està actualitzant Loginom AI Agent a {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualitza Loginom AI Agent a {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualització Loginom AI Agent",
  "wsl.onboarding.opencodeReadyIn": "Loginom AI Agent està llest a {{distro}}.",
  "wsl.onboarding.opencodeReady": "Loginom AI Agent està llest.",
  "wsl.onboarding.installOpencodeIn": "Instal·leu Loginom AI Agent a {{distro}}.",
  "wsl.onboarding.installOpencode": "Instal·la Loginom AI Agent",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Loginom AI Agent no instal·lat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsistema per a Linux) és necessari abans que Loginom AI Agent pugui afegir un WSL servidor",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "Loginom AI Agent no ha pogut verificar WSL en aquesta màquina.",
  "wsl.onboarding.installWsl": "Instal·la WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicieu Windows per acabar d'instal·lar WSL i, a continuació, torneu a obrir Loginom AI Agent.",
  ...
  "help.tabs.introduction": "Loginom AI Agent L'escriptori ara està construït al voltant de pestanyes.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nova versió de Loginom AI Agent ({{version}}) ja està disponible per instal·lar-la.",
  ...
  "error.page.report.prefix": "Informeu aquest error a l'equip Loginom AI Agent.",
  ...
  "error.chain.checkConfig": "Comproveu els noms del vostre proveïdor/model de configuració (loginom-ai-agent.json).",
  "error.chain.mcpFailed":
    'El servidor MCP "{{name}}" ha fallat. Tingueu en compte que Loginom AI Agent encara no admet l\'autenticació MCP.',
  ...
  "app.name.desktop": "Loginom AI Agent Escriptori",
  ...
  "settings.desktop.wsl.description": "Executeu el servidor Loginom AI Agent dins de WSL a Windows.",
  ...
  "settings.general.row.language.description": "Canvia l'idioma de visualització per a Loginom AI Agent",
  ...
  "settings.general.row.appearance.description": "Personalitza com es veu Loginom AI Agent al teu dispositiu",
  "settings.general.row.colorScheme.title": "Esquema de colors",
  "settings.general.row.colorScheme.description": "Trieu si Loginom AI Agent segueix el tema del sistema, clar o fosc",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalitza la temàtica de Loginom AI Agent.",
  ...
  "settings.updates.row.startup.description":
    "Comprova automàticament si hi ha actualitzacions quan s'iniciï Loginom AI Agent.",
  ...
  "settings.updates.toast.latest.description": "Esteu executant la darrera versió de Loginom AI Agent.",
