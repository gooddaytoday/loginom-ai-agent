...
export const dict = {
  ...
  "desktop.menu.documentation": "Documentação do Loginom AI Agent",
  ...
  "desktop.menu.ariaLabel": "Menu do Loginom AI Agent",
  ...
  "desktop.recovery.loadFailed": "Falha ao carregar o Loginom AI Agent",
  "desktop.recovery.terminated": "A janela do Loginom AI Agent foi encerrada inesperadamente",
  "desktop.recovery.unresponsive": "O Loginom AI Agent não está respondendo",
  ...
  "desktop.wsl.error.installOpencode": "Falha na instalação do Loginom AI Agent",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "O Loginom AI Agent não está instalado em {{distro}}",
  "desktop.wsl.error.updateVersion":
    "A atualização do Loginom AI Agent foi concluída, mas {{distro}} ainda informa a versão {{installed}}; a versão esperada é {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no Loginom AI Agent.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no Loginom AI Agent.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no Loginom AI Agent.",
  ...
  "dialog.plugins.empty": "Plugins configurados em loginom-ai-agent.json",
  ...
  "dialog.server.description": "Trocar para qual servidor Loginom AI Agent este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingOpencode": "Verificando o Loginom AI Agent...",
  "wsl.onboarding.checkingOpencodeIn": "Verificando o Loginom AI Agent em {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atualizando o Loginom AI Agent...",
  "wsl.onboarding.updatingOpencodeIn": "Atualizando o Loginom AI Agent em {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atualize o Loginom AI Agent em {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atualizar o Loginom AI Agent",
  "wsl.onboarding.opencodeReadyIn": "O Loginom AI Agent está pronto em {{distro}}.",
  "wsl.onboarding.opencodeReady": "O Loginom AI Agent está pronto.",
  "wsl.onboarding.installOpencodeIn": "Instale o Loginom AI Agent em {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar o Loginom AI Agent",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Loginom AI Agent não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o Loginom AI Agent possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O Loginom AI Agent não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o Loginom AI Agent novamente.",
  ...
  "help.tabs.introduction": "Agora, o Loginom AI Agent Desktop é organizado em abas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Uma nova versão do Loginom AI Agent ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do Loginom AI Agent",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (loginom-ai-agent.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: Loginom AI Agent ainda não suporta autenticação MCP.',
  ...
  "settings.desktop.wsl.description": "Executar o servidor Loginom AI Agent dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do Loginom AI Agent",
  ...
  "settings.general.row.appearance.description": "Personalize como o Loginom AI Agent aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o Loginom AI Agent segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o Loginom AI Agent é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o Loginom AI Agent iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do Loginom AI Agent.",
