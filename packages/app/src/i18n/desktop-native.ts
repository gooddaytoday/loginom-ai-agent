...
export const DESKTOP_NATIVE_ENGLISH = {
  ...
  "desktop.recovery.loadFailed": "Loginom AI Agent failed to load",
  "desktop.recovery.terminated": "Loginom AI Agent window terminated unexpectedly",
  "desktop.recovery.unresponsive": "Loginom AI Agent is not responding",
  ...
  "desktop.wsl.error.installOpencode": "Loginom AI Agent installation failed",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Loginom AI Agent is not installed in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Loginom AI Agent update finished but {{distro}} still reports {{installed}}; expected {{expected}}",
