...
export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacija za Loginom AI Agent",
  ...
  "desktop.menu.ariaLabel": "Loginom AI Agent meni",
  ...
  "desktop.recovery.loadFailed": "Loginom AI Agent se nije uspio učitati",
  "desktop.recovery.terminated": "Prozor Loginom AI Agent-a neočekivano je zatvoren",
  "desktop.recovery.unresponsive": "Loginom AI Agent ne reaguje",
  ...
  "desktop.wsl.error.installOpencode": "Instalacija Loginom AI Agent-a nije uspjela",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Loginom AI Agent nije instaliran u distribuciji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Ažuriranje Loginom AI Agent-a je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Loginom AI Agent-u.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Loginom AI Agent-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Loginom AI Agent-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u loginom-ai-agent.json",
  ...
  "dialog.server.description": "Promijeni na koji se Loginom AI Agent server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingOpencode": "Provjera Loginom AI Agent...",
  "wsl.onboarding.checkingOpencodeIn": "Provjera Loginom AI Agent u distribuciji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje Loginom AI Agent...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje Loginom AI Agent u distribuciji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažuriraj Loginom AI Agent u distribuciji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažuriraj Loginom AI Agent",
  "wsl.onboarding.opencodeReadyIn": "Loginom AI Agent je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.opencodeReady": "Loginom AI Agent je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instaliraj Loginom AI Agent u distribuciji {{distro}}.",
  "wsl.onboarding.installOpencode": "Instaliraj Loginom AI Agent",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Loginom AI Agent nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi Loginom AI Agent mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "Loginom AI Agent nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori Loginom AI Agent.",
  ...
  "help.tabs.introduction": "Loginom AI Agent Desktop sada je organizovan oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija Loginom AI Agent-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku Loginom AI Agent timu",
  ...
  "error.chain.checkConfig": "Provjeri nazive provajdera/modela u konfiguraciji (loginom-ai-agent.json)",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: Loginom AI Agent još ne podržava MCP autentifikaciju.',
  ...
  "settings.desktop.wsl.description": "Pokreni Loginom AI Agent server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Loginom AI Agent-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako Loginom AI Agent izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li Loginom AI Agent prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Loginom AI Agent-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Loginom AI Agent pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Loginom AI Agent-a.",
