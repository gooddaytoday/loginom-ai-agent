...
export const dict = {
  ...
  "desktop.menu.documentation": "Loginom AI Agent دیاں دستاویزاں",
  ...
  "desktop.recovery.loadFailed": "Loginom AI Agent لوڈ نئیں ہو سکیا",
  "desktop.recovery.terminated": "Loginom AI Agent دی ونڈو اچانک بند ہو گئی",
  "desktop.recovery.unresponsive": "Loginom AI Agent جواب نئیں دے رہیا",
  ...
  "desktop.wsl.error.installOpencode": "Loginom AI Agent دی تنصیب ناکام ہو گئی",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}} وچ Loginom AI Agent انسٹال نئیں اے",
  "desktop.wsl.error.updateVersion":
    "Loginom AI Agent دی اپ ڈیٹ پوری ہو گئی پر {{distro}} ہلے وی {{installed}} دس رہیا اے؛ {{expected}} چاہیدا سی",
  ...
  "provider.connect.apiKey.description":
    "اپنے اکاؤنٹ نوں جوڑن لئی اپنی {{provider}} API کلید درج کرو تے Loginom AI Agent وچ {{provider}} ماڈل ورتو۔",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " اپنے اکاؤنٹ نوں جوڑن تے Loginom AI Agent وچ {{provider}} ماڈل ورتن لئی اپنا اجازت کوڈ حاصل کرن لئی۔",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " تے اپنے اکاؤنٹ نوں جوڑن تے Loginom AI Agent وچ {{provider}} ماڈل ورتن لئی تھلے دتا کوڈ درج کرو۔",
  ...
  "dialog.plugins.empty": "loginom-ai-agent.json وچ سیٹ کیتے پلگ اِن",
  ...
  "dialog.server.description": "ایہہ ایپ کس Loginom AI Agent سرور نال جڑدی اے، اس نوں سوئچ کرو۔",
  ...
  "wsl.onboarding.checkingOpencode": "Loginom AI Agent چیک کر رئے آں...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} چ Loginom AI Agent دی جانچ پڑتال...",
  "wsl.onboarding.updatingOpencode": "Loginom AI Agent نو اپ ڈیٹ کر رئے آں...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} وچ Loginom AI Agent نو اپ ڈیٹ کر رئے آں...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} وچ Loginom AI Agent نو اپ ڈیٹ کرو۔",
  "wsl.onboarding.updateOpencode": "Loginom AI Agent اپ ڈیٹ کرو",
  "wsl.onboarding.opencodeReadyIn": "Loginom AI Agent {{distro}} چ تیار اے۔",
  "wsl.onboarding.opencodeReady": "Loginom AI Agent تیار اے۔",
  "wsl.onboarding.installOpencodeIn": "{{distro}} وچ Loginom AI Agent انسٹال کرو۔",
  "wsl.onboarding.installOpencode": "Loginom AI Agent انسٹال کرو",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Loginom AI Agent انسٹال نئیں کیتا گیا",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Loginom AI Agent دے WSL سرور شامل کرن توں پہلاں WSL (Windows Subsystem for Linux) دی لوڑ اے",
  "wsl.onboarding.wslUnavailable.title": "WSL دستیاب نئیں",
  "wsl.onboarding.wslUnavailable.description": "Loginom AI Agent ایس مشین تے WSL دی تصدیق نئیں کر سکیا۔",
  "wsl.onboarding.installWsl": "WSL انسٹال کرو",
  "wsl.onboarding.windowsRestartRequired":
    "WSL دی تنصیب پوری کرن لئی Windows نوں دوبارہ شروع کرو، فیر Loginom AI Agent دوبارہ کھولو۔",
  ...
  "help.tabs.introduction": "Loginom AI Agent Desktop ہن ٹیباں دے گرد بنایا گیا اے۔",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Loginom AI Agent ({{version}}) دا اک نواں ورژن ہن انسٹال کرن لئی دستیاب اے۔",
  ...
  "error.page.report.prefix": "مہربانی کر کے اس غلطی دی اطلاع Loginom AI Agent ٹیم نوں دیو",
  ...
  "error.chain.checkConfig": "اپنی کنفگ (loginom-ai-agent.json) وچ پرووائیڈر/ماڈل دے ناں چیک کرو",
  "error.chain.mcpFailed": 'MCP سرور "{{name}}" ناکام ہو گیا۔ نوٹ، Loginom AI Agent ہلے تک MCP تصدیق دی حمایت نئیں کردا۔',
  ...
  "settings.desktop.wsl.description": "Windows تے WSL دے اندر Loginom AI Agent سرور چلاؤ۔",
  ...
  "settings.general.row.language.description": "Loginom AI Agent لئی ڈسپلے دی بولی بدلو",
  ...
  "settings.general.row.appearance.description": "اپنے آلے تے Loginom AI Agent کیویں لگدا اے، اپنی مرضی دے مطابق بناؤ",
  "settings.general.row.colorScheme.title": "رنگ سکیم",
  "settings.general.row.colorScheme.description": "چنو کہ آیا Loginom AI Agent سسٹم، لائٹ، یا ڈارک تھیم دی پیروی کردا اے",
  "settings.general.row.theme.title": "تھیم",
  "settings.general.row.theme.description": "Loginom AI Agent نوں کس طرح تھیم کیتا گیا اے، اپنی مرضی دے مطابق بناؤ۔",
  ...
  "settings.updates.row.startup.description": "جدوں Loginom AI Agent لانچ ہوندا اے تے خودبخود اپ ڈیٹس چیک کرو",
  ...
  "settings.updates.toast.latest.description": "تسی Loginom AI Agent دا تازہ ترین ورژن چلا رئے او۔",
