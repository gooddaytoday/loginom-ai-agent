...
const desktop = [
  ...
  "Suskleisti",
  "Išskleisti",
  "Loginom AI Agent dokumentacija",
  "Pagalbos forumas",
  "Pateikti atsiliepimą",
  "Pranešti apie klaidą",
  "Loginom AI Agent meniu",
  ...
  "Laukti toliau",
  "Baigti darbą",
  "Loginom AI Agent įkelti nepavyko",
  "Loginom AI Agent langas netikėtai užsidarė",
  "Loginom AI Agent neatsako",
  ...
  "Loginom AI Agent įdiegti nepavyko",
  "{{distro}} jau pridėtas",
  "opencode šiame distributyve neįdiegtas",
  "opencode įdiegtas, bet jo paleisti nepavyko",
  "Loginom AI Agent neįdiegtas distributyve {{distro}}",
  "Loginom AI Agent naujinimas baigtas, bet {{distro}} vis dar praneša {{installed}}; tikėtasi {{expected}}",
  "versijos nėra",
...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Įveskite {{provider}} API raktą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius programoje Loginom AI Agent.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "rinkti prieigos kodą, kad galėtumėte prisijungti prie paskyros ir naudoti {{provider}} modelius Loginom AI Agent.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "ir įveskite toliau esantį kodą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius Loginom AI Agent.",
  ...
  "dialog.plugins.empty": "Papildiniai sukonfigūruoti loginom-ai-agent.json",
  ...
  "dialog.server.description": "Perjunkite, prie kurio Loginom AI Agent serverio jungiasi ši programa.",
  ...
  "wsl.onboarding.checkingOpencode": "Tikrinama Loginom AI Agent...",
  "wsl.onboarding.checkingOpencodeIn": "Tikrinama Loginom AI Agent {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atnaujinamas Loginom AI Agent...",
  "wsl.onboarding.updatingOpencodeIn": "Atnaujinamas Loginom AI Agent {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atnaujinkite Loginom AI Agent {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atnaujinkite Loginom AI Agent",
  "wsl.onboarding.opencodeReadyIn": "Loginom AI Agent yra paruoštas {{distro}}.",
  "wsl.onboarding.opencodeReady": "Loginom AI Agent yra paruoštas.",
  "wsl.onboarding.installOpencodeIn": "Įdiekite Loginom AI Agent į {{distro}}.",
  "wsl.onboarding.installOpencode": "Įdiekite Loginom AI Agent",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Loginom AI Agent neįdiegtas",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Kad Loginom AI Agent galėtų pridėti WSL serverį, reikalingas WSL (Windows posistemis, skirtas Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL nepasiekiamas",
  "wsl.onboarding.wslUnavailable.description": "Loginom AI Agent nepavyko patikrinti WSL šiame įrenginyje.",
  "wsl.onboarding.installWsl": "Įdiekite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Iš naujo paleiskite Windows, kad užbaigtumėte WSL diegimą, tada iš naujo atidarykite Loginom AI Agent.",
  ...
  "help.tabs.introduction": "Loginom AI Agent Desktop dabar sukurtas iš skirtukų.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Dabar galima įdiegti naują Loginom AI Agent ({{version}}) versiją.",
  ...
  "error.page.report.prefix": "Praneškite apie šią klaidą Loginom AI Agent komandai",
  ...
  "error.chain.checkConfig": "Patikrinkite konfigūracijos (loginom-ai-agent.json) teikėjo / modelio pavadinimus",
  "error.chain.mcpFailed":
    "MCP serveris „{{name}}“ nepavyko. Atminkite, kad Loginom AI Agent dar nepalaiko MCP autentifikavimo.",
  ...
  "app.name.desktop": "Loginom AI Agent darbalaukis",
  ...
  "settings.desktop.wsl.description": "Paleiskite Loginom AI Agent serverį WSL viduje Windows.",
  ...
  "settings.general.row.language.description": "Pakeiskite Loginom AI Agent ekrano kalbą",
  ...
  "settings.general.row.appearance.description": "Tinkinkite, kaip Loginom AI Agent atrodo jūsų įrenginyje",
  "settings.general.row.colorScheme.title": "Spalvų schema",
  "settings.general.row.colorScheme.description": "Pasirinkite, ar Loginom AI Agent seka sistemos, šviesios ar tamsios temos",
  "settings.general.row.theme.title": "tema",
  "settings.general.row.theme.description": "Tinkinkite Loginom AI Agent temą.",
  ...
  "settings.updates.row.startup.description": "Automatiškai patikrinkite, ar nėra naujinimų, kai paleidžiamas Loginom AI Agent",
  ...
  "settings.updates.toast.latest.description": "Naudojate naujausią Loginom AI Agent versiją.",
