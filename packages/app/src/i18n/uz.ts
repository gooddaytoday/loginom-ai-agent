...
export const dict = {
  ...
  "desktop.menu.documentation": "Loginom AI Agent hujjatlari",
  ...
  "desktop.menu.ariaLabel": "Loginom AI Agent menyusi",
  ...
  "desktop.recovery.loadFailed": "Loginom AI Agent yuklanmadi",
  "desktop.recovery.terminated": "Loginom AI Agent oynasi kutilmaganda tugatildi",
  "desktop.recovery.unresponsive": "Loginom AI Agent javob bermayapti",
  ...
  "desktop.wsl.error.installOpencode": "Loginom AI Agent oʻrnatilmadi",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Loginom AI Agent {{distro}} da o'rnatilmagan",
  "desktop.wsl.error.updateVersion":
    "Loginom AI Agent yangilanishi tugallandi, lekin {{distro}} hali ham {{installed}} haqida xabar beradi; kutilgan {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Hisobingizni ulash va Loginom AI Agent’da {{provider}} modellaridan foydalanish uchun {{provider}} API kalitini kiriting.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " hisobingizni ulash va Loginom AI Agent da {{provider}} modellaridan foydalanish uchun avtorizatsiya kodingizni yig'ish.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " va hisobingizni ulash uchun quyidagi kodni kiriting va Loginom AI Agent da {{provider}} modellaridan foydalaning.",
  ...
  "dialog.plugins.empty": "loginom-ai-agent.json da sozlangan plaginlar",
  ...
  "dialog.server.description": "Ushbu ilova qaysi Loginom AI Agent serveriga ulanishini almashtiring.",
  ...
  "wsl.onboarding.checkingOpencode": "Loginom AI Agent tekshirilmoqda...",
  "wsl.onboarding.checkingOpencodeIn": "Loginom AI Agent {{distro}} da tekshirilmoqda...",
  "wsl.onboarding.updatingOpencode": "Loginom AI Agent yangilanmoqda...",
  "wsl.onboarding.updatingOpencodeIn": "Loginom AI Agent {{distro}} da yangilanmoqda...",
  "wsl.onboarding.updateOpencodeIn": "Loginom AI Agent-ni {{distro}}-da yangilang.",
  "wsl.onboarding.updateOpencode": "Loginom AI Agent-ni yangilang",
  "wsl.onboarding.opencodeReadyIn": "Loginom AI Agent {{distro}} da tayyor.",
  "wsl.onboarding.opencodeReady": "Loginom AI Agent tayyor.",
  "wsl.onboarding.installOpencodeIn": "Loginom AI Agent-ni {{distro}}-ga o'rnating.",
  "wsl.onboarding.installOpencode": "Loginom AI Agent-ni o'rnating",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Loginom AI Agent o'rnatilmagan",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Loginom AI Agent WSL serverini qoʻshishdan oldin WSL (Linux uchun Windows quyi tizimi) talab qilinadi.",
  "wsl.onboarding.wslUnavailable.title": "WSL mavjud emas",
  "wsl.onboarding.wslUnavailable.description": "Loginom AI Agent WSL ni ushbu mashinada tasdiqlay olmadi.",
  "wsl.onboarding.installWsl": "WSL-ni o'rnating",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-ni o'rnatishni tugatish uchun Windows-ni qayta ishga tushiring, so'ngra Loginom AI Agent-ni qayta oching.",
  ...
  "help.tabs.introduction": "Loginom AI Agent Desktop endi yorliqlar atrofida qurilgan.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Loginom AI Agent ({{version}}) yangi versiyasi endi oʻrnatish mumkin.",
  ...
  "error.page.report.prefix": "Iltimos, ushbu xato haqida Loginom AI Agent jamoasiga xabar bering",
  ...
  "error.chain.checkConfig": "Konfiguratsiya (loginom-ai-agent.json) provayder/model nomlarini tekshiring",
  "error.chain.mcpFailed":
    "MCP \"{{name}}\" serveri muvaffaqiyatsiz tugadi. E'tibor bering, Loginom AI Agent hali MCP autentifikatsiyasini qo'llab-quvvatlamaydi.",
  ...
  "settings.desktop.wsl.description": "Windows da WSL ichidagi Loginom AI Agent serverini ishga tushiring.",
  ...
  "settings.general.row.language.description": "Loginom AI Agent uchun ekran tilini o'zgartiring",
  ...
  "settings.general.row.appearance.description": "Loginom AI Agent qurilmangizda qanday koʻrinishini sozlang",
  "settings.general.row.colorScheme.title": "Rang sxemasi",
  "settings.general.row.colorScheme.description":
    "Loginom AI Agent tizimga, yorugʻlik yoki qorongʻi mavzuga amal qilishini tanlang",
  "settings.general.row.theme.title": "Mavzu",
  "settings.general.row.theme.description": "Loginom AI Agent mavzusini sozlash.",
  ...
  "settings.updates.row.startup.description": "Loginom AI Agent ishga tushganda avtomatik ravishda yangilanishlarni tekshiring",
  ...
  "settings.updates.toast.latest.description": "Siz Loginom AI Agent oxirgi versiyasini ishga tushiryapsiz.",
