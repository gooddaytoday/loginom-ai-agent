...
export const dict = {
  ...
  "desktop.menu.documentation": "Loginom AI Agent 文档",
  "desktop.menu.supportForum": "支持论坛",
  "desktop.menu.shareFeedback": "提供反馈",
  "desktop.menu.reportBug": "报告错误",
  "desktop.menu.ariaLabel": "Loginom AI Agent 菜单",
  ...
  "desktop.recovery.loadFailed": "Loginom AI Agent 加载失败",
  "desktop.recovery.terminated": "Loginom AI Agent 窗口意外终止",
  "desktop.recovery.unresponsive": "Loginom AI Agent 未响应",
  ...
  "desktop.wsl.error.installOpencode": "Loginom AI Agent 安装失败",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}} 中未安装 Loginom AI Agent",
  "desktop.wsl.error.updateVersion":
    "Loginom AI Agent 更新已完成，但 {{distro}} 仍报告版本 {{installed}}；预期版本为 {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接账户，并在 Loginom AI Agent 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的账户并在 Loginom AI Agent 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的账户并在 Loginom AI Agent 中使用 {{provider}} 模型。",
  ...
  "dialog.plugins.empty": "在 loginom-ai-agent.json 中配置的插件",
  ...
  "dialog.server.description": "切换此应用连接的 Loginom AI Agent 服务器。",
  ...
  "wsl.onboarding.checkingOpencode": "正在检查 Loginom AI Agent...",
  "wsl.onboarding.checkingOpencodeIn": "正在检查 {{distro}} 中的 Loginom AI Agent...",
  "wsl.onboarding.updatingOpencode": "正在更新 Loginom AI Agent...",
  "wsl.onboarding.updatingOpencodeIn": "正在更新 {{distro}} 中的 Loginom AI Agent...",
  "wsl.onboarding.updateOpencodeIn": "更新 {{distro}} 中的 Loginom AI Agent。",
  "wsl.onboarding.updateOpencode": "更新 Loginom AI Agent",
  "wsl.onboarding.opencodeReadyIn": "{{distro}} 中的 Loginom AI Agent 已就绪。",
  "wsl.onboarding.opencodeReady": "Loginom AI Agent 已就绪。",
  "wsl.onboarding.installOpencodeIn": "在 {{distro}} 中安装 Loginom AI Agent。",
  "wsl.onboarding.installOpencode": "安装 Loginom AI Agent",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "未安装 Loginom AI Agent",
  ...
  "wsl.onboarding.wslNotInstalled.description": "Loginom AI Agent 需要 WSL（Windows Subsystem for Linux）才能添加 WSL 服务器",
  "wsl.onboarding.wslUnavailable.title": "WSL 不可用",
  "wsl.onboarding.wslUnavailable.description": "Loginom AI Agent 无法验证此设备上的 WSL。",
  "wsl.onboarding.installWsl": "安装 WSL",
  "wsl.onboarding.windowsRestartRequired": "重启 Windows 以完成 WSL 安装，然后重新打开 Loginom AI Agent。",
  ...
  "help.tabs.introduction": "Loginom AI Agent Desktop 现已采用以标签页为核心的设计。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Loginom AI Agent 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 Loginom AI Agent 团队",
  ...
  "error.chain.checkConfig": "请检查你的配置 (loginom-ai-agent.json) 中的 provider/model 名称",
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意：Loginom AI Agent 暂不支持 MCP 认证。',
  ...
  "settings.desktop.wsl.description": "在 Windows 的 WSL 环境中运行 Loginom AI Agent 服务器。",
  ...
  "settings.general.row.language.description": "更改 Loginom AI Agent 的显示语言",
  ...
  "settings.general.row.appearance.description": "自定义 Loginom AI Agent 在你的设备上的外观",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "选择 Loginom AI Agent 跟随系统、浅色或深色主题",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 Loginom AI Agent 的主题。",
  ...
  "settings.updates.row.startup.description": "在 Loginom AI Agent 启动时自动检查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 Loginom AI Agent。",
