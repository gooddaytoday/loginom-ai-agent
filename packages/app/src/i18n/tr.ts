...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "Loginom AI Agent yüklenemedi",
  "desktop.recovery.terminated": "Loginom AI Agent penceresi beklenmedik şekilde sonlandırıldı",
  "desktop.recovery.unresponsive": "Loginom AI Agent yanıt vermiyor",
  ...
  "desktop.wsl.error.installOpencode": "Loginom AI Agent kurulamadı",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Loginom AI Agent, {{distro}} içinde kurulu değil",
  "desktop.wsl.error.updateVersion":
    "Loginom AI Agent güncellemesi tamamlandı ancak {{distro}} hâlâ {{installed}} sürümünü bildiriyor; beklenen sürüm: {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve Loginom AI Agent'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak Loginom AI Agent'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak Loginom AI Agent'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler loginom-ai-agent.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi Loginom AI Agent sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingOpencode": "Loginom AI Agent kontrol ediliyor...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} içinde Loginom AI Agent kontrol ediliyor...",
  "wsl.onboarding.updatingOpencode": "Loginom AI Agent güncelleniyor...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} içinde Loginom AI Agent güncelleniyor...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} içindeki Loginom AI Agent'u güncelleyin.",
  "wsl.onboarding.updateOpencode": "Loginom AI Agent'u güncelle",
  "wsl.onboarding.opencodeReadyIn": "{{distro}} içinde Loginom AI Agent hazır.",
  "wsl.onboarding.opencodeReady": "Loginom AI Agent hazır.",
  "wsl.onboarding.installOpencodeIn": "Loginom AI Agent'u {{distro}} içine kurun.",
  "wsl.onboarding.installOpencode": "Loginom AI Agent'u kur",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Loginom AI Agent kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Loginom AI Agent'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "Loginom AI Agent bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından Loginom AI Agent'u tekrar açın.",
  ...
  "help.tabs.introduction": "Loginom AI Agent Desktop artık sekmeler üzerine kurulu.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Loginom AI Agent'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı Loginom AI Agent ekibine",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızdaki (loginom-ai-agent.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" çalıştırılamadı. Not: Loginom AI Agent henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "app.name.desktop": "Loginom AI Agent Masaüstü",
  ...
  "settings.desktop.wsl.description": "Loginom AI Agent sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "Loginom AI Agent'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "Loginom AI Agent'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "Loginom AI Agent'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Loginom AI Agent'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "Loginom AI Agent başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "Loginom AI Agent'un en son sürümünü kullanıyorsunuz.",
