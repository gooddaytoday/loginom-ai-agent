...
const desktop = [
  ...
  "Lágmarka",
  "Hámarka",
  "Loginom AI Agent skjölun",
  "Aðstoðarspjallborð",
  "Deila ábendingu",
  "Tilkynna villu",
  "Loginom AI Agent-valmynd",
  ...
  "Bíða áfram",
  "Hætta",
  "Ekki tókst að hlaða Loginom AI Agent",
  "Loginom AI Agent-glugganum var óvænt lokað",
  "Loginom AI Agent svarar ekki",
  ...
  "Uppsetning Loginom AI Agent mistókst",
  ...
  "Loginom AI Agent er ekki uppsett í {{distro}}",
  "Uppfærslu Loginom AI Agent lauk en {{distro}} tilkynnir enn {{installed}}; vænt var {{expected}}",
  "engin útgáfa",
...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Sláðu inn API-lykilinn þinn fyrir {{provider}} til að tengja reikninginn og nota líkön frá {{provider}} í Loginom AI Agent.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "til að safna heimildarkóðanum þínum til að tengja reikninginn þinn og nota {{provider}} gerðir í Loginom AI Agent.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "og sláðu inn kóðann hér að neðan til að tengja reikninginn þinn og nota {{provider}} gerðir í Loginom AI Agent.",
  ...
  "dialog.plugins.empty": "Viðbætur stilltar í loginom-ai-agent.json",
  ...
  "dialog.server.description": "Skiptu um hvaða Loginom AI Agent miðlara þetta app tengist.",
  ...
  "wsl.onboarding.checkingOpencode": "Athugar Loginom AI Agent...",
  "wsl.onboarding.checkingOpencodeIn": "Athugar Loginom AI Agent í {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Uppfærir Loginom AI Agent...",
  "wsl.onboarding.updatingOpencodeIn": "Uppfærir Loginom AI Agent í {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Uppfærðu Loginom AI Agent í {{distro}}.",
  "wsl.onboarding.updateOpencode": "Uppfærðu Loginom AI Agent",
  "wsl.onboarding.opencodeReadyIn": "Loginom AI Agent er tilbúið í {{distro}}.",
  "wsl.onboarding.opencodeReady": "Loginom AI Agent er tilbúinn.",
  "wsl.onboarding.installOpencodeIn": "Settu upp Loginom AI Agent í {{distro}}.",
  "wsl.onboarding.installOpencode": "Settu upp Loginom AI Agent",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Loginom AI Agent ekki uppsett",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows undirkerfi fyrir Linux) þarf áður en Loginom AI Agent getur bætt við WSL netþjóni",
  "wsl.onboarding.wslUnavailable.title": "WSL ekki í boði",
  "wsl.onboarding.wslUnavailable.description": "Loginom AI Agent gat ekki staðfest WSL á þessari vél.",
  "wsl.onboarding.installWsl": "Settu upp WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Endurræstu Windows til að klára að setja upp WSL, opnaðu síðan Loginom AI Agent aftur.",
  ...
  "help.tabs.introduction": "Loginom AI Agent Desktop er nú byggt í kringum flipa.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Ný útgáfa af Loginom AI Agent ({{version}}) er nú fáanleg til uppsetningar.",
  ...
  "error.page.report.prefix": "Vinsamlegast tilkynnið þessa villu til Loginom AI Agent teymisins",
  ...
  "error.chain.checkConfig": "Athugaðu stillingar (loginom-ai-agent.json) þjónustuveitu/módelheiti",
  "error.chain.mcpFailed": "MCP þjónn „{{name}}“ mistókst. Athugið, Loginom AI Agent styður ekki MCP auðkenningu ennþá.",
  ...
  "app.name.desktop": "Loginom AI Agent skjáborð",
  ...
  "settings.desktop.wsl.description": "Keyrðu Loginom AI Agent netþjóninn inni í WSL á Windows.",
  ...
  "settings.general.row.language.description": "Breyttu skjátungumálinu fyrir Loginom AI Agent",
  ...
  "settings.general.row.appearance.description": "Sérsníddu hvernig Loginom AI Agent lítur út á tækinu þínu",
  "settings.general.row.colorScheme.title": "Litasamsetning",
  "settings.general.row.colorScheme.description": "Veldu hvort Loginom AI Agent fylgir kerfis-, ljósu eða dökku þema",
  "settings.general.row.theme.title": "Þema",
  "settings.general.row.theme.description": "Sérsníddu hvernig Loginom AI Agent er þema.",
  ...
  "settings.updates.row.startup.description": "Athugaðu sjálfkrafa fyrir uppfærslur þegar Loginom AI Agent ræsir",
  ...
  "settings.updates.toast.latest.description": "Þú ert að keyra nýjustu útgáfuna af Loginom AI Agent.",
