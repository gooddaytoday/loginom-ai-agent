...
export const dict = {
  ...
  "desktop.menu.documentation": "Documentation d'Loginom AI Agent",
  ...
  "desktop.recovery.loadFailed": "Échec du chargement d'Loginom AI Agent",
  "desktop.recovery.terminated": "La fenêtre Loginom AI Agent s'est arrêtée de manière inattendue",
  "desktop.recovery.unresponsive": "Loginom AI Agent ne répond pas",
  ...
  "desktop.wsl.error.installOpencode": "Échec de l'installation d'Loginom AI Agent",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Loginom AI Agent n'est pas installé dans {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La mise à jour d'Loginom AI Agent est terminée, mais {{distro}} indique toujours {{installed}} au lieu de {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans Loginom AI Agent.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans Loginom AI Agent.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans Loginom AI Agent.",
  ...
  "dialog.plugins.empty": "Extensions configurées dans loginom-ai-agent.json",
  ...
  "dialog.server.description": "Changez le serveur Loginom AI Agent auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingOpencode": "Vérification d'Loginom AI Agent...",
  "wsl.onboarding.checkingOpencodeIn": "Vérification d'Loginom AI Agent dans {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Mise à jour d'Loginom AI Agent...",
  "wsl.onboarding.updatingOpencodeIn": "Mise à jour d'Loginom AI Agent dans {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Mettez à jour Loginom AI Agent dans {{distro}}.",
  "wsl.onboarding.updateOpencode": "Mettre à jour Loginom AI Agent",
  "wsl.onboarding.opencodeReadyIn": "Loginom AI Agent est prêt dans {{distro}}.",
  "wsl.onboarding.opencodeReady": "Loginom AI Agent est prêt.",
  "wsl.onboarding.installOpencodeIn": "Installez Loginom AI Agent dans {{distro}}.",
  "wsl.onboarding.installOpencode": "Installer Loginom AI Agent",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Loginom AI Agent non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'Loginom AI Agent puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "Loginom AI Agent n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez Loginom AI Agent.",
  ...
  "help.tabs.introduction": "Loginom AI Agent Desktop s'articule désormais autour d'onglets.",
  "help.tabs.sessions":
  ...
  "toast.update.description":
    "Une nouvelle version d'Loginom AI Agent ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe Loginom AI Agent",
  ...
  "error.chain.checkConfig": "Vérifiez les noms de fournisseur et de modèle dans votre configuration (loginom-ai-agent.json)",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'Loginom AI Agent ne prend pas encore en charge l'authentification MCP.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur Loginom AI Agent dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour Loginom AI Agent",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'Loginom AI Agent sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si Loginom AI Agent suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'Loginom AI Agent.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'Loginom AI Agent",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'Loginom AI Agent.",
