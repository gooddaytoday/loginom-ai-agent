...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "Loginom AI Agent laadimine ebaõnnestus",
  "desktop.recovery.terminated": "Loginom AI Agent aken suleti ootamatult",
  "desktop.recovery.unresponsive": "Loginom AI Agent ei vasta",
  ...
  "desktop.wsl.error.installOpencode": "Loginom AI Agent installimine ebaõnnestus",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Loginom AI Agent pole installitud asukohta {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Loginom AI Agent värskendus on lõpetatud, kuid {{distro}} teatab endiselt {{installed}}; oodata {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Sisestage {{provider}} API võti, et ühendada konto ja kasutada {{provider}} mudeleid Loginom AI Agent'is.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " konto ühendamiseks autoriseerimiskoodi kogumiseks ja {{provider}} mudeli kasutamiseks jaotises Loginom AI Agent.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja sisestage allolev kood, et ühendada oma konto ja kasutada {{provider}} mudelit jaotises Loginom AI Agent.",
  ...
  "dialog.plugins.empty": "Pluginad on konfigureeritud failis loginom-ai-agent.json",
  ...
  "dialog.server.description": "Lülitage, millise Loginom AI Agent serveriga see rakendus ühenduse loob.",
  ...
  "wsl.onboarding.checkingOpencode": "Loginom AI Agent kontrollimine...",
  "wsl.onboarding.checkingOpencodeIn": "Loginom AI Agent kontrollimine asukohas {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Loginom AI Agent värskendamine...",
  "wsl.onboarding.updatingOpencodeIn": "Loginom AI Agent värskendamine asukohas {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Värskenda Loginom AI Agent jaotises {{distro}}.",
  "wsl.onboarding.updateOpencode": "Värskenda Loginom AI Agent",
  "wsl.onboarding.opencodeReadyIn": "Loginom AI Agent on valmis {{distro}}.",
  "wsl.onboarding.opencodeReady": "Loginom AI Agent on valmis.",
  "wsl.onboarding.installOpencodeIn": "Installige Loginom AI Agent asukohta {{distro}}.",
  "wsl.onboarding.installOpencode": "Installige Loginom AI Agent",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Loginom AI Agent pole installitud",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows alamsüsteem Linux jaoks) on nõutav, enne kui Loginom AI Agent saab lisada WSL serveri",
  "wsl.onboarding.wslUnavailable.title": "WSL pole saadaval",
  "wsl.onboarding.wslUnavailable.description": "Loginom AI Agent ei saanud selles masinas kontrollida WSL.",
  "wsl.onboarding.installWsl": "Installige WSL",
  "wsl.onboarding.windowsRestartRequired": "Taaskäivitage Windows, et installida WSL, seejärel avage uuesti Loginom AI Agent.",
  ...
  "help.tabs.introduction": "Loginom AI Agent Töölaud on nüüd üles ehitatud vahekaartide ümber.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Rakenduse Loginom AI Agent ({{version}}) uus versioon on nüüd installimiseks saadaval.",
  ...
  "error.page.report.prefix": "Teatage sellest veast Loginom AI Agent meeskonnale",
  ...
  "error.chain.checkConfig": "Kontrollige oma konfiguratsiooni (loginom-ai-agent.json) pakkuja/mudeli nimesid",
  "error.chain.mcpFailed": 'MCP server "{{name}}" ebaõnnestus. Pange tähele, Loginom AI Agent ei toeta veel MCP autentimist.',
  ...
  "app.name.desktop": "Loginom AI Agent Töölaud",
  ...
  "settings.desktop.wsl.description": "Käivitage Loginom AI Agent server sees WSL saidil Windows.",
  ...
  "settings.general.row.language.description": "Muutke Loginom AI Agent kuvakeelt",
  ...
  "settings.general.row.appearance.description": "Kohandage, kuidas Loginom AI Agent teie seadmes välja näeb",
  "settings.general.row.colorScheme.title": "Värvilahendus",
  "settings.general.row.colorScheme.description": "Valige, kas Loginom AI Agent järgib süsteemi, heledat või tumedat teemat",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Kohandage, kuidas Loginom AI Agent on teemastatud.",
  ...
  "settings.updates.row.startup.description": "Kontrollige automaatselt värskendusi, kui Loginom AI Agent käivitub",
  ...
  "settings.updates.toast.latest.description": "Kasutate rakenduse Loginom AI Agent uusimat versiooni.",
