...
export const dict = {
  ...
  "desktop.menu.documentation": "Loginom AI Agent Dokumentacija",
  ...
  "desktop.recovery.loadFailed": "Loginom AI Agent ni uspelo naložiti",
  "desktop.recovery.terminated": "Okno Loginom AI Agent se je nepričakovano končalo",
  "desktop.recovery.unresponsive": "Loginom AI Agent se ne odziva",
  ...
  "desktop.wsl.error.installOpencode": "Namestitev Loginom AI Agent ni uspela",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Loginom AI Agent ni nameščen v {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Posodobitev Loginom AI Agent je končana, vendar {{distro}} še vedno poroča {{installed}}; pričakovano {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Vnesite ključ API ponudnika {{provider}}, da povežete račun in uporabljate modele {{provider}} v Loginom AI Agent.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " za zbiranje avtorizacijske kode za povezavo vašega računa in uporabo modelov {{provider}} v Loginom AI Agent.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " in vnesite spodnjo kodo, da povežete svoj račun in uporabite modele {{provider}} v Loginom AI Agent.",
  ...
  "dialog.plugins.empty": "Vtičniki, konfigurirani v loginom-ai-agent.json",
  ...
  "dialog.server.description": "Preklopite, s katerim strežnikom Loginom AI Agent se povezuje ta aplikacija.",
  ...
  "wsl.onboarding.checkingOpencode": "Preverjanje Loginom AI Agent ...",
  "wsl.onboarding.checkingOpencodeIn": "Preverjanje Loginom AI Agent v {{distro}} ...",
  "wsl.onboarding.updatingOpencode": "Posodabljanje Loginom AI Agent ...",
  "wsl.onboarding.updatingOpencodeIn": "Posodabljanje Loginom AI Agent v {{distro}} ...",
  "wsl.onboarding.updateOpencodeIn": "Posodobite Loginom AI Agent v {{distro}}.",
  "wsl.onboarding.updateOpencode": "Posodobite Loginom AI Agent",
  "wsl.onboarding.opencodeReadyIn": "Loginom AI Agent je pripravljen v {{distro}}.",
  "wsl.onboarding.opencodeReady": "Loginom AI Agent je pripravljen.",
  "wsl.onboarding.installOpencodeIn": "Namestite Loginom AI Agent v {{distro}}.",
  "wsl.onboarding.installOpencode": "Namestite Loginom AI Agent",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Loginom AI Agent ni nameščen",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (podsistem Windows za Linux) je potreben, preden lahko Loginom AI Agent doda strežnik WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL ni na voljo",
  "wsl.onboarding.wslUnavailable.description": "Loginom AI Agent ni mogel preveriti WSL na tej napravi.",
  "wsl.onboarding.installWsl": "Namestite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Znova zaženite Windows, da dokončate namestitev WSL, nato znova odprite Loginom AI Agent.",
  ...
  "help.tabs.introduction": "Loginom AI Agent Desktop je zdaj zgrajen okoli zavihkov.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova različica Loginom AI Agent ({{version}}) je zdaj na voljo za namestitev.",
  ...
  "error.page.report.prefix": "Prosimo, prijavite to napako ekipi Loginom AI Agent",
  ...
  "error.chain.checkConfig": "Preverite imena ponudnikov/modelov konfiguracije (loginom-ai-agent.json).",
  "error.chain.mcpFailed": 'MCP strežnik "{{name}}" ni uspel. Opomba, Loginom AI Agent še ne podpira avtentikacije MCP.',
  ...
  "settings.desktop.wsl.description": "Zaženite strežnik Loginom AI Agent znotraj WSL na Windows.",
  ...
  "settings.general.row.language.description": "Spremenite jezik prikaza za Loginom AI Agent",
  ...
  "settings.general.row.appearance.description": "Prilagodite, kako Loginom AI Agent izgleda na vaši napravi",
  "settings.general.row.colorScheme.title": "Barvna shema",
  "settings.general.row.colorScheme.description": "Izberite, ali Loginom AI Agent sledi sistemski, svetli ali temni temi",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite temo Loginom AI Agent.",
  ...
  "settings.updates.row.startup.description": "Samodejno preveri posodobitve, ko se zažene Loginom AI Agent",
  ...
  "settings.updates.toast.latest.description": "Uporabljate najnovejšo različico Loginom AI Agent.",
