...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "Loginom AI Agent መጫን አልቻለም",
  "desktop.recovery.terminated": "Loginom AI Agent መስኮት በድንገት ተቋርጧል",
  "desktop.recovery.unresponsive": "Loginom AI Agent ምላሽ እየሰጠ አይደለም",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Loginom AI Agent በ{{distro}}] ውስጥ አልተጫነም",
  "desktop.wsl.error.updateVersion":
    "Loginom AI Agent ዝማኔ አልቋል ግን {{distro}} አሁንም ሪፖርት ያደርጋል {{installed}}; የሚጠበቀው {{expected}}",
  ...
  "provider.connect.opencodeZen.line1": "Loginom AI Agent ዜን ለኮድ ወኪሎች የተመቻቹ አስተማማኝ ሞዴሎች ስብስብ መዳረሻ ይሰጥዎታል።",
  ...
  "dialog.plugins.empty": "plugins በ loginom-ai-agent.json የተዋቀሩ",
  ...
  "dialog.server.description": "ይህ መተግበሪያ ከየትኛው Loginom AI Agent አገልጋይ ጋር እንደሚገናኝ ይቀይሩ።",
  ...
  "wsl.onboarding.checkingOpencode": "መፈተሽ Loginom AI Agent...",
  "wsl.onboarding.checkingOpencodeIn": "OpenCodeን በ{{distro}} ውስጥ በመፈተሽ ላይ...",
  "wsl.onboarding.updatingOpencode": "በማዘመን ላይ Loginom AI Agent...",
  "wsl.onboarding.updatingOpencodeIn": "በማዘመን ላይ Loginom AI Agent በ{{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "አዘምን Loginom AI Agent በ{{distro}}።",
  "wsl.onboarding.updateOpencode": "አዘምን Loginom AI Agent",
  "wsl.onboarding.opencodeReadyIn": "Loginom AI Agent በ{{distro}} ውስጥ ዝግጁ ነው።",
  "wsl.onboarding.opencodeReady": "Loginom AI Agent ዝግጁ ነው።",
  "wsl.onboarding.installOpencodeIn": "መጫን Loginom AI Agent በ{{distro}} ውስጥ።",
  "wsl.onboarding.installOpencode": "ጫን Loginom AI Agent",
  ...
  "wsl.onboarding.wslNotInstalled.description": "WSL (Windowsንዑስ ስርዓት ለLinux) Loginom AI Agent WSL አገልጋይ ከመጨመራቸው በፊት ያስፈልጋል",
  "wsl.onboarding.wslUnavailable.title": "WSL አይገኝም",
  "wsl.onboarding.wslUnavailable.description": "Loginom AI Agent በዚህ ማሽን ላይ WSLን ማረጋገጥ አልቻለም።",
  "wsl.onboarding.installWsl": "ጫን WSL",
  "wsl.onboarding.windowsRestartRequired": "WSLን መጫኑን ለመጨረስ Windows እንደገና ያስጀምሩ እና ከዚያ እንደገና ይክፈቱ Loginom AI Agent።",
  ...
  "help.tabs.introduction": "Loginom AI Agent ዴስክቶፕ አሁን በትሮች ዙሪያ ነው የተሰራው።",
  "help.tabs.sessions":
  ...
  "error.chain.checkConfig": "የእርስዎን ውቅር (loginom-ai-agent.json) አቅራቢ/የሞዴል ስሞችን ያረጋግጡ",
  "error.chain.mcpFailed": 'MCP አገልጋይ "{{name}}" አልተሳካም። ማስታወሻ፣ Loginom AI Agent እስካሁን MCP ማረጋገጫን አይደግፍም።',
  ...
  "app.name.desktop": "Loginom AI Agent ዴስክቶፕ",
  ...
  "settings.general.row.colorScheme.description": "Loginom AI Agent ስርዓቱን፣ ብርሃንን ወይም ጨለማውን ገጽታ የሚከተል እንደሆነ ምረጥ",
  "settings.general.row.theme.title": "ገጽታ",
  "settings.general.row.theme.description": "Loginom AI Agent ገጽታ እንዴት እንደሆነ አብጅ።",
  ...
  "settings.updates.row.startup.description": "Loginom AI Agent ሲጀመር ዝማኔዎችን በራስ-ሰር ያረጋግጡ",
