...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Indtast din API-nøgle til {{provider}} for at forbinde din konto og bruge modeller fra {{provider}} i Loginom AI Agent.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode, forbinde din konto og bruge modeller fra {{provider}} i Loginom AI Agent.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge modeller fra {{provider}} i Loginom AI Agent.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i loginom-ai-agent.json",
  ...
  "dialog.server.description": "Skift hvilken Loginom AI Agent-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingOpencode": "Tjekker Loginom AI Agent...",
  "wsl.onboarding.checkingOpencodeIn": "Tjekker Loginom AI Agent i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Opdaterer Loginom AI Agent...",
  "wsl.onboarding.updatingOpencodeIn": "Opdaterer Loginom AI Agent i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Opdater Loginom AI Agent i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Opdater Loginom AI Agent",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Loginom AI Agent er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før Loginom AI Agent kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "Loginom AI Agent kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter Loginom AI Agent igen.",
  ...
  "toast.update.description": "En ny version af Loginom AI Agent ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til Loginom AI Agent-teamet",
  ...
  "error.chain.checkConfig": "Kontrollér udbyder- og modelnavnene i din konfiguration (loginom-ai-agent.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, Loginom AI Agent understøtter ikke MCP-godkendelse endnu.',
  ...
  "settings.desktop.wsl.description": "Kør Loginom AI Agent-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for Loginom AI Agent",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan Loginom AI Agent ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description":
    "Vælg, om Loginom AI Agent skal følge systemtemaet eller bruge et lyst eller mørkt tema",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når Loginom AI Agent starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af Loginom AI Agent.",
  ...
  "desktop.recovery.loadFailed": "Loginom AI Agent kunne ikke indlæses",
  "desktop.recovery.terminated": "Loginom AI Agent-vinduet blev uventet afsluttet",
  ...
  "desktop.wsl.error.installOpencode": "Installationen af Loginom AI Agent mislykkedes",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Loginom AI Agent er ikke installeret i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Opdateringen af Loginom AI Agent er fuldført, men {{distro}} rapporterer stadig {{installed}}. Forventet: {{expected}}",
  ...
  "help.tabs.introduction": "Loginom AI Agent Desktop er nu bygget op omkring faner.",
  "help.tabs.sessions":
