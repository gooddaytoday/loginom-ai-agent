...
export const dict = {
  ...
  "dialog.plugins.empty": "Laajennukset määritetään loginom-ai-agent.json-tiedostossa",
  ...
  "dialog.server.description": "Vaihda Loginom AI Agent-palvelimeen, johon tämä sovellus muodostaa yhteyden.",
  ...
  "wsl.onboarding.updateOpencodeIn": "Päivitä Loginom AI Agent jakelussa {{distro}}.",
  "wsl.onboarding.updateOpencode": "Päivitä Loginom AI Agent",
  "wsl.onboarding.opencodeReadyIn": "Loginom AI Agent on valmis jakelussa {{distro}}.",
  "wsl.onboarding.opencodeReady": "Loginom AI Agent on valmis.",
  "wsl.onboarding.installOpencodeIn": "Asenna Loginom AI Agent jakeluun {{distro}}.",
  "wsl.onboarding.installOpencode": "Asenna Loginom AI Agent",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) vaaditaan ennen kuin Loginom AI Agent voi lisätä WSL-palvelimen",
  "wsl.onboarding.wslUnavailable.title": "WSL ei ole käytettävissä",
  "wsl.onboarding.wslUnavailable.description": "Loginom AI Agent ei voinut vahvistaa WSL:ää tällä koneella.",
  "wsl.onboarding.installWsl": "Asenna WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Viimeistele WSL:n asennus käynnistämällä Windows uudelleen ja avaa sitten Loginom AI Agent uudelleen.",
  ...
  "error.page.report.prefix": "Ilmoita tästä virheestä Loginom AI Agent-tiimille",
  ...
  "error.chain.checkConfig": "Tarkista määritysten (loginom-ai-agent.json) palveluntarjoajien ja mallien nimet",
  "error.chain.mcpFailed": 'MCP-palvelin "{{name}}" epäonnistui. Huomaa, että Loginom AI Agent ei vielä tue MCP-todennusta.',
  ...
  "settings.desktop.wsl.description": "Suorita Loginom AI Agent-palvelin WSL:n sisällä Windowsissa.",
  ...
  "settings.general.row.appearance.description": "Mukauta, miltä Loginom AI Agent näyttää laitteellasi",
  "settings.general.row.colorScheme.title": "Värimalli",
  "settings.general.row.colorScheme.description":
    "Valitse, käyttääkö Loginom AI Agent järjestelmän mukaista, vaaleaa vai tummaa teemaa",
  ...
  "settings.updates.row.startup.description": "Tarkista päivitykset automaattisesti, kun Loginom AI Agent käynnistyy",
  ...
  "desktop.menu.documentation": "Loginom AI Agent-dokumentaatio",
  ...
  "desktop.menu.ariaLabel": "Loginom AI Agent-valikko",
  ...
  "desktop.recovery.terminated": "Loginom AI Agent-ikkuna sulkeutui odottamatta",
  "desktop.recovery.unresponsive": "Loginom AI Agent ei vastaa",
  ...
  "help.tabs.introduction": "Loginom AI Agent Desktop perustuu nyt välilehtiin.",
  "help.tabs.sessions":
