...
export const dict = {
  ...
  "desktop.menu.documentation": "Loginom AI Agent Τεκμηρίωση",
  ...
  "desktop.menu.ariaLabel": "Loginom AI Agent μενού",
  ...
  "desktop.recovery.loadFailed": "Loginom AI Agent απέτυχε η φόρτωση",
  "desktop.recovery.terminated": "Loginom AI Agent το παράθυρο τερματίστηκε απροσδόκητα",
  "desktop.recovery.unresponsive": "Loginom AI Agent δεν αποκρίνεται",
  ...
  "desktop.wsl.error.installOpencode": "Loginom AI Agent η εγκατάσταση απέτυχε",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Loginom AI Agent δεν είναι εγκατεστημένο στο {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Loginom AI Agent η ενημέρωση ολοκληρώθηκε αλλά το {{distro}} εξακολουθεί να αναφέρει {{installed}}; αναμενόμενο {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Εισαγάγετε το κλειδί {{provider}} API για να συνδέσετε τον λογαριασμό σας και χρησιμοποιήστε μοντέλα {{provider}} στο Loginom AI Agent.",
  ...
  "provider.connect.opencodeZen.line1":
    "Loginom AI Agent Το Zen σάς δίνει πρόσβαση σε ένα επιμελημένο σύνολο αξιόπιστων βελτιστοποιημένων μοντέλων για πράκτορες κωδικοποίησης.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " για να συλλέξετε τον κωδικό εξουσιοδότησης για να συνδέσετε τον λογαριασμό σας και να χρησιμοποιήσετε {{provider}} μοντέλα στο Loginom AI Agent.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " και εισαγάγετε τον παρακάτω κωδικό για να συνδέσετε τον λογαριασμό σας και να χρησιμοποιήσετε {{provider}} μοντέλα στο Loginom AI Agent.",
  ...
  "dialog.plugins.empty": "Προσθήκες ρυθμισμένες στο loginom-ai-agent.json",
  ...
  "dialog.server.description": "Αλλαγή σε ποιον διακομιστή Loginom AI Agent συνδέεται αυτή η εφαρμογή.",
  ...
  "wsl.onboarding.checkingOpencode": "Έλεγχος Loginom AI Agent...",
  "wsl.onboarding.checkingOpencodeIn": "Έλεγχος Loginom AI Agent σε {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ενημέρωση Loginom AI Agent...",
  "wsl.onboarding.updatingOpencodeIn": "Ενημέρωση Loginom AI Agent σε {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ενημέρωση Loginom AI Agent σε {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ενημέρωση Loginom AI Agent",
  "wsl.onboarding.opencodeReadyIn": "Loginom AI Agent είναι έτοιμο στο {{distro}}.",
  "wsl.onboarding.opencodeReady": "Loginom AI Agent είναι έτοιμο.",
  "wsl.onboarding.installOpencodeIn": "Εγκατάσταση του Loginom AI Agent στο {{distro}}.",
  "wsl.onboarding.installOpencode": "Εγκατάσταση Loginom AI Agent",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Loginom AI Agent δεν έχει εγκατασταθεί",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Υποσύστημα για Linux) απαιτείται για να μπορέσει ο Loginom AI Agent να προσθέσει έναν διακομιστή WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL μη διαθέσιμο",
  "wsl.onboarding.wslUnavailable.description": "Loginom AI Agent δεν μπόρεσε να επαληθεύσει το WSL σε αυτό το μηχάνημα.",
  "wsl.onboarding.installWsl": "Εγκατάσταση WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Επανεκκινήστε το Windows για να ολοκληρώσετε την εγκατάσταση του WSL και μετά ανοίξτε ξανά το Loginom AI Agent.",
  ...
  "help.tabs.introduction": "Loginom AI Agent Η επιφάνεια εργασίας είναι πλέον χτισμένη γύρω από καρτέλες.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Μια νέα έκδοση του Loginom AI Agent ({{version}}) είναι τώρα διαθέσιμη για εγκατάσταση.",
  ...
  "error.page.report.prefix": "Αναφέρετε αυτό το σφάλμα στην ομάδα Loginom AI Agent",
  ...
  "error.chain.checkConfig": "Ελέγξτε τη διαμόρφωση (loginom-ai-agent.json) ονόματα παρόχου/μοντέλων",
  "error.chain.mcpFailed":
    'MCP διακομιστής "{{name}}" απέτυχε. Σημείωση, το Loginom AI Agent δεν υποστηρίζει ακόμη έλεγχο ταυτότητας MCP.',
  ...
  "app.name.desktop": "Loginom AI Agent Επιτραπέζιος υπολογιστής",
  ...
  "settings.desktop.wsl.description": "Εκτέλεση του διακομιστή Loginom AI Agent μέσα στο WSL στο Windows.",
  ...
  "settings.general.row.language.description": "Αλλαγή της γλώσσας εμφάνισης για το Loginom AI Agent",
  ...
  "systemProxy.state.applied": "Using {{address}}",
  "systemProxy.state.failed": "System proxy was not applied",
  "systemProxy.notice.title": "System proxy",
  "systemProxy.notice.read-failed": "The system proxy settings could not be read. The app is running without them.",
  "systemProxy.notice.timeout": "Reading the system proxy took too long. The app is running without it.",
  ...
  "settings.general.row.appearance.description": "Προσαρμογή της εμφάνισης του Loginom AI Agent στη συσκευή σας",
  "settings.general.row.colorScheme.title": "Χρωματικός συνδυασμός",
  "settings.general.row.colorScheme.description":
    "Επιλέξτε εάν το Loginom AI Agent ακολουθεί το σύστημα, το ανοιχτό ή το σκοτεινό θέμα",
  "settings.general.row.theme.title": "Θέμα",
  "settings.general.row.theme.description": "Προσαρμογή του τρόπου με τον οποίο έχει θέμα το Loginom AI Agent.",
  ...
  "settings.updates.row.startup.description": "Αυτόματος έλεγχος για ενημερώσεις κατά την εκκίνηση του Loginom AI Agent",
  ...
  "settings.updates.toast.latest.description": "Εκτελείτε την πιο πρόσφατη έκδοση του Loginom AI Agent.",
