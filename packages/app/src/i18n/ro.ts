...
export const dict = {
  ...
  "desktop.menu.documentation": "Documentație Loginom AI Agent",
  ...
  "desktop.menu.ariaLabel": "Meniu Loginom AI Agent",
  ...
  "desktop.recovery.loadFailed": "Loginom AI Agent nu a putut fi încărcat",
  "desktop.recovery.terminated": "Fereastra Loginom AI Agent s-a închis neașteptat",
  "desktop.recovery.unresponsive": "Loginom AI Agent nu răspunde",
  ...
  "desktop.wsl.error.installOpencode": "Instalarea Loginom AI Agent a eșuat",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Loginom AI Agent nu este instalat în {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Actualizarea Loginom AI Agent s-a terminat, dar {{distro}} raportează tot {{installed}}; era așteptat {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Introdu cheia API {{provider}} pentru a-ți conecta contul și a folosi modelele {{provider}} în Loginom AI Agent.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pentru a obține codul de autorizare și a-ți conecta contul ca să folosești modelele {{provider}} în Loginom AI Agent.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " și introdu codul de mai jos pentru a-ți conecta contul și a folosi modelele {{provider}} în Loginom AI Agent.",
  ...
  "dialog.plugins.empty": "Pluginuri configurate în loginom-ai-agent.json",
  ...
  "dialog.server.description": "Schimbă serverul Loginom AI Agent la care se conectează aplicația.",
  ...
  "wsl.onboarding.checkingOpencode": "Se verifică Loginom AI Agent...",
  "wsl.onboarding.checkingOpencodeIn": "Se verifică Loginom AI Agent în {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Se actualizează Loginom AI Agent...",
  "wsl.onboarding.updatingOpencodeIn": "Se actualizează Loginom AI Agent în {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualizează Loginom AI Agent în {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizează Loginom AI Agent",
  "wsl.onboarding.opencodeReadyIn": "Loginom AI Agent este gata în {{distro}}.",
  "wsl.onboarding.opencodeReady": "Loginom AI Agent este gata.",
  "wsl.onboarding.installOpencodeIn": "Instalează Loginom AI Agent în {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalează Loginom AI Agent",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Loginom AI Agent nu este instalat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Subsistemul Windows pentru Linux) este necesar înainte ca Loginom AI Agent să poată adăuga un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponibil",
  "wsl.onboarding.wslUnavailable.description": "Loginom AI Agent nu a putut verifica WSL pe acest calculator.",
  "wsl.onboarding.installWsl": "Instalează WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Repornește Windows pentru a finaliza instalarea WSL, apoi redeschide Loginom AI Agent.",
  ...
  "help.tabs.introduction": "Loginom AI Agent Desktop este acum construit în jurul filelor.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "O nouă versiune Loginom AI Agent ({{version}}) este disponibilă pentru instalare.",
  ...
  "error.page.report.prefix": "Te rugăm să raportezi această eroare echipei Loginom AI Agent",
  ...
  "error.chain.checkConfig": "Verifică numele provider/model în config (loginom-ai-agent.json)",
  "error.chain.mcpFailed": 'Serverul MCP "{{name}}" a eșuat. Atenție, Loginom AI Agent nu suportă încă autentificarea MCP.',
  ...
  "settings.desktop.wsl.description": "Rulează serverul Loginom AI Agent în WSL pe Windows.",
  ...
  "settings.general.row.language.description": "Schimbă limba de afișare pentru Loginom AI Agent",
  ...
  "settings.general.row.appearance.description": "Personalizează aspectul Loginom AI Agent pe dispozitivul tău",
  "settings.general.row.colorScheme.title": "Scheamă de culori",
  "settings.general.row.colorScheme.description": "Alege dacă Loginom AI Agent urmează sistemul, tema deschisă sau închisă",
  "settings.general.row.theme.title": "Temă",
  "settings.general.row.theme.description": "Personalizează tema Loginom AI Agent.",
  ...
  "settings.updates.row.startup.description": "Verifică automat actualizările la lansarea Loginom AI Agent",
  ...
  "settings.updates.toast.latest.description": "Folosești cea mai recentă versiune Loginom AI Agent.",
