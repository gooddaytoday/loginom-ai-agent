...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "فشل تحميل Loginom AI Agent",
  "desktop.recovery.terminated": "توقفت نافذة Loginom AI Agent بشكل غير متوقع",
  "desktop.recovery.unresponsive": "Loginom AI Agent لا يستجيب",
  ...
  "desktop.wsl.error.installOpencode": "فشل تثبيت Loginom AI Agent",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Loginom AI Agent غير مثبت في {{distro}}",
  "desktop.wsl.error.updateVersion":
    "اكتمل تحديث Loginom AI Agent، لكن {{distro}} ما زالت تعرض الإصدار {{installed}}؛ الإصدار المتوقع هو {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح API الخاص بـ {{provider}} لتوصيل حسابك واستخدام نماذج {{provider}} في Loginom AI Agent.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Loginom AI Agent.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في Loginom AI Agent.",
  ...
  "dialog.plugins.empty": "الإضافات المكونة في loginom-ai-agent.json",
  ...
  "dialog.server.description": "تبديل خادم Loginom AI Agent الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingOpencode": "جارٍ التحقق من Loginom AI Agent...",
  "wsl.onboarding.checkingOpencodeIn": "جارٍ التحقق من Loginom AI Agent في {{distro}}...",
  "wsl.onboarding.updatingOpencode": "جارٍ تحديث Loginom AI Agent...",
  "wsl.onboarding.updatingOpencodeIn": "جارٍ تحديث Loginom AI Agent في {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "حدّث Loginom AI Agent في {{distro}}.",
  "wsl.onboarding.updateOpencode": "تحديث Loginom AI Agent",
  "wsl.onboarding.opencodeReadyIn": "Loginom AI Agent جاهز في {{distro}}.",
  "wsl.onboarding.opencodeReady": "Loginom AI Agent جاهز.",
  "wsl.onboarding.installOpencodeIn": "ثبّت Loginom AI Agent في {{distro}}.",
  "wsl.onboarding.installOpencode": "تثبيت Loginom AI Agent",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Loginom AI Agent غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن Loginom AI Agent من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على Loginom AI Agent التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح Loginom AI Agent.",
  ...
  "help.tabs.introduction": "أصبح Loginom AI Agent Desktop الآن قائمًا على علامات التبويب.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "يتوفر الآن إصدار جديد من Loginom AI Agent ({{version}}) للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق Loginom AI Agent",
  ...
  "error.chain.checkConfig": "تحقق من أسماء الموفر/النموذج في التكوين (loginom-ai-agent.json)",
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن Loginom AI Agent لا يدعم مصادقة MCP بعد.',
  ...
  "settings.desktop.wsl.description": "تشغيل خادم Loginom AI Agent داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ Loginom AI Agent",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور Loginom AI Agent على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان Loginom AI Agent يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة Loginom AI Agent.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل Loginom AI Agent",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من Loginom AI Agent.",
