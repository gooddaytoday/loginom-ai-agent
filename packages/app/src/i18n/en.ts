...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Loginom AI Agent.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Loginom AI Agent.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Loginom AI Agent.",
  ...
  "dialog.plugins.empty": "Plugins configured in loginom-ai-agent.json",
  ...
  "dialog.server.description": "Switch which Loginom AI Agent server this app connects to.",
  ...
  "wsl.onboarding.checkingOpencode": "Checking Loginom AI Agent...",
  "wsl.onboarding.checkingOpencodeIn": "Checking Loginom AI Agent in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating Loginom AI Agent...",
  "wsl.onboarding.updatingOpencodeIn": "Updating Loginom AI Agent in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update Loginom AI Agent in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update Loginom AI Agent",
  "wsl.onboarding.opencodeReadyIn": "Loginom AI Agent is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "Loginom AI Agent is ready.",
  "wsl.onboarding.installOpencodeIn": "Install Loginom AI Agent in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install Loginom AI Agent",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Loginom AI Agent not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before Loginom AI Agent can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "Loginom AI Agent could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen Loginom AI Agent.",
  ...
  "help.tabs.introduction": "Loginom AI Agent Desktop is now built around tabs.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "A new version of Loginom AI Agent ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Loginom AI Agent team",
  ...
  "settings.desktop.wsl.description": "Run the Loginom AI Agent server inside WSL on Windows.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Loginom AI Agent launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Loginom AI Agent.",
