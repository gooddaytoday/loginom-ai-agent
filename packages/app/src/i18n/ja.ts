...
export const dict = {
  ...
  "provider.connect.opencodeZen.line1":
    "Loginom AI Agent Zenは、コーディングエージェント向けに最適化された信頼性の高いモデルへのアクセスを提供します。",
  ...
  "dialog.plugins.empty": "loginom-ai-agent.jsonで設定されたプラグイン",
  ...
  "help.tabs.introduction": "Loginom AI Agent Desktopでタブを中心とした操作ができるようになりました。",
  "help.tabs.sessions":
  ...
  "error.chain.checkConfig": "config (loginom-ai-agent.json) のプロバイダー/モデル名を確認してください",
  ...
  "settings.updates.row.startup.description": "Loginom AI Agent の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "Loginom AI Agent は最新バージョンです。",
