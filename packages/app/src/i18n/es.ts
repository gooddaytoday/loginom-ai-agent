...
export const dict = {
  ...
  "desktop.menu.documentation": "Documentación de Loginom AI Agent",
  ...
  "desktop.menu.ariaLabel": "Menú de Loginom AI Agent",
  ...
  "desktop.recovery.loadFailed": "No se pudo cargar Loginom AI Agent",
  "desktop.recovery.terminated": "La ventana de Loginom AI Agent se cerró de forma inesperada",
  "desktop.recovery.unresponsive": "Loginom AI Agent no responde",
  ...
  "desktop.wsl.error.installOpencode": "No se pudo instalar Loginom AI Agent",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Loginom AI Agent no está instalado en {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La actualización de Loginom AI Agent finalizó, pero {{distro}} sigue indicando {{installed}}; se esperaba {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en Loginom AI Agent.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en Loginom AI Agent.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en Loginom AI Agent.",
  ...
  "dialog.plugins.empty": "Plugins configurados en loginom-ai-agent.json",
  ...
  "dialog.server.description": "Cambiar el servidor de Loginom AI Agent al que se conecta esta aplicación.",
  ...
  "wsl.onboarding.checkingOpencode": "Comprobando Loginom AI Agent...",
  "wsl.onboarding.checkingOpencodeIn": "Comprobando Loginom AI Agent en {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Actualizando Loginom AI Agent...",
  "wsl.onboarding.updatingOpencodeIn": "Actualizando Loginom AI Agent en {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualiza Loginom AI Agent en {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizar Loginom AI Agent",
  "wsl.onboarding.opencodeReadyIn": "Loginom AI Agent está listo en {{distro}}.",
  "wsl.onboarding.opencodeReady": "Loginom AI Agent está listo.",
  "wsl.onboarding.installOpencodeIn": "Instala Loginom AI Agent en {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar Loginom AI Agent",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Loginom AI Agent no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que Loginom AI Agent pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "Loginom AI Agent no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir Loginom AI Agent.",
  ...
  "help.tabs.introduction": "Loginom AI Agent Desktop ahora se organiza en torno a pestañas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nueva versión de Loginom AI Agent ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Informa de este error al equipo de Loginom AI Agent",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (loginom-ai-agent.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota: Loginom AI Agent aún no admite la autenticación MCP.',
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor Loginom AI Agent dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para Loginom AI Agent",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve Loginom AI Agent en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si Loginom AI Agent sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de Loginom AI Agent.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia Loginom AI Agent",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de Loginom AI Agent.",
