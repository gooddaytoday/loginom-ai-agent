...
export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacioni Loginom AI Agent",
  ...
  "desktop.menu.ariaLabel": "Menuja Loginom AI Agent",
  ...
  "desktop.recovery.loadFailed": "Loginom AI Agent nuk u ngarkua",
  "desktop.recovery.terminated": "Dritarja Loginom AI Agent u mbyll papritur",
  "desktop.recovery.unresponsive": "Loginom AI Agent nuk po përgjigjet",
  ...
  "desktop.wsl.error.installOpencode": "Instalimi i Loginom AI Agent dështoi",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Loginom AI Agent nuk është i instaluar në {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Përditësimi i Loginom AI Agent përfundoi, por {{distro}} ende raporton {{installed}}; pritet {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Futni çelësin API të {{provider}} për të lidhur llogarinë dhe për të përdorur modelet {{provider}} në Loginom AI Agent.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " për të mbledhur kodin tuaj të autorizimit për të lidhur llogarinë tuaj dhe për të përdorur modelet {{provider}} në Loginom AI Agent.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dhe futni kodin më poshtë për të lidhur llogarinë tuaj dhe për të përdorur modelet {{provider}} në Loginom AI Agent.",
  ...
  "dialog.plugins.empty": "Shtojcat e konfiguruara në loginom-ai-agent.json",
  ...
  "dialog.server.description": "Ndrysho me cilin server Loginom AI Agent lidhet ky aplikacion.",
  ...
  "wsl.onboarding.checkingOpencode": "Po kontrollon Loginom AI Agent...",
  "wsl.onboarding.checkingOpencodeIn": "Po kontrollon Loginom AI Agent në {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Loginom AI Agent po përditësohet...",
  "wsl.onboarding.updatingOpencodeIn": "Po përditëson Loginom AI Agent në {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Përditëso Loginom AI Agent në {{distro}}.",
  "wsl.onboarding.updateOpencode": "Përditëso Loginom AI Agent",
  "wsl.onboarding.opencodeReadyIn": "Loginom AI Agent është gati në {{distro}}.",
  "wsl.onboarding.opencodeReady": "Loginom AI Agent është gati.",
  "wsl.onboarding.installOpencodeIn": "Instaloni Loginom AI Agent në {{distro}}.",
  "wsl.onboarding.installOpencode": "Instaloni Loginom AI Agent",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Loginom AI Agent nuk është i instaluar",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Nënsistemi Windows për Linux) kërkohet përpara se Loginom AI Agent të shtojë një server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL i padisponueshëm",
  "wsl.onboarding.wslUnavailable.description": "Loginom AI Agent nuk mund ta verifikonte WSL në këtë makinë.",
  "wsl.onboarding.installWsl": "Instaloni WSL",
  "wsl.onboarding.windowsRestartRequired": "Rinis Windows për të përfunduar instalimin e WSL, më pas rihap Loginom AI Agent.",
  ...
  "help.tabs.introduction": "Loginom AI Agent Desktop tani është ndërtuar rreth skedave.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Një version i ri i Loginom AI Agent ({{version}}) është tani i disponueshëm për t'u instaluar.",
  ...
  "error.page.report.prefix": "Ju lutemi raportoni këtë gabim te ekipi i Loginom AI Agent",
  ...
  "error.chain.checkConfig": "Kontrolloni emrat e ofruesit/modelit tuaj të konfigurimit (loginom-ai-agent.json).",
  "error.chain.mcpFailed": 'Serveri MCP "{{name}}" dështoi. Shënim, Loginom AI Agent nuk e mbështet ende vërtetimin MCP.',
  ...
  "settings.desktop.wsl.description": "Ekzekutoni serverin Loginom AI Agent brenda WSL në Windows.",
  ...
  "settings.general.row.language.description": "Ndryshoni gjuhën e ekranit për Loginom AI Agent",
  ...
  "settings.general.row.appearance.description": "Personalizojeni se si duket Loginom AI Agent në pajisjen tuaj",
  "settings.general.row.colorScheme.title": "Skema e ngjyrave",
  "settings.general.row.colorScheme.description":
    "Zgjidhni nëse Loginom AI Agent ndjek temën e sistemit, të lehtë ose të errët",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizojeni se si është tema e Loginom AI Agent.",
  ...
  "settings.updates.row.startup.description": "Kontrolloni automatikisht për përditësime kur niset Loginom AI Agent",
  ...
  "settings.updates.toast.latest.description": "Ju jeni duke ekzekutuar versionin më të fundit të Loginom AI Agent.",
