...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "Loginom AI Agent kunde inte läsas in",
  "desktop.recovery.terminated": "Loginom AI Agent-fönstret avslutades oväntat",
  "desktop.recovery.unresponsive": "Loginom AI Agent svarar inte",
  ...
  "desktop.wsl.error.installOpencode": "Installationen av Loginom AI Agent misslyckades",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Loginom AI Agent är inte installerat i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Loginom AI Agent-uppdateringen slutfördes, men {{distro}} rapporterar fortfarande {{installed}}. {{expected}} förväntades",
  ...
  "provider.connect.apiKey.description":
    "Ange din {{provider}}-API-nyckel för att ansluta ditt konto och använda {{provider}}-modeller i Loginom AI Agent.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " för att hämta auktoriseringskoden som ansluter ditt konto och låter dig använda {{provider}}-modeller i Loginom AI Agent.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " och ange koden nedan för att ansluta ditt konto och använda {{provider}}-modeller i Loginom AI Agent.",
  ...
  "dialog.plugins.empty": "Insticksprogram konfigurerade i loginom-ai-agent.json",
  ...
  "dialog.server.description": "Växla vilken Loginom AI Agent-server som denna app ansluter till.",
  ...
  "wsl.onboarding.checkingOpencode": "Kontrollerar Loginom AI Agent...",
  "wsl.onboarding.checkingOpencodeIn": "Kontrollerar Loginom AI Agent i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Uppdaterar Loginom AI Agent...",
  "wsl.onboarding.updatingOpencodeIn": "Uppdaterar Loginom AI Agent i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Uppdatera Loginom AI Agent i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Uppdatera Loginom AI Agent",
  "wsl.onboarding.opencodeReadyIn": "Loginom AI Agent är redo i {{distro}}.",
  "wsl.onboarding.opencodeReady": "Loginom AI Agent är redo.",
  "wsl.onboarding.installOpencodeIn": "Installera Loginom AI Agent i {{distro}}.",
  "wsl.onboarding.installOpencode": "Installera Loginom AI Agent",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Loginom AI Agent är inte installerat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) krävs innan Loginom AI Agent kan lägga till en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL är inte tillgängligt",
  "wsl.onboarding.wslUnavailable.description": "Loginom AI Agent kunde inte verifiera WSL på den här maskinen.",
  "wsl.onboarding.installWsl": "Installera WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Starta om Windows för att slutföra installationen av WSL och öppna sedan Loginom AI Agent igen.",
  ...
  "help.tabs.introduction": "Loginom AI Agent Desktop är nu uppbyggt kring flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "En ny version av Loginom AI Agent ({{version}}) är nu tillgänglig att installera.",
  ...
  "error.page.report.prefix": "Rapportera det här felet till Loginom AI Agent-teamet",
  ...
  "error.chain.checkConfig": "Kontrollera leverantörs- och modellnamnen i konfigurationen (loginom-ai-agent.json)",
  "error.chain.mcpFailed": 'MCP-servern "{{name}}" misslyckades. Obs, Loginom AI Agent stöder inte MCP-autentisering ännu.',
  ...
  "settings.desktop.wsl.description": "Kör Loginom AI Agent-servern inuti WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ändra visningsspråket för Loginom AI Agent",
  ...
  "settings.general.row.appearance.description": "Anpassa hur Loginom AI Agent ser ut på din enhet",
  "settings.general.row.colorScheme.title": "Färgschema",
  "settings.general.row.colorScheme.description": "Välj om Loginom AI Agent följer system-, ljus- eller mörktemat",
  ...
  "settings.updates.row.startup.description": "Sök automatiskt efter uppdateringar när Loginom AI Agent startas",
  ...
  "settings.updates.toast.latest.description": "Du kör den senaste versionen av Loginom AI Agent.",
