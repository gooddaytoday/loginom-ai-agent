...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren API-Schlüssel für {{provider}} ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in Loginom AI Agent zu nutzen.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}}-Modelle in Loginom AI Agent zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in Loginom AI Agent zu nutzen.",
  ...
  "dialog.plugins.empty": "In loginom-ai-agent.json konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den Loginom AI Agent-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.checkingOpencode": "Loginom AI Agent wird geprüft…",
  "wsl.onboarding.checkingOpencodeIn": "Loginom AI Agent in {{distro}} wird geprüft…",
  "wsl.onboarding.updatingOpencode": "Loginom AI Agent wird aktualisiert…",
  "wsl.onboarding.updatingOpencodeIn": "Loginom AI Agent in {{distro}} wird aktualisiert…",
  "wsl.onboarding.updateOpencodeIn": "Aktualisieren Sie Loginom AI Agent in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Loginom AI Agent aktualisieren",
  "wsl.onboarding.opencodeReadyIn": "Loginom AI Agent ist in {{distro}} bereit.",
  "wsl.onboarding.opencodeReady": "Loginom AI Agent ist bereit.",
  "wsl.onboarding.installOpencodeIn": "Installieren Sie Loginom AI Agent in {{distro}}.",
  "wsl.onboarding.installOpencode": "Loginom AI Agent installieren",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Loginom AI Agent nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor Loginom AI Agent einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "Loginom AI Agent konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann Loginom AI Agent erneut.",
  ...
  "toast.update.description": "Eine neue Version von Loginom AI Agent ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem Loginom AI Agent-Team",
  ...
  "error.chain.checkConfig": "Überprüfen Sie die Anbieter- und Modellnamen in Ihrer Konfiguration (loginom-ai-agent.json)",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: Loginom AI Agent unterstützt noch keine MCP-Authentifizierung.',
  ...
  "home.providerTip":
    "Loginom AI Agent mit über 75 Anbietern verbinden, um weitere Modelle wie Claude, GPT, Gemini und andere zu nutzen",
  ...
  "settings.desktop.wsl.description": "Loginom AI Agent-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für Loginom AI Agent ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie Loginom AI Agent auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob Loginom AI Agent dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von Loginom AI Agent anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von Loginom AI Agent automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.title": "Loginom AI Agent ist auf dem neuesten Stand",
  "settings.updates.toast.latest.description": "Die aktuelle Version von Loginom AI Agent wird verwendet.",
  ...
  "desktop.recovery.loadFailed": "Loginom AI Agent konnte nicht geladen werden",
  "desktop.recovery.terminated": "Das Loginom AI Agent-Fenster wurde unerwartet beendet",
  "desktop.recovery.unresponsive": "Loginom AI Agent reagiert nicht",
  ...
  "desktop.wsl.error.installOpencode": "Loginom AI Agent-Installation fehlgeschlagen",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Loginom AI Agent ist in {{distro}} nicht installiert",
  "desktop.wsl.error.updateVersion":
    "Das Loginom AI Agent-Update wurde abgeschlossen, aber {{distro}} meldet weiterhin {{installed}}; erwartet wurde {{expected}}",
  ...
  "help.tabs.introduction": "Loginom AI Agent Desktop basiert jetzt auf Tabs.",
  "help.tabs.sessions":
