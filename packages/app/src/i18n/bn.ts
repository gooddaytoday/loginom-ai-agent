...
export const dict: Record<string, string> = {
  ...
  "desktop.menu.documentation": "Loginom AI Agent ডকুমেন্টেশন",
  ...
  "desktop.menu.ariaLabel": "Loginom AI Agent মেনু",
  ...
  "desktop.recovery.loadFailed": "Loginom AI Agent লোড হতে ব্যর্থ হয়েছে৷",
  "desktop.recovery.terminated": "Loginom AI Agent উইন্ডো অপ্রত্যাশিতভাবে বন্ধ হয়ে গেছে",
  "desktop.recovery.unresponsive": "Loginom AI Agent সাড়া দিচ্ছে না",
  ...
  "desktop.wsl.error.installOpencode": "Loginom AI Agent ইনস্টলেশন ব্যর্থ হয়েছে৷",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Loginom AI Agent {{distro}} এ ইনস্টল করা নেই",
  "desktop.wsl.error.updateVersion":
    "Loginom AI Agent আপডেট শেষ হয়েছে কিন্তু {{distro}} এখনও রিপোর্ট করে {{installed}}; প্রত্যাশিত {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "আপনার অ্যাকাউন্ট সংযোগ করতে আপনার {{provider}} API কী লিখুন এবং Loginom AI Agent-এ {{provider}} মডেলগুলি ব্যবহার করুন৷",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "আপনার অ্যাকাউন্ট সংযোগ করতে আপনার অনুমোদন কোড সংগ্রহ করতে এবং {{provider}} মডেলগুলি Loginom AI Agent-এ ব্যবহার করতে।",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "এবং আপনার অ্যাকাউন্ট সংযোগ করতে নীচের কোডটি লিখুন এবং {{provider}} মডেলগুলি Loginom AI Agent-এ ব্যবহার করুন৷",
  ...
  "dialog.plugins.empty": "loginom-ai-agent.json এ কনফিগার করা প্লাগইন",
  ...
  "dialog.server.description": "এই অ্যাপটি কোন Loginom AI Agent সার্ভারের সাথে সংযোগ করে তা পরিবর্তন করুন।",
  ...
  "wsl.onboarding.checkingOpencode": "Loginom AI Agent পরীক্ষা করা হচ্ছে...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} এ Loginom AI Agent চেক করা হচ্ছে...",
  "wsl.onboarding.updatingOpencode": "আপডেট করা হচ্ছে Loginom AI Agent...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}-এ Loginom AI Agent আপডেট করা হচ্ছে...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}-এ Loginom AI Agent আপডেট করুন।",
  "wsl.onboarding.updateOpencode": "Loginom AI Agent আপডেট করুন",
  "wsl.onboarding.opencodeReadyIn": "Loginom AI Agent {{distro}}-এ প্রস্তুত।",
  "wsl.onboarding.opencodeReady": "Loginom AI Agent প্রস্তুত।",
  "wsl.onboarding.installOpencodeIn": "{{distro}}-এ Loginom AI Agent ইনস্টল করুন।",
  "wsl.onboarding.installOpencode": "Loginom AI Agent ইনস্টল করুন",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Loginom AI Agent ইনস্টল করা নেই",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Linux এর জন্য Windows সাবসিস্টেম) Loginom AI Agent একটি WSL সার্ভার যোগ করার আগে প্রয়োজন",
  "wsl.onboarding.wslUnavailable.title": "WSL অনুপলব্ধ",
  "wsl.onboarding.wslUnavailable.description": "Loginom AI Agent এই মেশিনে WSL যাচাই করতে পারেনি।",
  "wsl.onboarding.installWsl": "WSL ইনস্টল করুন",
  "wsl.onboarding.windowsRestartRequired":
    "WSL ইনস্টল করা শেষ করতে Windows পুনরায় চালু করুন, তারপর Loginom AI Agent আবার খুলুন।",
  ...
  "help.tabs.introduction": "Loginom AI Agent ডেস্কটপ এখন ট্যাবের চারপাশে তৈরি।",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Loginom AI Agent ({{version}}) এর একটি নতুন সংস্করণ এখন ইনস্টল করার জন্য উপলব্ধ৷",
  ...
  "error.page.report.prefix": "অনুগ্রহ করে এই ত্রুটিটি Loginom AI Agent টিমের কাছে রিপোর্ট করুন",
  ...
  "error.chain.checkConfig": "আপনার কনফিগারেশন (loginom-ai-agent.json) প্রদানকারী/মডেলের নাম পরীক্ষা করুন",
  "error.chain.mcpFailed":
    'MCP সার্ভার "{{name}}" ব্যর্থ হয়েছে৷ মনে রাখবেন, Loginom AI Agent এখনও MCP প্রমাণীকরণ সমর্থন করে না।',
  ...
  "app.name.desktop": "Loginom AI Agent ডেস্কটপ",
  ...
  "settings.desktop.wsl.description": "Windows-এ WSL-এর ভিতরে Loginom AI Agent সার্ভার চালান।",
  ...
  "settings.general.row.language.description": "Loginom AI Agent-এর জন্য প্রদর্শনের ভাষা পরিবর্তন করুন",
  ...
  "settings.general.row.appearance.description": "আপনার ডিভাইসে Loginom AI Agent কেমন দেখায় তা কাস্টমাইজ করুন",
  "settings.general.row.colorScheme.title": "রঙের স্কিম",
  "settings.general.row.colorScheme.description": "Loginom AI Agent সিস্টেম, হালকা বা অন্ধকার থিম অনুসরণ করে কিনা তা বেছে নিন",
  "settings.general.row.theme.title": "থিম",
  "settings.general.row.theme.description": "কিভাবে Loginom AI Agent থিম করা হয় তা কাস্টমাইজ করুন।",
  ...
  "settings.updates.row.startup.description": "Loginom AI Agent চালু হলে স্বয়ংক্রিয়ভাবে আপডেটের জন্য চেক করুন",
  ...
  "settings.updates.toast.latest.description": "আপনি Loginom AI Agent এর সর্বশেষ সংস্করণ চালাচ্ছেন।",
