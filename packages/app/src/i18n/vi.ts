...
export const dict = {
  ...
  "desktop.menu.documentation": "Tài liệu Loginom AI Agent",
  ...
  "desktop.recovery.loadFailed": "Không tải được Loginom AI Agent",
  "desktop.recovery.terminated": "Cửa sổ Loginom AI Agent đã bị đóng đột ngột",
  "desktop.recovery.unresponsive": "Loginom AI Agent không phản hồi",
  ...
  "desktop.wsl.error.installOpencode": "Không cài đặt được Loginom AI Agent",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Loginom AI Agent chưa được cài đặt trong {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Đã cập nhật Loginom AI Agent nhưng {{distro}} vẫn báo phiên bản {{installed}}; phiên bản dự kiến là {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Nhập khóa API {{provider}} để kết nối tài khoản và sử dụng các mô hình {{provider}} trong Loginom AI Agent.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " để lấy mã ủy quyền, kết nối tài khoản và sử dụng các mô hình {{provider}} trong Loginom AI Agent.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " và nhập mã bên dưới để kết nối tài khoản của bạn và sử dụng các mô hình {{provider}} trong Loginom AI Agent.",
  ...
  "dialog.plugins.empty": "Các plugin được định cấu hình trong loginom-ai-agent.json",
  ...
  "dialog.server.description": "Chuyển máy chủ Loginom AI Agent mà ứng dụng này kết nối tới.",
  ...
  "wsl.onboarding.checkingOpencode": "Đang kiểm tra Loginom AI Agent...",
  "wsl.onboarding.checkingOpencodeIn": "Đang kiểm tra Loginom AI Agent trong {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Đang cập nhật Loginom AI Agent...",
  "wsl.onboarding.updatingOpencodeIn": "Đang cập nhật Loginom AI Agent trong {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Cập nhật Loginom AI Agent trong {{distro}}.",
  "wsl.onboarding.updateOpencode": "Cập nhật Loginom AI Agent",
  "wsl.onboarding.opencodeReadyIn": "Loginom AI Agent đã sẵn sàng trong {{distro}}.",
  "wsl.onboarding.opencodeReady": "Loginom AI Agent đã sẵn sàng.",
  "wsl.onboarding.installOpencodeIn": "Cài đặt Loginom AI Agent trong {{distro}}.",
  "wsl.onboarding.installOpencode": "Cài đặt Loginom AI Agent",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Loginom AI Agent chưa được cài đặt",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Cần có WSL (Hệ thống con Windows dành cho Linux) trước khi Loginom AI Agent có thể thêm máy chủ WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL không có sẵn",
  "wsl.onboarding.wslUnavailable.description": "Loginom AI Agent không thể xác minh WSL trên máy này.",
  "wsl.onboarding.installWsl": "Cài đặt WSL",
  "wsl.onboarding.windowsRestartRequired": "Khởi động lại Windows để hoàn tất cài đặt WSL, sau đó mở lại Loginom AI Agent.",
  ...
  "help.tabs.introduction": "Loginom AI Agent Desktop nay được xây dựng xoay quanh các tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Hiện đã có phiên bản mới của Loginom AI Agent ({{version}}) để cài đặt.",
  ...
  "error.page.report.prefix": "Vui lòng báo cáo lỗi này cho nhóm Loginom AI Agent",
  ...
  "error.chain.checkConfig": "Kiểm tra tên nhà cung cấp/mô hình cấu hình (loginom-ai-agent.json) của bạn",
  "error.chain.mcpFailed": 'Máy chủ MCP "{{name}}" gặp lỗi. Lưu ý: Loginom AI Agent chưa hỗ trợ xác thực MCP.',
  ...
  "settings.desktop.wsl.description": "Chạy máy chủ Loginom AI Agent bên trong WSL trên Windows.",
  ...
  "settings.general.row.language.description": "Thay đổi ngôn ngữ hiển thị cho Loginom AI Agent",
  ...
  "settings.general.row.appearance.description": "Tùy chỉnh giao diện của Loginom AI Agent trên thiết bị",
  "settings.general.row.colorScheme.title": "Cách phối màu",
  "settings.general.row.colorScheme.description": "Chọn xem Loginom AI Agent tuân theo hệ thống, chủ đề sáng hay tối",
  "settings.general.row.theme.title": "Chủ đề",
  "settings.general.row.theme.description": "Tùy chỉnh chủ đề của Loginom AI Agent.",
  ...
  "settings.updates.row.startup.description": "Tự động kiểm tra các bản cập nhật khi Loginom AI Agent khởi chạy",
  ...
  "settings.updates.toast.latest.description": "Bạn đang chạy phiên bản mới nhất của Loginom AI Agent.",
