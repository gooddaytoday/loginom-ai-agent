...
export const dict = {
  ...
  "desktop.menu.documentation": "Loginom AI Agent-documentatie",
  ...
  "desktop.recovery.loadFailed": "Loginom AI Agent kan niet worden geladen",
  "desktop.recovery.terminated": "Het Loginom AI Agent-venster is onverwacht beëindigd",
  "desktop.recovery.unresponsive": "Loginom AI Agent reageert niet",
  ...
  "desktop.wsl.error.installOpencode": "Installatie van Loginom AI Agent is mislukt",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Loginom AI Agent is niet geïnstalleerd in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "De Loginom AI Agent-update is voltooid, maar {{distro}} meldt nog steeds {{installed}}; verwacht: {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Voer je {{provider}}-API-sleutel in om je account te koppelen en {{provider}}-modellen in Loginom AI Agent te gebruiken.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " om je autorisatiecode op te halen, je account te koppelen en {{provider}}-modellen in Loginom AI Agent te gebruiken.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " en voer de onderstaande code in om je account te koppelen en {{provider}}-modellen in Loginom AI Agent te gebruiken.",
  ...
  "dialog.plugins.empty": "Plug-ins geconfigureerd in loginom-ai-agent.json",
  ...
  "dialog.server.description": "Wijzig met welke Loginom AI Agent-server deze app verbinding maakt.",
  ...
  "wsl.onboarding.checkingOpencode": "Loginom AI Agent controleren...",
  "wsl.onboarding.checkingOpencodeIn": "Loginom AI Agent controleren in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Loginom AI Agent bijwerken...",
  "wsl.onboarding.updatingOpencodeIn": "Loginom AI Agent bijwerken in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Werk Loginom AI Agent bij in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Loginom AI Agent bijwerken",
  "wsl.onboarding.opencodeReadyIn": "Loginom AI Agent is gereed in {{distro}}.",
  "wsl.onboarding.opencodeReady": "Loginom AI Agent is klaar.",
  "wsl.onboarding.installOpencodeIn": "Installeer Loginom AI Agent in {{distro}}.",
  "wsl.onboarding.installOpencode": "Installeer Loginom AI Agent",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Loginom AI Agent niet geïnstalleerd",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows-subsysteem voor Linux) is vereist voordat Loginom AI Agent een WSL-server kan toevoegen",
  "wsl.onboarding.wslUnavailable.title": "WSL niet beschikbaar",
  "wsl.onboarding.wslUnavailable.description": "Loginom AI Agent kan WSL niet verifiëren op deze machine.",
  "wsl.onboarding.installWsl": "Installeer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows opnieuw om de installatie van WSL te voltooien en open vervolgens Loginom AI Agent opnieuw.",
  ...
  "help.tabs.introduction": "Loginom AI Agent Desktop is nu opgebouwd rond tabbladen.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Er is nu een nieuwe versie van Loginom AI Agent ({{version}}) beschikbaar om te installeren.",
  ...
  "error.page.report.prefix": "Rapporteer deze fout aan het Loginom AI Agent-team",
  ...
  "error.chain.checkConfig": "Controleer de provider- en modelnamen in je configuratie (loginom-ai-agent.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" is mislukt. Let op: Loginom AI Agent ondersteunt nog geen MCP-authenticatie.',
  ...
  "settings.desktop.wsl.description": "Voer de Loginom AI Agent-server uit in WSL op Windows.",
  ...
  "settings.general.row.language.description": "Wijzig de weergavetaal voor Loginom AI Agent",
  ...
  "settings.general.row.appearance.description": "Pas aan hoe Loginom AI Agent eruitziet op je apparaat",
  "settings.general.row.colorScheme.title": "Kleurenschema",
  "settings.general.row.colorScheme.description":
    "Kies of Loginom AI Agent het systeemthema, het lichte thema of het donkere thema gebruikt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Pas het thema van Loginom AI Agent aan.",
  ...
  "settings.updates.row.startup.description": "Controleer automatisch op updates wanneer Loginom AI Agent wordt gestart",
  ...
  "settings.updates.toast.latest.title": "Loginom AI Agent is bijgewerkt",
  "settings.updates.toast.latest.description": "Je gebruikt de nieuwste versie van Loginom AI Agent.",
