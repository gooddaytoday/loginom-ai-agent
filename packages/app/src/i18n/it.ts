...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Inserisci la chiave API di {{provider}} per connettere il tuo account e utilizzare i modelli {{provider}} in Loginom AI Agent.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " per ottenere il codice di autorizzazione, connettere il tuo account e usare i modelli {{provider}} in Loginom AI Agent.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e inserisci il codice qui sotto per connettere il tuo account e usare i modelli {{provider}} in Loginom AI Agent.",
  ...
  "dialog.plugins.empty": "Plugin configurati in loginom-ai-agent.json",
  ...
  "dialog.server.description": "Cambia il server Loginom AI Agent a cui si connette l'app.",
  ...
  "wsl.onboarding.checkingOpencode": "Controllo Loginom AI Agent...",
  "wsl.onboarding.checkingOpencodeIn": "Controllo Loginom AI Agent in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aggiornamento Loginom AI Agent...",
  "wsl.onboarding.updatingOpencodeIn": "Aggiornamento Loginom AI Agent in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Aggiorna Loginom AI Agent in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Aggiorna Loginom AI Agent",
  "wsl.onboarding.opencodeReadyIn": "Loginom AI Agent è pronto in {{distro}}.",
  "wsl.onboarding.opencodeReady": "Loginom AI Agent è pronto.",
  "wsl.onboarding.installOpencodeIn": "Installa Loginom AI Agent in {{distro}}.",
  "wsl.onboarding.installOpencode": "Installa Loginom AI Agent",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Loginom AI Agent non installato",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Sottosistema Windows per Linux) è necessario prima che Loginom AI Agent possa aggiungere un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL non disponibile",
  "wsl.onboarding.wslUnavailable.description": "Loginom AI Agent non ha potuto verificare WSL su questa macchina.",
  "wsl.onboarding.installWsl": "Installa WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Riavvia Windows per completare l'installazione WSL, quindi riapri Loginom AI Agent.",
  ...
  "help.tabs.introduction": "Loginom AI Agent Desktop ora è incentrato sulle schede.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nuova versione di Loginom AI Agent ({{version}}) è ora disponibile per l'installazione.",
  ...
  "error.page.report.prefix": "Segnala questo errore al team Loginom AI Agent",
  ...
  "error.chain.checkConfig": "Controlla i nomi di provider e modelli nella configurazione (loginom-ai-agent.json)",
  "error.chain.mcpFailed":
    'Il server MCP "{{name}}" non ha funzionato. Nota: Loginom AI Agent non supporta ancora l\'autenticazione MCP.',
  ...
  "settings.desktop.wsl.description": "Esegui il server Loginom AI Agent all'interno di WSL su Windows.",
  ...
  "settings.general.row.language.description": "Cambia la lingua di visualizzazione per Loginom AI Agent",
  ...
  "settings.general.row.appearance.description": "Personalizza l'aspetto di Loginom AI Agent sul tuo dispositivo",
  "settings.general.row.colorScheme.title": "Combinazione di colori",
  "settings.general.row.colorScheme.description": "Scegli se Loginom AI Agent segue il tema di sistema, chiaro o scuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizza il tema di Loginom AI Agent.",
  ...
  "settings.updates.row.startup.description": "Controlla automaticamente gli aggiornamenti all'avvio di Loginom AI Agent",
  ...
  "settings.updates.toast.latest.title": "Loginom AI Agent è aggiornato",
  "settings.updates.toast.latest.description": "Stai utilizzando l'ultima versione di Loginom AI Agent.",
  ...
  "desktop.menu.documentation": "Documentazione di Loginom AI Agent",
  ...
  "desktop.menu.ariaLabel": "Menu Loginom AI Agent",
  ...
  "desktop.recovery.loadFailed": "Impossibile caricare Loginom AI Agent",
  "desktop.recovery.terminated": "La finestra di Loginom AI Agent si è chiusa in modo imprevisto",
  "desktop.recovery.unresponsive": "Loginom AI Agent non risponde",
  ...
  "desktop.wsl.error.installOpencode": "Installazione di Loginom AI Agent non riuscita",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Loginom AI Agent non è installato in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "L'aggiornamento di Loginom AI Agent è terminato, ma {{distro}} segnala ancora la versione {{installed}}; era prevista la versione {{expected}}",
