...
export const dict = {
  ...
  "desktop.menu.documentation": "Loginom AI Agent-dokumentasjon",
  ...
  "desktop.menu.ariaLabel": "Loginom AI Agent-meny",
  ...
  "desktop.recovery.loadFailed": "Loginom AI Agent kunne ikke lastes inn",
  "desktop.recovery.terminated": "Loginom AI Agent-vinduet ble uventet avsluttet",
  "desktop.recovery.unresponsive": "Loginom AI Agent svarer ikke",
  ...
  "desktop.wsl.error.installOpencode": "Installasjonen av Loginom AI Agent mislyktes",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Loginom AI Agent er ikke installert i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Oppdateringen av Loginom AI Agent er fullført, men {{distro}} rapporterer fortsatt {{installed}}; forventet {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn API-nøkkelen din for {{provider}} for å koble til kontoen din og bruke {{provider}}-modeller i Loginom AI Agent.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Loginom AI Agent.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Loginom AI Agent.",
  ...
  "dialog.plugins.empty": "Programtillegg konfigurert i loginom-ai-agent.json",
  ...
  "dialog.server.description": "Bytt hvilken Loginom AI Agent-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Loginom AI Agent ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Loginom AI Agent-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (loginom-ai-agent.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Loginom AI Agent ikke støtter MCP-autentisering ennå.',
  ...
  "settings.desktop.wsl.description": "Kjør Loginom AI Agent-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Loginom AI Agent",
  ...
  "settings.general.row.appearance.description": "Tilpass hvordan Loginom AI Agent ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description":
    "Velg om Loginom AI Agent skal følge systeminnstillingen eller bruke lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass temaet i Loginom AI Agent.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Loginom AI Agent starter",
  ...
  "settings.updates.toast.latest.title": "Loginom AI Agent er oppdatert",
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Loginom AI Agent.",
  ...
  "wsl.onboarding.checkingOpencode": "Sjekker Loginom AI Agent...",
  "wsl.onboarding.checkingOpencodeIn": "Sjekker Loginom AI Agent i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Oppdaterer Loginom AI Agent...",
  "wsl.onboarding.updatingOpencodeIn": "Oppdaterer Loginom AI Agent i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Oppdater Loginom AI Agent i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Oppdater Loginom AI Agent",
  "wsl.onboarding.opencodeReadyIn": "Loginom AI Agent er klar i {{distro}}.",
  "wsl.onboarding.opencodeReady": "Loginom AI Agent er klar.",
  "wsl.onboarding.installOpencodeIn": "Installer Loginom AI Agent i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Loginom AI Agent er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før Loginom AI Agent kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "Loginom AI Agent kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter Loginom AI Agent på nytt.",
  ...
  "help.tabs.introduction": "Loginom AI Agent Desktop er nå bygget rundt faner.",
  "help.tabs.sessions":
