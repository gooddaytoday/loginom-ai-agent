...
export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacja Loginom AI Agent",
  ...
  "desktop.recovery.loadFailed": "Nie udało się wczytać Loginom AI Agent",
  "desktop.recovery.terminated": "Okno Loginom AI Agent zostało nieoczekiwanie zamknięte",
  "desktop.recovery.unresponsive": "Loginom AI Agent nie odpowiada",
  ...
  "desktop.wsl.error.installOpencode": "Nie udało się zainstalować Loginom AI Agent",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Loginom AI Agent nie jest zainstalowany w dystrybucji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Aktualizacja Loginom AI Agent została ukończona, ale dystrybucja {{distro}} nadal zgłasza wersję {{installed}}; oczekiwano {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Loginom AI Agent.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Loginom AI Agent.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Loginom AI Agent.",
  ...
  "dialog.plugins.empty": "Wtyczki są skonfigurowane w pliku loginom-ai-agent.json",
  ...
  "dialog.server.description": "Przełącz serwer Loginom AI Agent, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingOpencode": "Sprawdzanie Loginom AI Agent...",
  "wsl.onboarding.checkingOpencodeIn": "Sprawdzanie Loginom AI Agent w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aktualizowanie Loginom AI Agent...",
  "wsl.onboarding.updatingOpencodeIn": "Aktualizowanie Loginom AI Agent w dystrybucji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Zaktualizuj Loginom AI Agent w dystrybucji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Zaktualizuj Loginom AI Agent",
  "wsl.onboarding.opencodeReadyIn": "Loginom AI Agent jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.opencodeReady": "Loginom AI Agent jest gotowy.",
  "wsl.onboarding.installOpencodeIn": "Zainstaluj Loginom AI Agent w dystrybucji {{distro}}.",
  "wsl.onboarding.installOpencode": "Zainstaluj Loginom AI Agent",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Loginom AI Agent nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim Loginom AI Agent będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "Loginom AI Agent nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz Loginom AI Agent.",
  ...
  "help.tabs.introduction": "Loginom AI Agent Desktop korzysta teraz z układu opartego na kartach.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nowa wersja Loginom AI Agent ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Loginom AI Agent",
  ...
  "error.chain.checkConfig": "Sprawdź nazwy dostawców i modeli w konfiguracji (loginom-ai-agent.json)",
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: Loginom AI Agent nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer Loginom AI Agent wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Loginom AI Agent",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd Loginom AI Agent na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy Loginom AI Agent ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Loginom AI Agent.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania Loginom AI Agent",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji Loginom AI Agent.",
