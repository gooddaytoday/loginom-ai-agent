...
const GLOBAL_STORAGE = "loginom-ai-agent.global.dat"
const WINDOW_STORAGE = "loginom-ai-agent.window"
const LOCAL_PREFIX = "loginom-ai-agent."
...
function workspaceStorage(dir: string) {
  ...
  return `loginom-ai-agent.workspace.${head}.${sum}.dat`
}
...
function draftStorage(draftID: string) {
  ...
  return `loginom-ai-agent.draft.${head}.${sum}.dat`
}
