...
import { Session } from "@loginom-ai-agent/sdk/v2/client"
...
import { useTheme, type ColorScheme } from "@loginom-ai-agent/ui/theme/context"
...
export default function LegacyLayout(props: ParentProps) {
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openExternal(Product.support)}
      renderPanel={() =>
