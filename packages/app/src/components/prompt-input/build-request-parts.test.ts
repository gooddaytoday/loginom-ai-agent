...
describe("buildRequestParts", () => {
  ...
  test("preserves an external attachment source path for the model", () => {
      ...
      images: [
        {
          type: "image",
          id: "img_external",
          filename: "loginom-ai-agent.global.dat",
          sourcePath: "C:\\Users\\Luke\\AppData\\Roaming\\com.loginom.aiagent.beta\\loginom-ai-agent.global.dat",
          mime: "text/plain",
    ...
    expect(result.requestParts.find((part) => part.type === "file")?.filename).toBe(
      "C:\\Users\\Luke\\AppData\\Roaming\\com.loginom.aiagent.beta\\loginom-ai-agent.global.dat",
    )
  })
