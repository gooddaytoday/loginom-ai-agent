...
beforeAll(async () => {
  ...
  mock.module("@loginom-ai-agent/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@loginom-ai-agent/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@loginom-ai-agent/ui/icon", () => ({ Icon: () => null }))
  mock.module("@loginom-ai-agent/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
