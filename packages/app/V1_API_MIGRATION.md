...
The app is currently hybrid. In this document, V1 refers to the legacy unprefixed server APIs used by `@loginom-ai-agent/sdk/v2`, despite the SDK package name.
...
- [ ] Remove the `@loginom-ai-agent/sdk` runtime dependency after all legacy calls and types are gone.
  - `package.json`
