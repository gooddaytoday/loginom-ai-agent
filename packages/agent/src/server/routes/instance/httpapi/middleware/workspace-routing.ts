...
>()("@loginom-ai-agent/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@loginom-ai-agent/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceV2.ID | undefined {
  return Flag.LOGINOM_AI_AGENT_WORKSPACE_ID ? WorkspaceV2.ID.make(Flag.LOGINOM_AI_AGENT_WORKSPACE_ID) : undefined
}
