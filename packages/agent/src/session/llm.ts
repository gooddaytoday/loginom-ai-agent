...
import { llmClient } from "@loginom-ai-agent/core/effect/app-node-platform"
...
import type { LLMEvent } from "@loginom-ai-agent/llm"
import { LLMClient } from "@loginom-ai-agent/llm/route"
import type { LLMClientService } from "@loginom-ai-agent/llm/route"
...
export class Service extends Context.Service<Service, Interface>()("@loginom-ai-agent/LLM") {}
...
> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const run = Effect.fn("LLM.run")(function* (input: StreamRequest) {
      ...
      // Runtime seam: native is an opt-in adapter over @loginom-ai-agent/llm. It
