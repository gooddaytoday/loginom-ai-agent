...
import { buildPrompt } from "@loginom-ai-agent/core/session/compaction"
import { SessionCompactionEvent } from "@loginom-ai-agent/schema/session-compaction-event"
...
export class Service extends Context.Service<Service, Interface>()("@loginom-ai-agent/SessionCompaction") {}
