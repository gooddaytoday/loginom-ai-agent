import type { JsonSchema, LLMRequest, ProviderMetadata } from "@loginom-ai-agent/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@loginom-ai-agent/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @loginom-ai-agent/llm request objects from opencode's session/AI SDK-shaped data.
  return LLM.request({
