import { FinishReason, LLMEvent, ProviderMetadata, ToolResultValue } from "@loginom-ai-agent/llm"
...
// Move this extraction into @loginom-ai-agent/llm when Copilot is handled by the native runtime.
