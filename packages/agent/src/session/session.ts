...
import { Slug } from "@loginom-ai-agent/core/util/slug"
...
import type { ProviderMetadata, Usage } from "@loginom-ai-agent/llm"
...
import { locationServiceMapLayer } from "@loginom-ai-agent/core/location-services"
...
import { PartTable, SessionTable } from "@loginom-ai-agent/core/session/sql"
...
import { NonNegativeInt, optional } from "@loginom-ai-agent/core/schema"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".loginom-ai-agent", "plans")
...
export class Service extends Context.Service<Service, Interface>()("@loginom-ai-agent/Session") {}
