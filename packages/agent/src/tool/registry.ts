...
import { type ToolContext as PluginToolContext, type ToolDefinition } from "@loginom-ai-agent/plugin"
...
export class Service extends Context.Service<Service, Interface>()("@loginom-ai-agent/ToolRegistry") {}
