...
import { httpClient, path } from "@loginom-ai-agent/core/effect/app-node-platform"
...
export class Service extends Context.Service<Service, Interface>()("@loginom-ai-agent/SkillDiscovery") {}
