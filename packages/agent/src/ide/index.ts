...
import { IdeEvent } from "@loginom-ai-agent/schema/ide-event"
...
export function alreadyInstalled() {
  return process.env["LOGINOM_AI_AGENT_CALLER"] === "vscode" || process.env["LOGINOM_AI_AGENT_CALLER"] === "vscode-insiders"
}
