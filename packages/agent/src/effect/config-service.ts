 ...
 *   "@loginom-ai-agent/ServerAuthConfig",
 *   {
 *     password: Config.string("LOGINOM_AI_AGENT_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("LOGINOM_AI_AGENT_SERVER_USERNAME").pipe(Config.withDefault("opencode")),
 *   },
 * ) {}
 *
