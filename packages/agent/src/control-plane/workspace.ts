...
import { EventSequenceTable, EventTable } from "@loginom-ai-agent/core/event/sql"
...
import { WorkspaceEvent } from "@loginom-ai-agent/schema/workspace-event"
...
export class Service extends Context.Service<Service, Interface>()("@loginom-ai-agent/Workspace") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        LOGINOM_AI_AGENT_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        LOGINOM_AI_AGENT_WORKSPACE_ID: config.id,
        LOGINOM_AI_AGENT_EXPERIMENTAL_WORKSPACES: "true",
