...
import { ProjectDirectoryTable, ProjectTable } from "@loginom-ai-agent/core/project/sql"
import { ProjectDirectories } from "@loginom-ai-agent/core/project/directories"
...
import { which } from "@loginom-ai-agent/core/util/which"
...
export class Service extends Context.Service<Service, Interface>()("@loginom-ai-agent/Project") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(Project.Vcs))(Flag.LOGINOM_AI_AGENT_FAKE_VCS)
