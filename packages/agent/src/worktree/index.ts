...
import { path } from "@loginom-ai-agent/core/effect/app-node-platform"
...
import type { ProjectV2 } from "@loginom-ai-agent/core/project"
...
import { WorktreeEvent } from "@loginom-ai-agent/schema/worktree-event"
...
export class Service extends Context.Service<Service, Interface>()("@loginom-ai-agent/Worktree") {}
