...
export function permissionAlwaysLines(request: PermissionRequest): string[] {
  if (request.always.length === 1 && request.always[0] === "*") {
    return [`This will allow ${request.permission} until Loginom AI Agent is restarted.`]
  }

  return [
    "This will allow the following patterns until Loginom AI Agent is restarted.",
