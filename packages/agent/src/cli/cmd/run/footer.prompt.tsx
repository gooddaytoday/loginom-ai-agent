...
import { normalizePromptContent } from "@loginom-ai-agent/tui/editor"
...
import { LOGINOM_AI_AGENT_BASE_MODE, useBindings } from "@loginom-ai-agent/tui/keymap"
...
export function createPromptState(input: PromptInput): PromptState {
  ...
  const slashOptions = createMemo<SlashOption[]>(() => {
    const builtins = [
      ...
      { kind: "slash", name: "exit", display: "/exit", description: "close Loginom AI Agent" } satisfies SlashOption,
    ]
