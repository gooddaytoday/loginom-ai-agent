...
import type { Event, GlobalEvent, OpencodeClient } from "@loginom-ai-agent/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@loginom-ai-agent/RunStreamTransport") {}
