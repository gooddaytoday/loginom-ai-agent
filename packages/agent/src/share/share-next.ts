...
import type * as SDK from "@loginom-ai-agent/sdk/v2"
...
import { SessionShareTable } from "@loginom-ai-agent/core/share/sql"
...
const disabled = process.env["LOGINOM_AI_AGENT_DISABLE_SHARE"] === "true" || process.env["LOGINOM_AI_AGENT_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@loginom-ai-agent/ShareNext") {}
