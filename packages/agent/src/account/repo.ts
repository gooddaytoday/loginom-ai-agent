...
import { AccountStateTable, AccountTable } from "@loginom-ai-agent/core/account/sql"
...
export class Service extends Context.Service<Service, Interface>()("@loginom-ai-agent/AccountRepo") {}
