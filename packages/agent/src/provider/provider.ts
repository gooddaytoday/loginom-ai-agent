...
import { Hash } from "@loginom-ai-agent/core/util/hash"
...
import { optional } from "@loginom-ai-agent/core/schema"
...
const BUNDLED_PROVIDERS: Record<string, () => Promise<(opts: any) => BundledSDK>> = {
  ...
  "@ai-sdk/github-copilot": () =>
    import("@loginom-ai-agent/core/github-copilot/copilot-provider").then((m) => m.createOpenaiCompatible),
    ...
    "amazon-bedrock": Effect.fnUntraced(function* () {
      ...
      return {
        ...
        async getModel(sdk: any, modelID: string, options?: Record<string, any>, model?: Model) {
          ...
          // 1. options.region from loginom-ai-agent.json provider config
...
export class Service extends Context.Service<Service, Interface>()("@loginom-ai-agent/Provider") {}
