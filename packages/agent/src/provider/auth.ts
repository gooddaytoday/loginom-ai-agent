...
import type { AuthOAuthResult, Hooks } from "@loginom-ai-agent/plugin"
...
export class Service extends Context.Service<Service, Interface>()("@loginom-ai-agent/ProviderAuth") {}
