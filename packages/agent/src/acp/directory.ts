...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@loginom-ai-agent/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@loginom-ai-agent/ACPDirectory") {}
