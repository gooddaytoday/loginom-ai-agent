...
describe("opencode read-only commands (smoke)", () => {
  ...
  // LOGINOM_AI_AGENT_CONFIG_CONTENT={} we provide, no servers should be configured
  ...
  // `session list` reads the session DB. Fresh LOGINOM_AI_AGENT_TEST_HOME means
  ...
  // in production it'd be a path under LOGINOM_AI_AGENT_TEST_HOME / XDG_DATA_HOME.
