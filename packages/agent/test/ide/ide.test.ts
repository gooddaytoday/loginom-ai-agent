...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders LOGINOM_AI_AGENT_CALLER", () => {
    process.env["LOGINOM_AI_AGENT_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode LOGINOM_AI_AGENT_CALLER", () => {
    process.env["LOGINOM_AI_AGENT_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown LOGINOM_AI_AGENT_CALLER", () => {
    process.env["LOGINOM_AI_AGENT_CALLER"] = "unknown"
