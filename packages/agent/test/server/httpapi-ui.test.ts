  ...
  Effect.gen(function* () {
    ...
    yield* Effect.addFinalizer(() =>
      Effect.sync(() => {
        ...
        restoreEnv("LOGINOM_AI_AGENT_SERVER_PASSWORD", original.envPassword)
        restoreEnv("LOGINOM_AI_AGENT_SERVER_USERNAME", original.envUsername)
      }),
    )
  }),
)
      ...
      Layer.provide(
        ConfigProvider.layer(
          ConfigProvider.fromUnknown({
            LOGINOM_AI_AGENT_SERVER_PASSWORD: input?.password,
            LOGINOM_AI_AGENT_SERVER_USERNAME: input?.username,
          }),
        ),
      ),
    ),
