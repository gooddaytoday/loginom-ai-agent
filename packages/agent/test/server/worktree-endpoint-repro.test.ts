...
const stateLayer = Layer.effectDiscard(
  Effect.gen(function* () {
    const original = {
      LOGINOM_AI_AGENT_EXPERIMENTAL_WORKSPACES: Flag.LOGINOM_AI_AGENT_EXPERIMENTAL_WORKSPACES,
    }
    ...
    yield* Effect.addFinalizer(() =>
      Effect.promise(async () => {
        Flag.LOGINOM_AI_AGENT_EXPERIMENTAL_WORKSPACES = original.LOGINOM_AI_AGENT_EXPERIMENTAL_WORKSPACES
        await resetDatabase()
      }),
    )
  }),
