...
//   - LOGINOM_AI_AGENT_CONFIG_CONTENT      : provider config inline, no files to find
//   - LOGINOM_AI_AGENT_TEST_HOME           : pins os.homedir() → tmpdir
//   - LOGINOM_AI_AGENT_DISABLE_PROJECT_CONFIG : skip walking up for loginom-ai-agent.json
//   - LOGINOM_AI_AGENT_PURE                : skip external plugin discovery + install
//   - LOGINOM_AI_AGENT_DISABLE_AUTOUPDATE / AUTOCOMPACT / MODELS_FETCH : no background work
...
function isolatedEnv(home: string, configJson: string): Record<string, string> {
  return {
    LOGINOM_AI_AGENT_TEST_HOME: home,
    HOME: home,
    XDG_CONFIG_HOME: path.join(home, ".config"),
    XDG_DATA_HOME: path.join(home, ".local/share"),
    XDG_STATE_HOME: path.join(home, ".local/state"),
    XDG_CACHE_HOME: path.join(home, ".cache"),
    LOGINOM_AI_AGENT_CONFIG_CONTENT: configJson,
    LOGINOM_AI_AGENT_DISABLE_PROJECT_CONFIG: "1",
    LOGINOM_AI_AGENT_PURE: "1",
    LOGINOM_AI_AGENT_DISABLE_AUTOUPDATE: "1",
    LOGINOM_AI_AGENT_DISABLE_AUTOCOMPACT: "1",
