...
const withHome = <A, E, R>(home: string, self: Effect.Effect<A, E, R>) =>
  Effect.acquireUseRelease(
    Effect.sync(() => {
      const prev = process.env.LOGINOM_AI_AGENT_TEST_HOME
      process.env.LOGINOM_AI_AGENT_TEST_HOME = home
      return prev
    }),
    () => self,
    (prev) =>
      Effect.sync(() => {
        process.env.LOGINOM_AI_AGENT_TEST_HOME = prev
      }),
  )
...
describe("skill", () => {
  ...
  it.live("discovers skills from .loginom-ai-agent/skill/ directory", () =>
    provideTmpdirInstance(
      (dir) =>
        Effect.gen(function* () {
          yield* Effect.promise(() =>
            Bun.write(
              path.join(dir, ".loginom-ai-agent", "skill", "test-skill", "SKILL.md"),
              `---
name: test-skill
      ...
      (dir) =>
        withHome(
          ...
          Effect.gen(function* () {
            yield* Effect.promise(() =>
              Bun.write(
                path.join(dir, ".loginom-ai-agent", "skill", "dir-skill", "SKILL.md"),
                `---
name: dir-skill
...
`,
            ...
            expect(dirs).toContain(path.join(dir, ".loginom-ai-agent", "skill", "dir-skill"))
  ...
  it.live("discovers multiple skills from .loginom-ai-agent/skill/ directory", () =>
    provideTmpdirInstance(
      (dir) =>
        Effect.gen(function* () {
          yield* Effect.promise(() =>
            Promise.all([
              Bun.write(
                path.join(dir, ".loginom-ai-agent", "skill", "skill-one", "SKILL.md"),
                `---
name: skill-one
...
`,
              ...
              Bun.write(
                path.join(dir, ".loginom-ai-agent", "skill", "skill-two", "SKILL.md"),
                `---
name: skill-two
    ...
    provideTmpdirInstance(
      (dir) =>
        Effect.gen(function* () {
          yield* Effect.promise(() =>
            Bun.write(
              path.join(dir, ".loginom-ai-agent", "skill", "no-frontmatter", "SKILL.md"),
              `# No Frontmatter
    ...
    provideTmpdirInstance(
      (dir) =>
        Effect.gen(function* () {
          yield* Effect.promise(() =>
            Bun.write(
              path.join(dir, ".loginom-ai-agent", "skill", "manual-skill", "SKILL.md"),
              `---
name: manual-skill
---
...
`,
              ...
              Bun.write(
                path.join(dir, ".loginom-ai-agent", "skill", "opencode-skill", "SKILL.md"),
                `---
name: opencode-skill
description: A skill in the .loginom-ai-agent/skill directory.
---
...
`,
              ...
              Bun.write(
                path.join(dir, ".loginom-ai-agent", "skill", "agent-skill", "SKILL.md"),
                `---
name: opencode-skill
description: A skill in the .loginom-ai-agent/skill directory.
---
...
`,
              ...
              Bun.write(
                path.join(dir, ".loginom-ai-agent", "skills", "agent-skill", "SKILL.md"),
                `---
name: opencode-skill
description: A skill in the .loginom-ai-agent/skills directory.
---
