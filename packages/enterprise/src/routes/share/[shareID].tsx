import { Message, Model, Part, Session, SessionStatus, SnapshotFileDiff, UserMessage } from "@loginom-ai-agent/sdk/v2"
import { SessionTurn } from "@loginom-ai-agent/session-ui/session-turn"
import { SessionReview } from "@loginom-ai-agent/session-ui/session-review"
import { DataProvider } from "@loginom-ai-agent/session-ui/context"
import { FileComponentProvider } from "@loginom-ai-agent/ui/context/file"
import { WorkerPoolProvider } from "@loginom-ai-agent/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createMemo, createSignal, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@loginom-ai-agent/ui/logo"
import { IconButton } from "@loginom-ai-agent/ui/icon-button"
import { ProviderIcon } from "@loginom-ai-agent/ui/provider-icon"
import { iife } from "@loginom-ai-agent/core/util/iife"
...
import { MessageNav } from "@loginom-ai-agent/session-ui/message-nav"
import { FileSSR } from "@loginom-ai-agent/session-ui/file-ssr"
...
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@loginom-ai-agent/session-ui/pierre/worker").then((m) => ({
