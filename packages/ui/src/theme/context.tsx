...
const STORAGE_KEYS = {
  THEME_ID: "loginom-ai-agent-theme-id",
  COLOR_SCHEME: "loginom-ai-agent-color-scheme",
  THEME_CSS_LIGHT: "loginom-ai-agent-theme-css-light",
  THEME_CSS_DARK: "loginom-ai-agent-theme-css-dark",
} as const
...
const names: Record<string, string> = {
  ...
  "loginom-ai-agent": "Loginom AI Agent",
  orng: "Orng",
