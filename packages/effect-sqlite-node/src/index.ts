...
export const TypeId: TypeId = "~@loginom-ai-agent/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@loginom-ai-agent/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@loginom-ai-agent/effect-sqlite-node/NodeSqliteClient")
