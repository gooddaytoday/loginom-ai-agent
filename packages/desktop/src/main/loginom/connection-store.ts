...
// Only Electron main owns this directory. It is outside the generic renderer stores.
export function connectionStore(directory: string, codec = credentials(process.platform)) {
