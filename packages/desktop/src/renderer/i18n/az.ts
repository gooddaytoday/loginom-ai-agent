export const dict = {
  ...
  "desktop.updater.none.message": "Artıq Loginom AI Agent-un ən son versiyasından istifadə edirsiniz",
  ...
  "desktop.updater.downloaded.prompt":
    "Loginom AI Agent-un {{version}} versiyası yüklənib. Onu quraşdırıb tətbiqi yenidən başlatmaq istəyirsiniz?",
