export const dict = {
  ...
  "desktop.updater.none.message": "თქვენ უკვე იყენებთ Loginom AI Agent-ის უახლეს ვერსიას",
  ...
  "desktop.updater.downloaded.prompt":
    "Loginom AI Agent-ის {{version}} ვერსია ჩამოტვირთულია, გსურთ მისი ინსტალაცია და ხელახლა გაშვება?",
