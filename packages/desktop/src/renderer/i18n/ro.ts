export const dict = {
  ...
  "desktop.updater.none.message": "Folosești deja cea mai recentă versiune Loginom AI Agent",
  ...
  "desktop.updater.downloaded.prompt":
    "Versiunea {{version}} Loginom AI Agent a fost descărcată. Vrei să o instalezi și să repornești?",
  ...
  "desktop.cli.installed.message":
    "CLI a fost instalat în {{path}}\n\nRepornește terminalul pentru a folosi comanda 'loginom-ai-agent'.",
