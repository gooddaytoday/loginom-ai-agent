export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av Loginom AI Agent",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av Loginom AI Agent er lastet ned. Vil du installere den og starte på nytt?",
