export const dict = {
  ...
  "desktop.updater.none.message": "Du använder redan den senaste versionen av Loginom AI Agent",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} av Loginom AI Agent har laddats ned. Vill du installera den och starta om programmet?",
  ...
  "desktop.cli.installed.message":
    "CLI installerat i {{path}}\n\nStarta om terminalen för att använda kommandot 'loginom-ai-agent'.",
