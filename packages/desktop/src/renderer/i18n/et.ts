export const dict = {
  ...
  "desktop.updater.none.message": "Kasutate juba rakenduse Loginom AI Agent uusimat versiooni",
  ...
  "desktop.updater.downloaded.prompt":
    "Loginom AI Agent'i versioon {{version}} on alla laaditud. Kas soovite selle installida ja rakenduse taaskäivitada?",
