export const dict = {
  ...
  "desktop.updater.none.message": "Þú ert nú þegar að nota nýjustu útgáfuna af Loginom AI Agent",
  ...
  "desktop.updater.downloaded.prompt":
    "Útgáfu {{version}} af Loginom AI Agent hefur verið hlaðið niður. Viltu setja hana upp og endurræsa?",
