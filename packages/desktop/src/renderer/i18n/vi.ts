export const dict = {
  ...
  "desktop.updater.none.message": "Bạn đang sử dụng phiên bản mới nhất của Loginom AI Agent",
  ...
  "desktop.updater.downloaded.prompt":
    "Phiên bản {{version}} của Loginom AI Agent đã được tải xuống, bạn có muốn cài đặt và khởi chạy lại không?",
