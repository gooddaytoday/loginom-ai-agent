export const dict = {
  ...
  "desktop.updater.none.message": "تسی پہلے ای Loginom AI Agent دا تازہ ترین ورژن استعمال کر رئے او",
  ...
  "desktop.updater.downloaded.prompt":
    "Loginom AI Agent دا ورژن {{version}} ڈاؤن لوڈ کر دتا گیا اے، کی تسی اینوں انسٹال کرنا تے دوبارہ لانچ کرنا چاہندے او؟",
  ...
  "desktop.cli.installed.message":
    "CLI {{path}} تے انسٹال کیتا گیا\n\n'loginom-ai-agent' کمانڈ ورتن لئی اپنے ٹرمینل نوں دوبارہ شروع کرو۔",
