export const dict = {
  ...
  "desktop.updater.none.message": "Вече използвате най-новата версия на Loginom AI Agent",
  ...
  "desktop.updater.downloaded.prompt":
    "Версия {{version}} от Loginom AI Agent е изтеглена. Искате ли да я инсталирате и рестартирате?",
  ...
  "desktop.cli.installed.message":
    "CLI инсталиран на {{path}}\n\nРестартирайте терминала си, за да използвате командата 'loginom-ai-agent'.",
