export const dict = {
  ...
  "desktop.updater.none.message": "Tú brúkar longu nýggjastu útgávuna av Loginom AI Agent.",
  ...
  "desktop.updater.downloaded.prompt":
    "Útgáva {{version}} av Loginom AI Agent er heintað, vilt tú seta hana upp og seta hana í gongd aftur?",
  ...
  "desktop.cli.installed.message":
    "CLI sett upp í {{path}}\n\nEndurbyrja terminalin fyri at brúka skipanina 'loginom-ai-agent'.",
