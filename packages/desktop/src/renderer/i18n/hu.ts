export const dict = {
  ...
  "desktop.updater.none.message": "Már az Loginom AI Agent legújabb verzióját használja",
  ...
  "desktop.updater.downloaded.prompt":
    "Az Loginom AI Agent {{version}} verziója letöltődött. Szeretné telepíteni és újraindítani az alkalmazást?",
