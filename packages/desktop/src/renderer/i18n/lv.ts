export const dict = {
  ...
  "desktop.updater.none.message": "Jūs jau izmantojat jaunāko Loginom AI Agent versiju",
  ...
  "desktop.updater.downloaded.prompt":
    "Loginom AI Agent versija {{version}} ir lejupielādēta. Vai vēlaties to instalēt un palaist no jauna?",
