export const dict = {
  ...
  "desktop.updater.none.message": "شما در حال حاضر از آخرین نسخه Loginom AI Agent استفاده می کنید",
  ...
  "desktop.updater.downloaded.prompt":
    "نسخه {{version}} Loginom AI Agent دانلود شده است، آیا می خواهید آن را نصب کنید و دوباره راه اندازی کنید؟",
  ...
  "desktop.cli.installed.message":
    "CLI روی {{path}} نصب شد\n\nترمینال خود را مجددا راه اندازی کنید تا از دستور 'loginom-ai-agent' استفاده کنید.",
