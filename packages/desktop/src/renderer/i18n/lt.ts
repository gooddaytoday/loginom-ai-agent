export const dict = {
  ...
  "desktop.updater.none.message": "Jau naudojate naujausią Loginom AI Agent versiją",
  ...
  "desktop.updater.downloaded.prompt":
    "Loginom AI Agent versija {{version}} atsisiųsta, ar norėtumėte ją įdiegti ir paleisti iš naujo?",
