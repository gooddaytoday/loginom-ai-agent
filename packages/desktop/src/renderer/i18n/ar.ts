export const dict = {
  ...
  "desktop.updater.none.message": "أنت تستخدم بالفعل أحدث إصدار من Loginom AI Agent",
  ...
  "desktop.updater.downloaded.prompt":
    "تم تنزيل الإصدار {{version}} من Loginom AI Agent. هل ترغب في تثبيته وإعادة تشغيل التطبيق؟",
