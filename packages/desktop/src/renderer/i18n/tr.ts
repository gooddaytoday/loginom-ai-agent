export const dict = {
  ...
  "desktop.updater.none.message": "Loginom AI Agent'un en son sürümünü zaten kullanıyorsunuz",
  ...
  "desktop.updater.downloaded.prompt":
    "Loginom AI Agent'un {{version}} sürümü indirildi. Şimdi yükleyip yeniden başlatmak ister misiniz?",
  ...
  "desktop.cli.installed.message":
    "CLI {{path}} konumuna yüklendi\n\n'loginom-ai-agent' komutunu kullanmak için terminalinizi yeniden başlatın.",
