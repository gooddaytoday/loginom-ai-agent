export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji Loginom AI Agent",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} Loginom AI Agent. Czy chcesz ją zainstalować i uruchomić ponownie?",
