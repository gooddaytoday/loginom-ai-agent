export const dict = {
  ...
  "desktop.updater.none.message": "Ja utilitzeu la versió més recent d'Loginom AI Agent",
  ...
  "desktop.updater.downloaded.prompt":
    "S'ha baixat la versió {{version}} d'Loginom AI Agent. Voleu instal·lar-la i reiniciar l'aplicació?",
