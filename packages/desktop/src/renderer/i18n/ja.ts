export const dict = {
  ...
  "desktop.updater.none.message": "すでに最新バージョンの Loginom AI Agent を使用しています",
  ...
  "desktop.updater.downloaded.prompt":
    "Loginom AI Agent のバージョン {{version}} がダウンロードされました。インストールして再起動しますか？",
  ...
  "desktop.cli.installed.message":
    "CLI を {{path}} にインストールしました\n\nターミナルを再起動して 'loginom-ai-agent' コマンドを使用してください。",
