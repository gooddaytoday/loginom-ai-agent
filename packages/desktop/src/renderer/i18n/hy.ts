export const dict = {
  ...
  "desktop.updater.none.message": "Դուք արդեն օգտագործում եք Loginom AI Agent-ի վերջին տարբերակը",
  ...
  "desktop.updater.downloaded.prompt":
    "Loginom AI Agent-ի {{version}} տարբերակը ներբեռնվել է: Ցանկանու՞մ եք տեղադրել այն և վերագործարկել:",
