export const dict = {
  ...
  "desktop.updater.none.message": "አሁን የቅርብ ጊዜውን የLoginom AI Agent ስሪት እየተጠቀሙ ነው",
  ...
  "desktop.updater.downloaded.prompt": "ስሪት {{version}} ከLoginom AI Agent ወርዷል፣ መጫን እና እንደገና ማስጀመር ይፈልጋሉ?",
