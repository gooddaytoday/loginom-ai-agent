export const dict = {
  ...
  "desktop.updater.none.message": "Веќе ја користите најновата верзија на Loginom AI Agent",
  ...
  "desktop.updater.downloaded.prompt":
    "Верзијата {{version}} од Loginom AI Agent е преземена, дали сакате да ја инсталирате и повторно да ја стартувате?",
