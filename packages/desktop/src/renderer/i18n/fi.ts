export const dict = {
  ...
  "desktop.updater.none.message": "Käytät jo Loginom AI Agentn uusinta versiota",
  ...
  "desktop.updater.downloaded.prompt":
    "Loginom AI Agentn versio {{version}} on ladattu. Haluatko asentaa sen ja käynnistää Loginom AI Agentn uudelleen?",
