export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju Loginom AI Agent-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} Loginom AI Agent-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
  ...
  "desktop.cli.installed.message":
    "CLI je instaliran u {{path}}\n\nPonovo pokreni terminal da bi koristio komandu 'loginom-ai-agent'.",
