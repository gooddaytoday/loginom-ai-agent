export const dict = {
  ...
  "desktop.updater.none.message": "Používate najnovšiu verziu Loginom AI Agent",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzia {{version}} Loginom AI Agent bola stiahnutá. Chcete ju nainštalovať a reštartovať?",
