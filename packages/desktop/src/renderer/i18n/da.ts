export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af Loginom AI Agent",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af Loginom AI Agent er blevet downloadet. Vil du installere den og genstarte?",
  ...
  "desktop.cli.installed.message":
    "CLI installeret i {{path}}\n\nGenstart din terminal for at bruge 'loginom-ai-agent'-kommandoen.",
