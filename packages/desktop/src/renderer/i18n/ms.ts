export const dict = {
  ...
  "desktop.updater.none.message": "Anda sudah menggunakan versi terkini Loginom AI Agent",
  ...
  "desktop.updater.downloaded.prompt":
    "Versi {{version}} Loginom AI Agent telah dimuat turun, adakah anda ingin memasangnya dan melancarkan semula?",
