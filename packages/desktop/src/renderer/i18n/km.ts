export const dict = {
  ...
  "desktop.updater.none.message": "អ្នកកំពុងប្រើកំណែចុងក្រោយនៃ Loginom AI Agent រួចហើយ",
  ...
  "desktop.updater.downloaded.prompt":
    "កំណែ {{version}} នៃ Loginom AI Agent ត្រូវបានទាញយក តើអ្នកចង់ដំឡើងវា ហើយចាប់ផ្ដើមឡើងវិញទេ?",
  ...
  "desktop.cli.installed.message":
    "CLI បានដំឡើងទៅ {{path}}\n\nចាប់ផ្តើមស្ថានីយរបស់អ្នកឡើងវិញ ដើម្បីប្រើពាក្យបញ្ជា 'loginom-ai-agent' ។",
