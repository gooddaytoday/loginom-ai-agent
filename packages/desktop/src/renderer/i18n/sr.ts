export const dict = {
  ...
  "desktop.updater.none.message": "Већ користите најновију верзију Loginom AI Agent",
  ...
  "desktop.updater.downloaded.prompt":
    "Верзија {{version}} од Loginom AI Agent је преузета, да ли желите да је инсталирате и поново покренете?",
