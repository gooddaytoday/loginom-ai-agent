export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'Loginom AI Agent",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'Loginom AI Agent a été téléchargée. Voulez-vous l'installer et relancer l'application ?",
