export const dict = {
  ...
  "desktop.updater.none.message": "Je gebruikt al de nieuwste versie van Loginom AI Agent",
  ...
  "desktop.updater.downloaded.prompt":
    "Versie {{version}} van Loginom AI Agent is gedownload. Wil je deze installeren en Loginom AI Agent opnieuw starten?",
  ...
  "desktop.cli.installed.message":
    "CLI geïnstalleerd op {{path}}\n\nStart je terminal opnieuw om de opdracht 'loginom-ai-agent' te gebruiken.",
