...
const releaseId = process.env.LOGINOM_AI_AGENT_RELEASE
if (!releaseId) throw new Error("LOGINOM_AI_AGENT_RELEASE is required")

const version = process.env.LOGINOM_AI_AGENT_VERSION
if (!version) throw new Error("LOGINOM_AI_AGENT_VERSION is required")
