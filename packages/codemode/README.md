...
{
  "dependencies": {
    "@loginom-ai-agent/codemode": "workspace:*"
  }
}
```
...
```ts
import { CodeMode, Tool } from "@loginom-ai-agent/codemode"
...
```ts
import { CodeMode, OpenAPI } from "@loginom-ai-agent/codemode"
...
```ts
import { toolError } from "@loginom-ai-agent/codemode"
