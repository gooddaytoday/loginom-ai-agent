...
The Promise plugin API is the async/await equivalent of `@loginom-ai-agent/plugin/v2/effect`. It grants plugins the same two in-process capabilities:
...
```ts
import { define } from "@loginom-ai-agent/plugin/v2/promise"
