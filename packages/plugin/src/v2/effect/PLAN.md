...
- Effect plugins import `@loginom-ai-agent/plugin/v2/effect`, not `@loginom-ai-agent/core`.
- Public domain values use generated `@loginom-ai-agent/sdk` types.
...
- Define `PluginHost` domain capabilities in `@loginom-ai-agent/plugin/v2/effect`.
