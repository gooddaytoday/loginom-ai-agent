...
- Canonical tagged tool file sources in `@loginom-ai-agent/llm`.
...
- Canonicalize ambient instruction traversal boundaries, honor `LOGINOM_AI_AGENT_DISABLE_PROJECT_CONFIG`, and make non-empty aggregate updates explicitly supersede previously loaded instructions.
