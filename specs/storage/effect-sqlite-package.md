...
- `@loginom-ai-agent/effect-drizzle-sqlite`
...
1. Add `@loginom-ai-agent/effect-drizzle-sqlite` with a minimal in-memory/file SQLite test schema.
...
4. Add `@loginom-ai-agent/effect-drizzle-sqlite` as a dependency of `packages/agent`.
