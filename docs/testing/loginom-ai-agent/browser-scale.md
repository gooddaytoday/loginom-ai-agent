...
Linux Desktop 0.1.16 из `scale-fix` уже собран, статически проверен и установлен;
изолированный GUI smoke прошёл. [Отчёт установки](reports/2026-09-25-scale-fix-desktop-install.md).
Это не закрывает сценарную приёмку исправления масштаба.

Нужны сборка и установка исправленного CLI, проверка полного source pin
для обеих поставок и CSV 55/101 с сохранением и холодным открытием на каждой
