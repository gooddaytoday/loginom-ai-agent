...
Нативная проверка helper и его идентичной копии прошла; полная installed
acceptance конечного кандидата пока не подтверждена. Эти результаты не
расширяют историческую Linux-приёмку ниже.
