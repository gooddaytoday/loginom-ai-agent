...
> Историческая спецификация. В ветке `loginom-cli` действует
> [дизайн самостоятельного CLI](2026-09-17-loginom-cli-standalone-design.md).
> Общая служба, client registry и миграция Desktop не входят в новую реализацию.
