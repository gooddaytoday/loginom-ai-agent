...
## 2026-09-24 — подготовка 0.1.16: ожидание совместимости портов

После заблокированной приёмки 0.1.15 пользователь разрешил исправление и новый
выпуск. При задержке проверки портов на 20 секунд старый алгоритм воспроизводит
отказ, исправленный создаёт связь одним удержанным жестом и подтверждает граф.
Полный Runtime: 2382 PASS / 4 SKIP, профильные тесты: 130 PASS. Это проверка
исходников, ещё не приёмка артефактов 0.1.16. Полные условия выпуска сохранены.
Актуальный статус: [отчёт 0.1.16](../testing/loginom-ai-agent/reports/2026-09-24-link-validation-release.md).
