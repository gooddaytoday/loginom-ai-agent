...
Обновление реализации: стабильный снимок исходников архивирован и восстановлен
2026-09-16; первичный импорт выполнен. См. [выбор исходников и evidence](source-selection.md)
и [протокол архива](archive-protocol.md). Ниже сохранён исходный снимок планирования.
