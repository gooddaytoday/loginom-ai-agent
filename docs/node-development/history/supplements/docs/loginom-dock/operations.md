> Исторический документ, адаптированный для навигации в Loginom AI Agent. Даты, версии, SHA и результаты относятся к прежним проверкам. Пути к коду указаны относительно нового репозитория; это не доказательство проверки текущих файлов. Исходник `source-03f9c3616062` и изменения: [происхождение](../../../../provenance.json). `unavailable:artifact-*` означает [неперенесённый материал](../../../unavailable.md). Актуальная работа: [регламент](../../../../README.md).
...
для отката сохранены. [Полные проверки и точные пути отката](../../../../../../services/loginom-ai/docs/loginom-dock/releases/rc6-release-2026-09-14.md).
...
[Полный комплект проверенных pins](../../../../../../services/loginom-ai/docs/loginom-dock/node12-candidate2-2026-09-13.json).
...
[Полные hashes/pins](../../../../../../services/loginom-ai/docs/loginom-dock/node11-candidate-2026-09-13.json).
...
[Доказательства, ограничения и checkpoints](../../../../../../services/loginom-ai/docs/loginom-dock/dock-availability-2026-09-13.md).
...
Согласован [план](../../../../../../services/loginom-ai/docs/plans/loginom-dock/09-hermes-user-diagnostics.md).
...
[Обычная приёмка и независимый аудит](../../../../../../services/loginom-ai/docs/loginom-dock/hermes-user-diagnostics-2026-09-10.md) прошли.
...
[windows-agent-install.md](../../../../../../services/loginom-ai/docs/loginom-dock/windows-agent-install.md).
...
Назначения и собственные каталоги проверять по [реестру потоков](../../../../../../services/loginom-ai/docs/plans/loginom-dock/three-stream-workflow.md).
...
в [очередь потока1](../../../../../../services/loginom-ai/docs/plans/loginom-dock/four-stream-node-roadmap.md).
...
| Клиент/native plugins | [Выпуск клиентских комплектов](../../../../../../services/loginom-ai/docs/loginom-dock/releasing.md) | Серверный образ сам по себе не обновляет клиент пользователя |
...
Канонические URI трёх источников перечислены в [архитектуре](../../../../../../services/loginom-ai/docs/loginom-dock/architecture.md).
...
baseline нужных ревизий. Порядок и адресный повтор — в [development.md](../../../../../../services/loginom-ai/docs/loginom-dock/development.md).
...
не менялись. [Отчёт, доказательства и ограничения](../../../../../../services/loginom-ai/docs/loginom-dock/sales-followups-2026-09-10.md).
...
production DNS или публичные порты. Подробности — в [deploy README](../../../../../../services/loginom-ai/deploy/loginom-dock/README.md).
...
## Landing migrated to standalone Desktop — 2026-09-19

Public landing remains https://loginom-dock.duckdns.org/. Canonical source moved to gooddaytoday/loginom-ai-agent `apps/loginom-site`, working branch `site-desktop` based on main/v0.1.5. Deployed release `/opt/loginom-dock/releases/20260919-site-agent-32f06707ff`, Caddy image `loginom-dock:site-agent-32f06707ff`. Backend and installed clients unchanged. Previous architect release/image and env backup retained. See new repository `unavailable:artifact-5d017a068eee15d0` for checks and rollback. Do not republish obsolete plugin instructions from this repository.


2026-09-19 typography update: public Caddy image `loginom-dock:site-fonts-757c100c46`, release `/opt/loginom-dock/releases/20260919-site-fonts-757c100c46`. Previous standalone site retained for rollback. New repo report: unavailable:artifact-fc711723fd296957. Backend unchanged.
