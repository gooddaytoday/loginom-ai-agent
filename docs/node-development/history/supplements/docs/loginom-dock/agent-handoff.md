> Исторический документ, адаптированный для навигации в Loginom AI Agent. Даты, версии, SHA и результаты относятся к прежним проверкам. Пути к коду указаны относительно нового репозитория; это не доказательство проверки текущих файлов. Исходник `source-2c0da70e7e09` и изменения: [происхождение](../../../../provenance.json). `unavailable:artifact-*` означает [неперенесённый материал](../../../unavailable.md). Актуальная работа: [регламент](../../../../README.md).

> 2026-09-24: память перенесена на **https://mcp.loginom.ai/mcp** (178.236.16.111).
> Старый backend и его копии УДАЛЕНЫ; loginom.ai и app.loginom.ai остались на 194.156.118.61.
> Актуальные пути, обслуживание и ограничения отката: [отчёт о переносе](migration-2026-09-24.md).
> Старые полностековые команды ниже — исторические; не запускать ими память на старом VPS.

> 2026-09-17, обновление: опубликован вариант 4373 (architect, скорость сборки 3×). Current `20260917-landing-architect-d564198369`. [Проверки и откат](releases/landing-architect-2026-09-17.md).

> **MiMo ОСТАНОВЛЕН по просьбе пользователя 2026-09-17.** Task34 остановлен
> до создания узлов; exit130, cleanup UNCONFIRMED (нет сохранённого пакета).
> Task19: technical diagnostic PASS, business FAIL. Final38PENDING.
> Продолжать только по новой команде; точная точка — начало
> `mimo-session-handoff-2026-09-17.md`. Более ранние running-записи устарели.


> MiMo checkpoint 2026-09-17: task19 `20260917-160352-21fec178` завершён,
> business FAIL; составной диагностический аудит7таблиц/1147строк/15515ячеек
> и настроек7рабочих узлов PASS. Исправлен duplicate wizard lifecycle,
> live PASS и386тестов PASS. Остался лишний калькулятор модели; старые audit
> cleanup не подтверждены, последний cleanup PASS. Final38 ещё не начат.
> Подробности: `mimo-session-handoff-2026-09-17.md`, раздел8.


> **MiMo возобновлена 17 сентября по команде пользователя.** [Текущее состояние](../../../../../../services/loginom-ai/docs/loginom-dock/mimo-session-handoff-2026-09-17.md#8-возобновление-17-сентября-текущие-подтверждения): общий table reader и первый read проверены адресно и live; завершаются диагностические gates. Итоговые38запусков ещё не начаты.

> 2026-09-17: опубликован выбранный Loginom AI landing; current `20260917-landing-ai-4c85c51e47`, backend без изменений. Сборка и откат: [отчёт](releases/landing-ai-2026-09-17.md).
...
[Проверки, ограничения и откат](../../../../../../services/loginom-ai/docs/loginom-dock/releases/rc8-release-2026-09-15.md).
...
[Полный отчёт, границы и откат](../../../../../../services/loginom-ai/docs/loginom-dock/releases/rc7-release-2026-09-15.md).
...
работа сохранена. [Полный отчёт, ограничения и откат](../../../../../../services/loginom-ai/docs/loginom-dock/releases/rc6-release-2026-09-14.md).
...
> **14 сентября 2026: шесть принятых веток объединены для RC.** Реестр содержит 14 обработчиков; локальные проверки пройдены с адресными повторами. Совместная живая проверка и выпуск ещё не выполнялись. [Итог интеграции](../../../../../../services/loginom-ai/docs/loginom-dock/releases/rc-integration-2026-09-14.md). Новые узлы не запускаются; оптимизация чтения отложена.

> Очистка и возобновление: [отчёт13сентября](../../../../../../services/loginom-ai/docs/loginom-dock/accepted-node-cleanup-2026-09-13.md). Raw diagnostics03–10 удалены по разрешению пользователя; текущие worktrees сохранены.
...
[Инцидент](../../../../../../services/loginom-ai/docs/loginom-dock/disk-pressure-2026-09-13.md): Data100%/116MiB, ENOSPC14/16/17.
...
[Stage/readback](../../../../../../services/loginom-ai/docs/loginom-dock/node13-candidate-stage-2026-09-13.json): version
...
включено в назначение. [Точное решение](../../../../../../services/loginom-ai/docs/loginom-dock/node16-exact-wiring-decision-2026-09-13.md)
...
worktree14 services/loginom-ai/docs/loginom-dock/node14-import-placement-refusal-proposal-2026-09-13.md.
...
[конкретный contract-design этап](../../../../../../services/loginom-ai/docs/loginom-dock/node16-variant-contract-next-step-2026-09-13.md),
...
[node13-r2-transfer-decision-2026-09-13.md](../../../../../../services/loginom-ai/docs/loginom-dock/node13-r2-transfer-decision-2026-09-13.md).
...
[Точный пакет и границы](../../../../../../services/loginom-ai/docs/loginom-dock/node13-r2-transfer-decision-2026-09-13.md) сверены
...
[Stage/readback](../../../../../../services/loginom-ai/docs/loginom-dock/node14-candidate-v2-stage-2026-09-13.json):4/4файла совпали,
...
Без public integration; [точное решение](../../../../../../services/loginom-ai/docs/loginom-dock/node16-variant-prototype-decision.md).
...
`unavailable:artifact-56a53afe8ac6fecc`, isGitRepository=true. Перед первым ходом
...
[Узел11 принят в ветке](../../../../../../services/loginom-ai/docs/loginom-dock/node11-branch-acceptance-2026-09-13.json): отдельная
...
Следующий узел потока1 — [17. Экспорт текста](../../../../../../services/loginom-ai/docs/plans/loginom-dock/17-text-export.md).
Созданы постоянный `unavailable:artifact-56a53afe8ac6fecc`, ветка
...
[Точный разрешённый объём](../../../../../../services/loginom-ai/docs/loginom-dock/node16-variant-prototype-decision.md) заменяет прежний
...
по [ограниченному variant эксперименту](../../../../../../services/loginom-ai/docs/loginom-dock/node16-variant-prototype-decision.md).
...
[Подготовленный ограниченный эксперимент и причина согласования](../../../../../../services/loginom-ai/docs/loginom-dock/node16-variant-prototype-decision.md).
...
[Квитанция и ограничения](../../../../../../services/loginom-ai/docs/loginom-dock/node11-candidate-v2-2026-09-13.json).
...
[coordinator-inbox.md](../../../../../../services/loginom-ai/docs/plans/loginom-dock/coordinator-inbox.md).
Локальная очередь создана в `unavailable:artifact-633da5e207767cdd`, связана
...
Разрешён только пакет `55ccc7b6`: один runtime hunk `packages/loginom-runtime/client/lib/executor.mjs`
...
Документ: `unavailable:artifact-acd86a7e7b5c40c6`.
...
любого другого UI-пути Loginom. [Доказательства](../../../../../../services/loginom-ai/docs/loginom-dock/node16-variant-reader-checkpoint-2026-09-13.json).
...
сохранена. [Квитанция](../../../../../../services/loginom-ai/docs/loginom-dock/node16-shared-memory-knowledge-2026-09-13.json).
...
новое ревью и Hermes не назначены. [Проверенные файлы и решение](../../../../../../services/loginom-ai/docs/loginom-dock/node16-variant-reader-checkpoint-2026-09-13.json).
...
[Решение и проверенные границы](../../../../../../services/loginom-ai/docs/loginom-dock/node12-branch-acceptance-2026-09-13.json).
...
`unavailable:artifact-473c939875d2f6d1` от ранее принятого main base
...
[Назначение и memory gates](../../../../../../services/loginom-ai/docs/loginom-dock/node16-start-2026-09-13.json).
...
`services/loginom-ai/docs/loginom-dock/missing-values-autonomous-acceptance-1-blocked-2026-09-13.md`.
...
`services/loginom-ai/docs/loginom-dock/missing-values-native-candidate-preflight-2026-09-13.md` и
...
[Квитанция координатора](../../../../../../services/loginom-ai/docs/loginom-dock/node14-native-preflight-2026-09-13.json).
...
[Фактические версии и контрольные суммы](../../../../../../services/loginom-ai/docs/loginom-dock/node12-candidate2-2026-09-13.json).
...
[Проверенные pins](../../../../../../services/loginom-ai/docs/loginom-dock/node14-candidate-2026-09-13.json).
...
`services/loginom-ai/docs/loginom-dock/node-13-fix-1.md`. N13-R3 закрыто: expected строится из
...
Полный комплект: `services/loginom-ai/docs/loginom-dock/replacement-acceptance-followup-2026-09-13.json`
...
`services/loginom-ai/docs/plans/loginom-dock/node12-acceptance-preparation-1/attempt-20260913-060514.md`.
...
`services/loginom-ai/docs/loginom-dock/missing-values-recovery-2026-09-13.md`.
...
`services/loginom-ai/docs/plans/loginom-dock/node12-acceptance-preparation-1/attempt-20260913-060042.md`.
...
Прочитан `services/loginom-ai/docs/loginom-dock/node-13-development-report.md` в worktree13,
...
[Полный candidate pin и доказательства](../../../../../../services/loginom-ai/docs/loginom-dock/node11-candidate-2026-09-13.json).
...
[Подтверждения](../../../../../../services/loginom-ai/docs/loginom-dock/node12-candidate-2026-09-13.json). Ход
...
[Проверенная сводка](../../../../../../services/loginom-ai/docs/loginom-dock/node12-candidate-2026-09-13.json). Локальные исходники и
...
[tools/project-memory/README.md](../../../../../../services/loginom-ai/tools/project-memory/README.md).
[Единая инструкция](../../../../../../services/loginom-ai/docs/plans/loginom-dock/node-workflow-runbook.md), AGENTS.md,
политика и реестр очереди обновлены. [Доказательства](../../../../../../services/loginom-ai/docs/loginom-dock/memory-enrollment-2026-09-13.json).
...
[инструкции старта и полного цикла](../../../../../../services/loginom-ai/docs/plans/loginom-dock/node-workflow-runbook.md).
...
каждый фрагмент. Свидетельства: [memory-routing-activation-2026-09-13.json](../../../../../../services/loginom-ai/docs/loginom-dock/memory-routing-activation-2026-09-13.json).
...
Порядок и rollback: [tools/project-memory/README.md](../../../../../../services/loginom-ai/tools/project-memory/README.md).
Политика: [shared-project-memory.md](../../../../../../services/loginom-ai/docs/loginom-dock/shared-project-memory.md).
Runtime `unavailable:artifact-4a8abe957af82b36`; config/trust receipts
`unavailable:artifact-49ea65e7d82e1ab6`, activation receipts —
`unavailable:artifact-b8283c9f71fdc662`. App tasks не архивировались; мониторинг,
...
Координатор прочитал отчёт `services/loginom-ai/docs/plans/loginom-dock/12-code-review-2026-09-13.md`
...
`services/loginom-ai/docs/plans/loginom-dock/12-code-review-2026-09-13.md`.
...
Loginom Dock, сохраняя собственный Peer. [Точные правила](../../../../../../services/loginom-ai/docs/loginom-dock/shared-project-memory.md)
...
[Актуальные этапы и ограничения](../../../../../../services/loginom-ai/docs/plans/loginom-dock/automatic-node-workflow.md).
...
сервер и три источника. [Доказательства и ограничения](../../../../../../services/loginom-ai/docs/loginom-dock/dock-availability-2026-09-13.md).
...
возвращает TLS-ошибку. [Проверки и ограничения](../../../../../../services/loginom-ai/docs/loginom-dock/dock-availability-2026-09-13.md).
...
[Дорожная карта](../../../../../../services/loginom-ai/docs/plans/loginom-dock/four-stream-node-roadmap.md) и
[JSON-реестр](../../../../../../services/loginom-ai/docs/plans/loginom-dock/four-stream-node-roadmap.json) закрепляют
...
[live-снимке](../../../../../../services/loginom-ai/docs/plans/loginom-dock/node-roadmap-live-2026-09-12.json).
...
`unavailable:artifact-56539dddc4ac5b92`, ветка `codex/node-14-missing-values`,
...
[реестре потоков](../../../../../../services/loginom-ai/docs/plans/loginom-dock/three-stream-workflow.md).
...
[Отчёт и все59 checks](../../../../../../services/loginom-ai/docs/plans/loginom-dock/11-persistence-reassessment-2026-09-13.md).
...
[Полный отчёт и точный FAIL](../../../../../../services/loginom-ai/docs/plans/loginom-dock/11-autonomous-v2-2026-09-13.md).
...
[Отчёт и команда следующей приёмки](../../../../../../services/loginom-ai/docs/plans/loginom-dock/11-candidate-v2-preflight-2026-09-13.md).
...
[Отчёт интеграции и новые pins](../../../../../../services/loginom-ai/docs/plans/loginom-dock/11-saveas-integration-results-2026-09-13.md).
...
[Точный пакет и focused live план](../../../../../../services/loginom-ai/docs/plans/loginom-dock/11-saveas-integration-package-2026-09-13.md).
...
[Отчёт follow-up](../../../../../../services/loginom-ai/docs/plans/loginom-dock/11-acceptance-followup-2026-09-13.md).
...
[Итог и конкретные следующие исправления](../../../../../../services/loginom-ai/docs/plans/loginom-dock/11-autonomous-acceptance-2026-09-13.md).
...
[Комплект и команды](../../../../../../services/loginom-ai/docs/plans/loginom-dock/11-acceptance-preparation-2026-09-13.md).
...
[Отчёт исправления](../../../../../../services/loginom-ai/docs/plans/loginom-dock/11-fix-results-2026-09-13.md),
[машинная сводка](../../../../../../services/loginom-ai/docs/loginom-dock/replacement-fix-2026-09-13.json).
...
[Итог разработки](../../../../../../services/loginom-ai/docs/plans/loginom-dock/11-development-audit.md),
[контрольная точка](../../../../../../services/loginom-ai/docs/loginom-dock/replacement-progress-2026-09-12.md).
...
на Astra/medium в постоянных `unavailable:artifact-7b51148252f60442`, зарегистрированных отдельными
проектами приложения. Точные ID и ветки — в
[плане и реестре потоков](../../../../../../services/loginom-ai/docs/plans/loginom-dock/three-stream-workflow.md).

Все три разработчика сохранили `unavailable:artifact-22950d6e897487a2`: подтверждены
...
Новый порядок: [три потока под управлением исходного чата](../../../../../../services/loginom-ai/docs/plans/loginom-dock/three-stream-workflow.md).
...
[Состав, проверки, ограничения и откат](../../../../../../services/loginom-ai/docs/loginom-dock/client-update-union-2026-09-12.md).
...
[Отчёт перепроверки](../../../../../../services/loginom-ai/docs/loginom-dock/union-review-progress-2026-09-12.md),
[машинная сводка](../../../../../../services/loginom-ai/docs/loginom-dock/union-review-acceptance-2026-09-12.json).
...
[Аудит требований и ограничения](../../../../../../services/loginom-ai/docs/plans/loginom-dock/10-completion-audit.md),
[машинная сводка](../../../../../../services/loginom-ai/docs/loginom-dock/union-acceptance-2026-09-12.json),
[журнал диагностики](../../../../../../services/loginom-ai/docs/loginom-dock/union-progress-2026-09-12.md).
...
[Состав, доказательства и откат](../../../../../../services/loginom-ai/docs/loginom-dock/client-update-join-2026-09-12.md).
...
[Полный отчёт и история попыток](../../../../../../services/loginom-ai/docs/loginom-dock/join-review-live-2026-09-12.md),
[машинная сводка](../../../../../../services/loginom-ai/docs/loginom-dock/join-review-acceptance-2026-09-12.json).
...
[Полный аудит](../../../../../../services/loginom-ai/docs/plans/loginom-dock/09-completion-audit.md),
[журнал](../../../../../../services/loginom-ai/docs/loginom-dock/join-progress-2026-09-12.md), [машинная сводка](../../../../../../services/loginom-ai/docs/loginom-dock/join-acceptance-2026-09-12.json).
...
[Состав, проверки и откат](../../../../../../services/loginom-ai/docs/loginom-dock/client-update-process-focus-2026-09-12.md).
...
Клиент: **1316 PASS /1 SKIP**; Python: **480 PASS**. [Полный отчёт](../../../../../../services/loginom-ai/docs/loginom-dock/process-node-focus-fix-20260911.md).
...
параллельный пилот остаётся остановленным. [Проверки и доказательства](../../../../../../services/loginom-ai/docs/loginom-dock/process-node-focus-fix-20260911.md).
...
узлом за раз. [Точная точка продолжения](../../../../../../services/loginom-ai/docs/loginom-dock/parallel-node-pilot.md) и локальная
...
production не активирован. [Канонический checkpoint](../../../../../../services/loginom-ai/docs/loginom-dock/resume-checkpoint.md)
...
проверяющий Astra/xhigh. [Пилот и порядок продолжения](../../../../../../services/loginom-ai/docs/loginom-dock/parallel-node-pilot.md)
...
не проверен. Состояние и владельцы: `unavailable:artifact-b7f3f644efe0905b`.
...
[Состав, проверки и ограничения](../../../../../../services/loginom-ai/docs/loginom-dock/client-update-row-filter-2026-09-11.md).
...
[Доказательства и границы проверки](../../../../../../services/loginom-ai/docs/loginom-dock/row-filter-review-live-2026-09-11.md).
...
[Аудит требований, pins, попытки и ограничения](../../../../../../services/loginom-ai/docs/plans/loginom-dock/06-completion-audit.md).
...
История и локальные свидетельства: [журнал](../../../../../../services/loginom-ai/docs/loginom-dock/row-filter-progress-2026-09-11.md).
...
[Состав, проверки, отличие от main и откат](../../../../../../services/loginom-ai/docs/loginom-dock/client-update-field-parameters-2026-09-11.md).
...
[Условия, исправления и доказательства](../../../../../../services/loginom-ai/docs/loginom-dock/field-parameters-review-2026-09-11.md).
...
[Полный аудит требований, pins и ограничения](../../../../../../services/loginom-ai/docs/plans/loginom-dock/05-completion-audit.md).
...
Подготовлены [подпланы 11–16](../../../../../../services/loginom-ai/docs/plans/loginom-dock/next-wave.md): Замена,
...
Обновлены [реестр и порядок](../../../../../../services/loginom-ai/docs/plans/loginom-dock/README.md) с учётом обычного
...
[Состав, проверки, ограничения и откат](../../../../../../services/loginom-ai/docs/loginom-dock/client-update-2026-09-11.md).
...
[Итоговый отчёт, доказательства и ограничения](../../../../../../services/loginom-ai/docs/loginom-dock/review-0537cc2-2026-09-10.md).
...
[План](../../../../../../services/loginom-ai/docs/plans/loginom-dock/09-hermes-user-diagnostics.md) реализован.
[Итоговый отчёт](../../../../../../services/loginom-ai/docs/loginom-dock/hermes-user-diagnostics-2026-09-10.md) содержит метрики, ограничения,
...
наблюдении мастера импорта. [Полный отчёт](../../../../../../services/loginom-ai/docs/loginom-dock/sales-followups-2026-09-10.md).
...
[Полный разбор, измерения, доказательства и следующие задачи](../../../../../../services/loginom-ai/docs/loginom-dock/rename-recovery-fix-2026-09-10.md).
...
[разбор исправления](../../../../../../services/loginom-ai/docs/loginom-dock/rename-recovery-fix-2026-09-10.md) и этот checkpoint.
...
[Отчёт, измерения и границы диагностики](../../../../../../services/loginom-ai/docs/loginom-dock/user-sales-trial-2026-09-10.md).
...
[Аудит требований и границы](../../../../../../services/loginom-ai/docs/plans/loginom-dock/08-completion-audit.md),
[диагностика и исторические FAIL](../../../../../../services/loginom-ai/docs/plans/loginom-dock/08-progress.md).
...
[Аудит каждого требования](../../../../../../services/loginom-ai/docs/plans/loginom-dock/07-completion-audit.md),
[диагностика и ограничения](../../../../../../services/loginom-ai/docs/plans/loginom-dock/07-progress.md).
...
[Состав и границы RC](../../../../../../services/loginom-ai/docs/loginom-dock/releases/0.1.0-rc.5.md).
...
такой схемы не приняты. [Подробности и границы](../../../../../../services/loginom-ai/docs/plans/loginom-dock/03-review-followup.md).
...
в mappings. [Подробности и доказательства](../../../../../../services/loginom-ai/docs/plans/loginom-dock/04-review-followup.md).
...
[Проверка каждого требования](../../../../../../services/loginom-ai/docs/plans/loginom-dock/04-completion-audit.md),
[история диагностики](../../../../../../services/loginom-ai/docs/plans/loginom-dock/04-progress.md).
...
[Итоговая проверка всех требований](../../../../../../services/loginom-ai/docs/plans/loginom-dock/03-completion-audit.md)
...
Подплан03 ещё открыт. [Точные evidence и ограничения](../../../../../../services/loginom-ai/docs/loginom-dock/text-import-node.md).
...
[Точные evidence и ограничения](../../../../../../services/loginom-ai/docs/loginom-dock/text-import-node.md).
...
[Точные evidence и продолжение](../../../../../../services/loginom-ai/docs/loginom-dock/text-import-node.md).
...
[Точные evidence, исправления и продолжение](../../../../../../services/loginom-ai/docs/loginom-dock/text-import-node.md).
...
[Точное состояние, ограничения и следующий шаг](../../../../../../services/loginom-ai/docs/loginom-dock/text-import-node.md).
...
[Точные evidence и следующий шаг](../../../../../../services/loginom-ai/docs/loginom-dock/text-import-node.md).
...
[Точные evidence, ограничения и продолжение](../../../../../../services/loginom-ai/docs/loginom-dock/text-import-node.md).
...
[Точная точка продолжения и evidence](../../../../../../services/loginom-ai/docs/loginom-dock/text-import-node.md).
...
[Точные ограничения, evidence и продолжение](../../../../../../services/loginom-ai/docs/loginom-dock/text-import-node.md).
...
[Точный checkpoint и evidence](../../../../../../services/loginom-ai/docs/loginom-dock/text-import-node.md).
...
[Точный checkpoint](../../../../../../services/loginom-ai/docs/loginom-dock/text-import-node.md).
...
[Диагностика и точное продолжение](../../../../../../services/loginom-ai/docs/loginom-dock/text-import-node.md).
...
открыт. [Точный checkpoint](../../../../../../services/loginom-ai/docs/loginom-dock/text-import-node.md).
...
bridge закрыт. [Точный следующий fix и evidence](../../../../../../services/loginom-ai/docs/loginom-dock/text-import-node.md).
...
[Матрица оставшейся приёмки](../../../../../../services/loginom-ai/docs/plans/loginom-dock/03-acceptance-matrix.md).
[Точная точка продолжения](../../../../../../services/loginom-ai/docs/loginom-dock/text-import-node.md).
...
[Точный checkpoint и оставшиеся требования](../../../../../../services/loginom-ai/docs/loginom-dock/text-import-node.md).
...
Python113 PASS. Pin23a36052…ee84a требует нового live. [Checkpoint](../../../../../../services/loginom-ai/docs/loginom-dock/text-import-node.md).
...
[Точный checkpoint](../../../../../../services/loginom-ai/docs/loginom-dock/text-import-node.md). Подплан03 открыт.
...
rehearsal/Hermes. [Точный checkpoint](../../../../../../services/loginom-ai/docs/loginom-dock/text-import-node.md). Подплан03 открыт.
...
затем полный negative audit и Hermes. [Checkpoint](../../../../../../services/loginom-ai/docs/loginom-dock/text-import-node.md). Подплан03 открыт.
...
[Точная точка продолжения](../../../../../../services/loginom-ai/docs/loginom-dock/text-import-node.md). Подплан03 открыт.
...
[Точный checkpoint и оставшаяся работа](../../../../../../services/loginom-ai/docs/loginom-dock/text-import-node.md). Подплан03 открыт.
...
[Точный checkpoint, manifest SHA и ограничения](../../../../../../services/loginom-ai/docs/loginom-dock/text-import-node.md).
...
[точной контрольной точке](../../../../../../services/loginom-ai/docs/loginom-dock/text-import-node.md). Production не менялся.
...
[Точный checkpoint и следующий участок](../../../../../../services/loginom-ai/docs/loginom-dock/text-import-node.md).
...
[Точный checkpoint, partial transfer и оставшийся scope](../../../../../../services/loginom-ai/docs/loginom-dock/text-import-node.md).
...
[Точный checkpoint, исправление pins и оставшийся scope](../../../../../../services/loginom-ai/docs/loginom-dock/text-import-node.md).
...
ещё не завершены. [Точная контрольная точка и evidence](../../../../../../services/loginom-ai/docs/loginom-dock/text-import-node.md).
...
[Контрольная точка и следующие обязательства](../../../../../../services/loginom-ai/docs/loginom-dock/text-import-node.md).
...
[Точная контрольная точка, evidence и оставшиеся обязательства](../../../../../../services/loginom-ai/docs/loginom-dock/text-import-node.md).
...
[Точная контрольная точка и текущий transfer](../../../../../../services/loginom-ai/docs/loginom-dock/text-import-node.md).
...
[Контрольная точка и следующий участок — file delivery](../../../../../../services/loginom-ai/docs/loginom-dock/text-import-node.md).
...
[Контрольная точка и следующий шаг](../../../../../../services/loginom-ai/docs/loginom-dock/text-import-node.md).
...
[Контрольная точка, evidence и следующий шаг](../../../../../../services/loginom-ai/docs/loginom-dock/text-import-node.md).
...
[Точная контрольная точка и следующий шаг](../../../../../../services/loginom-ai/docs/loginom-dock/text-import-node.md).
...
[Точное evidence, найденная native ownership связь и следующий шаг](../../../../../../services/loginom-ai/docs/loginom-dock/text-import-node.md).
...
[Checkpoint, evidence и следующие обязательства](../../../../../../services/loginom-ai/docs/loginom-dock/text-import-node.md).
...
[Checkpoint и evidence](../../../../../../services/loginom-ai/docs/loginom-dock/text-import-node.md).
...
прочие recovery границы и полный03 остаются. [Checkpoint](../../../../../../services/loginom-ai/docs/loginom-dock/text-import-node.md).
...
[Checkpoint, evidence и следующий шаг](../../../../../../services/loginom-ai/docs/loginom-dock/text-import-node.md).
...
[Точный checkpoint, диагностические handles и следующий шаг](../../../../../../services/loginom-ai/docs/loginom-dock/text-import-node.md).
...
[Точный checkpoint и дальнейшие обязательства](../../../../../../services/loginom-ai/docs/loginom-dock/text-import-node.md).
...
[Точная точка остановки, evidence и следующий шаг](../../../../../../services/loginom-ai/docs/loginom-dock/text-import-node.md).
...
не сохранены. [Точный checkpoint](../../../../../../services/loginom-ai/docs/loginom-dock/text-import-node.md).
...
исключения и handler integration остаются. [Точный checkpoint](../../../../../../services/loginom-ai/docs/loginom-dock/text-import-node.md).
...
Handler mappings ещё не активирован. [Точный checkpoint](../../../../../../services/loginom-ai/docs/loginom-dock/text-import-node.md).
...
navigation устарел после Save As. [Точный checkpoint](../../../../../../services/loginom-ai/docs/loginom-dock/text-import-node.md).
...
[Подробности и ограничения](../../../../../../services/loginom-ai/docs/loginom-dock/text-import-node.md).
...
[Точный checkpoint, проверки и ограничения](../../../../../../services/loginom-ai/docs/loginom-dock/text-import-node.md).
...
[Точный checkpoint и ограничения](../../../../../../services/loginom-ai/docs/loginom-dock/text-import-node.md).
...
diagnostic закрыты; production не менялся. [Точный checkpoint и оставшийся scope](../../../../../../services/loginom-ai/docs/loginom-dock/text-import-node.md).
...
recovery/Hermes scope. [Точный checkpoint и ограничения](../../../../../../services/loginom-ai/docs/loginom-dock/text-import-node.md).
...
[Точный checkpoint и оставшийся scope](../../../../../../services/loginom-ai/docs/loginom-dock/text-import-node.md).
...
production не менялся. [Точный checkpoint и ограничения](../../../../../../services/loginom-ai/docs/loginom-dock/text-import-node.md).
...
[Точный checkpoint, evidence и границы](../../../../../../services/loginom-ai/docs/loginom-dock/text-import-node.md).
...
[Точный checkpoint и доказательства](../../../../../../services/loginom-ai/docs/loginom-dock/text-import-node.md).
...
[Подробный checkpoint, ограничения и evidence](../../../../../../services/loginom-ai/docs/loginom-dock/text-import-node.md).
...
[Подробный checkpoint, UI-факты и evidence](../../../../../../services/loginom-ai/docs/loginom-dock/text-import-node.md).
Исторические записи ниже.
...
[Точный checkpoint и evidence](../../../../../../services/loginom-ai/docs/loginom-dock/text-import-node.md). Исторические записи ниже.
...
[Точные pins, evidence, ограничения и следующий участок](../../../../../../services/loginom-ai/docs/loginom-dock/text-import-node.md).
...
[Подробности](../../../../../../services/loginom-ai/docs/loginom-dock/text-import-node.md). Изменения не закоммичены.
...
[Текущий код, ограничения и точка продолжения](../../../../../../services/loginom-ai/docs/loginom-dock/text-import-node.md).
...
[Код, свидетельства, ограничения и точка продолжения](../../../../../../services/loginom-ai/docs/loginom-dock/text-import-node.md).
...
[Контракт, проверки и ограничения](../../../../../../services/loginom-ai/docs/loginom-dock/node-target-driver.md).
...
Условия, источники и живые свидетельства: [autolinks.md](../../../../../../services/loginom-ai/docs/loginom-dock/autolinks.md).
...
`unavailable:artifact-b36adf2e215ef8a4`, PASS со штатным журналом.
...
[node-target-driver.md](../../../../../../services/loginom-ai/docs/loginom-dock/node-target-driver.md). Дальше — подключение к общему
...
[workspace-preparation.md](../../../../../../services/loginom-ai/docs/loginom-dock/workspace-preparation.md).
Private evidence: `unavailable:artifact-7d3cddcf270d9f0b`. Следующий шаг — подплан 02 с передачей
...
Канонический [план реализации и выхода из MVP](../../../../../../services/loginom-ai/docs/plans/2026-09-02-loginom-dock-implementation-plan.md)
...
сохранены в [checkpoint](../../../../../../services/loginom-ai/docs/loginom-dock/resume-checkpoint.md).
Работа разложена на [десять конкретных подпланов](../../../../../../services/loginom-ai/docs/plans/loginom-dock/README.md):
...
[Предыдущий план](../../../../../../services/loginom-ai/docs/plans/2026-09-02-loginom-dock-implementation-plan-history-through-2026-09-07.md)
...
[Точная точка продолжения](../../../../../../services/loginom-ai/docs/loginom-dock/resume-checkpoint.md).
...
Подробности, суммы и откат: [windows-agent-install.md](../../../../../../services/loginom-ai/docs/loginom-dock/windows-agent-install.md).
...
Актуальное состояние: [resume-checkpoint.md](../../../../../../services/loginom-ai/docs/loginom-dock/resume-checkpoint.md).

**Предыдущая передача 2026-09-07, 14:06 МСК — историческая пауза.**
См. [resume-checkpoint.md](../../../../../../services/loginom-ai/docs/loginom-dock/resume-checkpoint.md). Последний calculator-roundtrip
...
[Контракт и порядок в плане §13.3](../../../../../../services/loginom-ai/docs/plans/2026-09-02-loginom-dock-implementation-plan.md#node-level-operations).
...
`unavailable:artifact-6d43280ac47840c1`. Hidden/foreign/invalid path
...
native driver. Snapshot `unavailable:artifact-d479acbba7528bb5`:
...
`unavailable:artifact-f639676f5523db24` подтвердил четыре узла и три связи.
...
Артефакты: `unavailable:artifact-0955e312e62fc181{open,steps,finish}-result.json`.
...
`unavailable:artifact-50d6dded63303d31`. Реальный drag этим не проверен.
...
Native финальный snapshot unavailable:artifact-dbebe2f33a42f2f3
...
Свежие manual snapshots unavailable:artifact-4d4e5eb0dc856633 и
...
input и закрытие. Полные unavailable:artifact-99855ec0a42aef40 suites после этой правки ещё НЕ
...
columns с отдельным readback, не принимает schema. 295 unavailable:artifact-4b8ff1fae63e9c7b Python/10 packaging PASS. UI действительно открыт в TF-1 «Настройка», source wizard;
...
cursor/roots без fallback. 293 unavailable:artifact-4b8ff1fae63e9c7b Python/10 packaging PASS.
...
Old same-start repro AMBIGUOUS167ms. 291 unavailable:artifact-4b8ff1fae63e9c7b Python/10 packaging PASS.
...
pre-read остаётся FAIL, audit не переписывать. 290 unavailable:artifact-4b8ff1fae63e9c7b Python/10 packaging PASS.
...
Перед возобновлением проверить unavailable:artifact-aef88d9c8770832d и живой
...
после него targeted unavailable:artifact-d5cf08e4e3dc24e0 PASS (точные числа сверху status).
...
170 unavailable:artifact-ae99e53bf671aae5 packaging. Active Hermes нет. Следующее — новый run
...
164 unavailable:artifact-ae99e53bf671aae5 packaging. Старый FAIL сохранён, active Hermes нет.
...
в unavailable:artifact-3d3803b03b1407ef; 77 coverage rows presence-only, statuses planned.
...
исторические. Локальный checkpoint находится в unavailable:artifact-d94c477329101c93.
...
[§§13–21 канонического плана](../../../../../../services/loginom-ai/docs/plans/2026-09-02-loginom-dock-implementation-plan.md#post-mvp-scope):
...
P0 начат: `packages/loginom-runtime/tools/loginom-acceptance/preflight.py` сверяет build inputs с commit
...
точный граф. Текущий source pin `f5d42a18…`, 41 input, 139 unavailable:artifact-2249cf6a8080f72c Python/10
...
[карту E2E-источников](../../../../../../services/loginom-ai/docs/loginom-dock/e2e-source-map.md); она отделяет реальные UI-паттерны от
...
- Реализованы `packages/loginom-runtime/tools/loginom-acceptance/manual_reopen.py`, `save-reopen-client.mjs`,
...
- Индекс `unavailable:artifact-337d3ecaeab986ea`: 17 попыток / 6 PASS,
...
1. Прочитать корневой [AGENTS.md](../../../unavailable.md#artifact-31a6af6b44c1fa8d), эту памятку и запрос пользователя.
2. Проверить `git status --short`, текущую ветку и историю. Репозиторий на этой
   машине — `unavailable:artifact-cf88a7be2dd0c277`, remote —
...
4. Выбрать документы по таблице ниже. Перед изменением архитектуры прочитать
   [канонический план](../../../../../../services/loginom-ai/docs/plans/2026-09-02-loginom-dock-implementation-plan.md)
   и [архитектуру](../../../../../../services/loginom-ai/docs/loginom-dock/architecture.md).
...
| Задача | Что читать |
| --- | --- |
| Сервер, SSH, конфиги, обновление, откат, копии | [operations.md](operations.md), [deploy README](../../../../../../services/loginom-ai/deploy/loginom-dock/README.md) |
| Устройство и границы системы | [architecture.md](../../../../../../services/loginom-ai/docs/loginom-dock/architecture.md) |
| Выход из MVP, покрытие функций, восстановление и поставка | [Канонический план, этапы V1–V5](../../../../../../services/loginom-ai/docs/plans/2026-09-02-loginom-dock-implementation-plan.md#post-mvp-phases), [карта E2E](../../../../../../services/loginom-ai/docs/loginom-dock/e2e-source-map.md) |
| Код, зависимости, GitLab/LFS, suites | [development.md](../../../../../../services/loginom-ai/docs/loginom-dock/development.md) |
| Клиент, hooks, браузер, очередь | [client/README.md](../../../../../../packages/loginom-runtime/client/README.md), [инструкция пользователя](../../../../../../packages/loginom-runtime/client/INSTALL.md) |
| Новый клиентский выпуск | [releasing.md](../../../../../../services/loginom-ai/docs/loginom-dock/releasing.md) |
| Лендинг, русский текст, ссылки загрузки | [landing/README.md](../../../../../../apps/loginom-site/README.md) |
...
| Запуск и объединение MCP | `packages/loginom-runtime/client/bin/loginom-dock.mjs`, `packages/loginom-runtime/client/lib/bridge.mjs`, `catalog.mjs`, `config.mjs`, `session.mjs` в `unavailable:artifact-e8ca5f97a65351b9` |
| E2E-исполнитель и каталоги | `packages/loginom-runtime/client/lib/action-catalog.mjs`, `packages/loginom-runtime/client/lib/executor.mjs`, `executor/`; сборка и публикация — `deploy/loginom-dock/build-action-catalog.mjs`, `publish-action-catalog.py` |
| Подготовка executor workspace и журнал операций | `packages/loginom-runtime/client/lib/workspace.mjs`, `packages/loginom-runtime/client/lib/execution-journal.mjs`; закреплённые UI probes — `services/loginom-ai/docs/loginom-dock/pinned-ui-probes.md` |
| Наблюдаемый UI и одиночные жесты | `packages/loginom-runtime/client/lib/workspace-ui.mjs`; маршрутизация — `packages/loginom-runtime/client/lib/bridge.mjs`; refs, квитанции и восстановление операции — `packages/loginom-runtime/client/lib/executor.mjs` |
| Получение skill и диагностика | `packages/loginom-runtime/client/lib/skill.mjs`, `packages/loginom-runtime/client/lib/diagnostics.mjs` |
| Архив, hooks, redaction | `packages/loginom-runtime/client/lib/archive.mjs`, `history.mjs`, `hooks.mjs`, `hook-runtime.mjs`, `redact.mjs` в `unavailable:artifact-e8ca5f97a65351b9`; `packages/loginom-runtime/client/bin/hook.mjs`, `dispatch.mjs` |
| Clipboard и сериализация действий | `packages/loginom-runtime/client/lib/clipboard.mjs` |
| Мастер, update/rollback/uninstall | `packages/loginom-runtime/client/bin/setup.mjs`, `packages/loginom-runtime/client/lib/install.mjs`, `packages/loginom-runtime/client/lib/native.mjs` |
...
итерации находятся в приватном `unavailable:artifact-c0162febc155ea5f`.
...
`packages/loginom-runtime/client/test/landing.test.mjs` импортирует `landing/instructions.mjs` и
...
### Public site handoff — 2026-09-19

The public site now serves standalone Loginom AI Agent v0.1.5 downloads. Canonical source is the new repository `apps/loginom-site` on branch `site-desktop` (local checkout `/Users/kartamyshev/Git/loginom-ai-site`). Publication and rollback report: new repo `unavailable:artifact-5d017a068eee15d0`. API/Studio and installed clients were not updated. Old 4373 files here remain historical design sources, not the current site build.
